...
public class Categories {
	public static class EquipCategory extends Category {
		 ...
		 */
		public EquipCategory(String name, int color, int highlightColor, ItemStack item,
				EnumEquipmentInventory inventory, int slot) {
	...
	public static class UnequipCategory extends EquipCategory {
		 ...
		 */
		public UnequipCategory(String name, int color, int highlightColor, ItemStack item,
				EnumEquipmentInventory inventory, int slot) {
