...
public class BatchedParticleRenderer {
	public static class ParticleBatchType {
		...
		protected void render(Iterable<Particle> particles, Tessellator tessellator, Entity entity, float partialTicks,
				float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
			BufferBuilder buffer = tessellator.getBuffer();

			for (Particle particle : particles) {
				particle.renderParticle(buffer, entity, partialTicks, rotationX, rotationZ, rotationYZ, rotationXY,
						rotationXZ);
			}
		}
	...
	public void renderBatchType(ParticleBatchType batchType, Collection<Particle> particles, Entity entity,
			float partialTicks) {
