...
public class ParticleAnimated extends Particle implements IParticleSpriteReceiver {
	...
	public ParticleAnimated(World world, double x, double y, double z, double mx, double my, double mz, int maxAge,
			float scale) {
		this(world, x, y, z, mx, my, mz, maxAge, scale, true);
	}

	public ParticleAnimated(World world, double x, double y, double z, double mx, double my, double mz, int maxAge,
			float scale, boolean randomStart) {
		super(world, x, y, z);
	...
	public static final class GenericFactory extends ParticleFactory<GenericFactory, ParticleAnimated> {
		public GenericFactory(ResourceLocation texture) {
			super(ParticleAnimated.class,
					ParticleTextureStitcher.create(ParticleAnimated.class, texture).setSplitAnimations(true));
		}

		@Override
		public ParticleAnimated createParticle(ImmutableParticleArgs args) {
			return new ParticleAnimated(args.world, args.x, args.y, args.z, args.motionX, args.motionY, args.motionZ,
					args.data.getInt(0), args.scale, args.data.getBool(1));
		}
		...
		public PortalFactory() {
			super(ParticleAnimated.class,
					ParticleTextureStitcher
							.create(ParticleAnimated.class, new ResourceLocation("thebetweenlands:particle/portal"))
	...
	public static final class SpawnerFactory extends ParticleFactory<PortalFactory, ParticleAnimated> {
		public SpawnerFactory() {
			super(ParticleAnimated.class,
					ParticleTextureStitcher
							.create(ParticleAnimated.class, new ResourceLocation("thebetweenlands:particle/spawner"))
							.setSplitAnimations(true));
		}
