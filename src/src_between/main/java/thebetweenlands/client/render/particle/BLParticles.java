...
public enum BLParticles {
	...
	PORTAL(new ParticleAnimated.PortalFactory()), SPAWNER(new ParticleAnimated.SpawnerFactory()),
	...
	SWAMP_SMOKE(VanillaParticleFactory.create(ParticleSmokeNormal.class, new ParticleSmokeNormal.Factory())
			.getBaseArgsBuilder().withColor(0xFF2D4231).buildBaseArgs()),
	FLAME(VanillaParticleFactory.create(ParticleFlame.class, new ParticleFlame.Factory())),
	GREEN_FLAME(VanillaParticleFactory.create(ParticleFlame.class, new ParticleFlame.Factory()).getBaseArgsBuilder()
			.withColor(0xFF2C4231).buildBaseArgs()),
	SULFUR_TORCH(VanillaParticleFactory.create(ParticleSmokeNormal.class, new ParticleSmokeNormal.Factory())
			.getBaseArgsBuilder().withColor(0xFFE7f70E).buildBaseArgs()),
	SULFUR_ORE(VanillaParticleFactory.create(ParticleSpell.class, new ParticleSpell.Factory()).getBaseArgsBuilder()
			.withColor(0xFFE7f70E).buildBaseArgs()),
	SNAIL_POISON(VanillaParticleFactory.create(ParticleSpell.class, new ParticleSpell.Factory()).getBaseArgsBuilder()
			.withColor(0xFFFF0000).buildBaseArgs()),
	PURIFIER_STEAM(VanillaParticleFactory.create(ParticleSmokeNormal.class, new ParticleSmokeNormal.Factory())
			.getBaseArgsBuilder().withColor(0xFFFFFFFF).buildBaseArgs()),
	FLY(new ParticleBug.FlyFactory()), MOTH(new ParticleMoth.Factory()), MOSQUITO(new ParticleBug.MosquitoFactory()),
	SPIRIT_BUTTERFLY(new ParticleSpiritButterfly.Factory()), WATER_BUG(new ParticleBug.WaterBugFactory()),
	FISH(new ParticleFish.Factory()), WISP(new ParticleWisp.Factory()),
	DRUID_CASTING(new ParticleDruidCasting.Factory()),
	DRUID_CASTING_BIG(new ParticleDruidCasting.Factory().getBaseArgsBuilder().withColor(0, 1, 1, 1).buildBaseArgs()),
	DIRT_DECAY(VanillaParticleFactory.create(ParticleSpell.class, new ParticleSpell.Factory()).getBaseArgsBuilder()
			.withColor(0.306F, 0.576F, 0.192F, 1.0F).buildBaseArgs()),
	BUBBLE_PURIFIER(new ParticleBubbleBL.Factory().getBaseArgsBuilder().withColor(0.306F, 0.576F, 0.192F, 1.0F)
			.buildBaseArgs()),
	BUBBLE_INFUSION(
			new ParticleBubbleBL.Factory().getBaseArgsBuilder().withColor(0.5F, 0F, 0.125F, 1.0F).buildBaseArgs()),
	BUBBLE_TAR(new ParticleBubbleBL.Factory().getBaseArgsBuilder().withColor(0, 0, 0, 1.0F).buildBaseArgs()),
	SPLASH_TAR(new ParticleBreakingBL.Factory().getBaseArgsBuilder().withColor(0, 0, 0, 1.0F).buildBaseArgs()),
	...
	GAS_CLOUD(new ParticleGasCloud.Factory()), WEEDWOOD_LEAF(new ParticleWeedwoodLeaf.Factory()),
	...
	XP_PIECES(new ParticleXPPieces.Factory()), DAMAGE_REDUCTION(new ParticleDamageReduction.Factory()),
	ROOT_SPIKE(new ParticleRootSpike.Factory()),
	CORRUPTED(new ParticleSimple.GenericFactory(new ResourceLocation("thebetweenlands:particle/corrupted"))
			.getBaseArgsBuilder().withDataBuilder().setData(2, 1.0F).buildData().buildBaseArgs()),
	SOUND_RIPPLE(new ParticleSoundRipple.Factory()), LIFE_ESSENCE(new ParticleLifeEssence.Factory()),
	PUZZLE_BEAM(new ParticlePuzzleBeam.Factory()), PUZZLE_BEAM_2(new ParticlePuzzleBeam2.Factory()),
	SMOOTH_SMOKE(new ParticleSimple.GenericFactory(new ResourceLocation("thebetweenlands:particle/smooth_smoke"))),
	SONIC_SCREAM(new ParticleSonicScream.Factory()), EMBER_SWIRL(new ParticleLeafSwirl.FactoryEmberSwirl()),
