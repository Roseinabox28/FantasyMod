...
public class ParticleWeedwoodLeaf extends Particle implements IParticleSpriteReceiver {
	...
	public ParticleWeedwoodLeaf(World world, double x, double y, double z, double mx, double my, double mz, int maxAge,
			float scale) {
		super(world, x, y, z);
	...
	public static final class Factory extends ParticleFactory<Factory, ParticleWeedwoodLeaf> {
		public Factory() {
			super(ParticleWeedwoodLeaf.class,
					ParticleTextureStitcher
							.create(ParticleWeedwoodLeaf.class, new ResourceLocation("thebetweenlands:particle/leaf"))
							.setSplitAnimations(true));
		}

		@Override
		public ParticleWeedwoodLeaf createParticle(ImmutableParticleArgs args) {
			return new ParticleWeedwoodLeaf(args.world, args.x, args.y, args.z, args.motionX, args.motionY,
					args.motionZ, args.data.getInt(0), args.scale);
		}
