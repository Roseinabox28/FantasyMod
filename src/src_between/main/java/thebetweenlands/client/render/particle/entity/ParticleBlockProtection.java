...
public class ParticleBlockProtection extends ParticleAnimated implements IParticleSpriteReceiver {
	...
	protected ParticleBlockProtection(World world, double x, double y, double z, double mx, double my, double mz,
			EnumFacing face, float scale, int maxAge) {
	...
	public static final class Factory extends ParticleFactory<Factory, ParticleBlockProtection> {
		public Factory() {
			super(ParticleBlockProtection.class,
					ParticleTextureStitcher
							.create(ParticleBlockProtection.class,
									new ResourceLocation("thebetweenlands:particle/block_protection"))
							.setSplitAnimations(true));
		}

		@Override
		public ParticleBlockProtection createParticle(ImmutableParticleArgs args) {
			return new ParticleBlockProtection(args.world, args.x, args.y, args.z, args.motionX, args.motionY,
					args.motionZ, args.data.getObject(EnumFacing.class, 0), args.scale, args.data.getInt(1));
		}
