...
public class ParticleMoth extends ParticleBug {
	...
	protected ParticleMoth(World world, double x, double y, double z, double mx, double my, double mz, int maxAge,
	...
	public static final class Factory extends ParticleFactory<Factory, ParticleMoth> {
		public Factory() {
			super(ParticleMoth.class,
					ParticleTextureStitcher.create(ParticleMoth.class,
							new ResourceLocation[] { new ResourceLocation("thebetweenlands:particle/moth_1"),
									new ResourceLocation("thebetweenlands:particle/moth_2") }));
		}

		@Override
		public ParticleMoth createParticle(ImmutableParticleArgs args) {
			return new ParticleMoth(args.world, args.x, args.y, args.z, args.motionX, args.motionY, args.motionZ,
