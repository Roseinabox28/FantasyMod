...
public class ParticleTarBeastDrip extends Particle {
	...
	public ParticleTarBeastDrip(World world, double x, double y, double z, double velX, double velY, double velZ,
			float scale) {
	...
	public void onUpdate() {
		...
		if (material.isLiquid() || material.isSolid()) {
			double d0 = (double) ((float) (MathHelper.floor(posY) + 1)
					- BlockLiquid.getLiquidHeightPercent(blockState.getBlock().getMetaFromState(blockState)));
	...
	public static final class Factory extends ParticleFactory<Factory, ParticleTarBeastDrip> {
		...
		public ParticleTarBeastDrip createParticle(ImmutableParticleArgs args) {
			return new ParticleTarBeastDrip(args.world, args.x, args.y, args.z, args.motionX, args.motionY,
					args.motionZ, args.scale);
		}
	}
}
