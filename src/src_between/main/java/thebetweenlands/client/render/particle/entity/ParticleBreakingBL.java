...
public class ParticleBreakingBL extends ParticleBreaking implements IParticleSpriteReceiver {
	...
	protected ParticleBreakingBL(World worldIn, double posXIn, double posYIn, double posZIn, double mx, double my,
			double mz, Item itemIn, int meta, float scale) {
		super(worldIn, posXIn, posYIn, posZIn, itemIn, meta);
		this.particleScale = scale;
		this.motionX = mx;
		this.motionY = my;
	...
	public static final class Factory extends ParticleFactory<Factory, ParticleBreaking> {
		...
		public ParticleBreaking createParticle(ImmutableParticleArgs args) {
			return new ParticleBreakingBL(args.world, args.x, args.y, args.z, args.data.getObject(Item.class, 0),
					args.data.getInt(1), args.scale);
		}
	...
	public static final class MotionFactory extends ParticleFactory<MotionFactory, ParticleBreaking> {
		...
		@Override
		public ParticleBreaking createParticle(ImmutableParticleArgs args) {
			return new ParticleBreakingBL(args.world, args.x, args.y, args.z, args.motionX, args.motionY, args.motionZ,
					args.data.getObject(Item.class, 0), args.data.getInt(1), args.scale);
		}
