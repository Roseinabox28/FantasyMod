...
public class ParticleSonicScream extends ParticleAnimated implements IParticleSpriteReceiver {
	...
	protected ParticleSonicScream(World world, double x, double y, double z, double mx, double my, double mz,
			float scale, int maxAge, int initialFrame) {
	...
	public static final class Factory extends ParticleFactory<Factory, ParticleSonicScream> {
		public Factory() {
			super(ParticleSonicScream.class,
					ParticleTextureStitcher
							.create(ParticleSonicScream.class,
									new ResourceLocation("thebetweenlands:particle/sonic_scream"))
							.setSplitAnimations(true));
		}

		@Override
		public ParticleSonicScream createParticle(ImmutableParticleArgs args) {
			return new ParticleSonicScream(args.world, args.x, args.y, args.z, args.motionX, args.motionY, args.motionZ,
					args.scale, args.data.getInt(0), args.data.getInt(1));
		}
