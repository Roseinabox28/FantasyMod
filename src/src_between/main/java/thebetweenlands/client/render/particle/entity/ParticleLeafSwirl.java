...
public class ParticleLeafSwirl extends ParticleSwirl implements IParticleSpriteReceiver {
	...
	public ParticleLeafSwirl(World world, double x, double y, double z, int maxAge, float scale, float progress,
			Entity target) {
		...
		this.setTargetMotion(this.target.posX - this.target.lastTickPosX, this.target.posY - this.target.lastTickPosY,
				this.target.posZ - this.target.lastTickPosZ);
	...
	public static final class Factory extends ParticleFactory<Factory, ParticleLeafSwirl> {
		public Factory() {
			super(ParticleLeafSwirl.class,
					ParticleTextureStitcher
							.create(ParticleLeafSwirl.class, new ResourceLocation("thebetweenlands:particle/leaf"))
							.setSplitAnimations(true));
		}

		@Override
		public ParticleLeafSwirl createParticle(ImmutableParticleArgs args) {
			return new ParticleLeafSwirl(args.world, args.x, args.y, args.z, args.data.getInt(0), args.scale,
					args.data.getFloat(1), args.data.getObject(Entity.class, 2));
		}
	...
	public static final class FactoryEmberSwirl extends ParticleFactory<FactoryEmberSwirl, ParticleLeafSwirl> {
		public FactoryEmberSwirl() {
			super(ParticleLeafSwirl.class,
					ParticleTextureStitcher
							.create(ParticleLeafSwirl.class,
									new ResourceLocation("thebetweenlands:particle/ember_swirl"))
							.setSplitAnimations(true));
		}
	...
	public static final class FactorySludgeSwirl extends ParticleFactory<FactorySludgeSwirl, ParticleLeafSwirl> {
		public FactorySludgeSwirl() {
			super(ParticleLeafSwirl.class, ParticleTextureStitcher.create(ParticleLeafSwirl.class,
					new ResourceLocation("thebetweenlands:particle/smooth_smoke")));
		}
