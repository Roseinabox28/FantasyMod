...
public class Warp extends PostProcessingEffect<Warp> {
	...
	protected ResourceLocation[] getShaders() {
		return new ResourceLocation[] { new ResourceLocation("thebetweenlands:shaders/postprocessing/warp/warp.vsh"),
				new ResourceLocation("thebetweenlands:shaders/postprocessing/warp/warp.fsh") };
	}
