...
public class Tonemapper extends PostProcessingEffect<Tonemapper> {
	...
	protected ResourceLocation[] getShaders() {
		return new ResourceLocation[] {
				new ResourceLocation("thebetweenlands:shaders/postprocessing/tonemapper/tonemapper.vsh"),
				new ResourceLocation("thebetweenlands:shaders/postprocessing/tonemapper/tonemapper.fsh") };
	}
