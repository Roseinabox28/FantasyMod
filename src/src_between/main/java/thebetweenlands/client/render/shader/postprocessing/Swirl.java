...
public class Swirl extends PostProcessingEffect<Swirl> {
	...
	protected ResourceLocation[] getShaders() {
		return new ResourceLocation[] { new ResourceLocation("thebetweenlands:shaders/postprocessing/swirl/swirl.vsh"),
				new ResourceLocation("thebetweenlands:shaders/postprocessing/swirl/swirl.fsh") };
	}
	...
	protected boolean initEffect() {
		...
		return /*
				 * this.timeUniformID >= 0 && this.scaleUniformID >= 0 &&
				 * this.timeScaleUniformID >= 0 && this.multiplierUniformID >= 0 &&
				 * this.xOffsetUniformID >= 0 && this.yOffsetUniformID >= 0
				 */true;
	}
