...
public class Dither extends PostProcessingEffect<Dither> {
	...
	protected ResourceLocation[] getShaders() {
		return new ResourceLocation[] {
				new ResourceLocation("thebetweenlands:shaders/postprocessing/dither/dither.vsh"),
				new ResourceLocation("thebetweenlands:shaders/postprocessing/dither/dither.fsh") };
	}
	...
	protected boolean initEffect() {
		...
		bayerMatrix.put(new byte[] { 0, 32, 8, 40, 2, 34, 10, 42, 48, 16, 56, 24, 50, 18, 58, 26, 12, 44, 4, 36, 14, 46,
				6, 38, 60, 28, 52, 20, 62, 30, 54, 22, 3, 35, 11, 43, 1, 33, 9, 41, 51, 19, 59, 27, 49, 17, 57, 25, 15,
		...
		GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_LUMINANCE, 8, 8, 0, GL11.GL_LUMINANCE, GL11.GL_UNSIGNED_BYTE,
				bayerMatrix);
