...
public class GodRay extends PostProcessingEffect<GodRay> {
	...
	protected ResourceLocation[] getShaders() {
		return new ResourceLocation[] {
				new ResourceLocation("thebetweenlands:shaders/postprocessing/godray/godray.vsh"),
				new ResourceLocation("thebetweenlands:shaders/postprocessing/godray/godray.fsh") };
	}
	...
	protected boolean initEffect() {
		...
		this.illuminationDecayUniformID = OpenGlHelper.glGetUniformLocation(this.getShaderProgram(),
				"u_illuminationDecay");
		return true;
	}
