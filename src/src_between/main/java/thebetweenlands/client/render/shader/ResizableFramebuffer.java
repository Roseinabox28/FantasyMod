...
public class ResizableFramebuffer {
	...
	/**
	 * Resizes the framebuffer to the specified dimensions and returns the
	 * framebuffer
	 * 
	 * @param width
	 * @param height
	...
	public Framebuffer getFramebuffer(int width, int height) {
		if (this.framebuffer == null || width != this.framebuffer.framebufferWidth
				|| height != this.framebuffer.framebufferHeight) {
