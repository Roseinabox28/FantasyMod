...
public class GeometryBuffer extends AbstractTexture {
	 ...
	 */
	public GeometryBuffer(TextureManager textureManager, @Nullable ResourceLocation nameDiffuse,
			@Nullable ResourceLocation nameDepth, boolean depthBuffer) {
	...
	public boolean updateGeometryBuffer(int width, int height) {
		...
		if (width != this.geometryBuffer.framebufferWidth || height != this.geometryBuffer.framebufferHeight) {
