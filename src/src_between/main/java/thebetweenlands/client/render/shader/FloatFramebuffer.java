	...
	public FloatFramebuffer(int width, int height, boolean useDepth, boolean useFloatBuffer) {
		...
		if (this.useFloatBuffer) {
			...
			if (colorFormat != -1) {
				...
				GlStateManager.glTexImage2D(GL11.GL_TEXTURE_2D, 0, colorFormat, this.framebufferTextureWidth,
						this.framebufferTextureHeight, 0, GL11.GL_RGBA, GL11.GL_FLOAT, (IntBuffer) null);
			}
		}
	}
}
