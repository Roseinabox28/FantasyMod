	...
	protected ResourceLocation[] getShaders() {
		return new ResourceLocation[] {
				new ResourceLocation(
						"thebetweenlands:shaders/postprocessing/occlusionextractor/occlusionextractor.vsh"),
				new ResourceLocation(
						"thebetweenlands:shaders/postprocessing/occlusionextractor/occlusionextractor.fsh") };
	}

	@Override
	protected boolean initEffect() {
		this.worldDepthFBOUniformID = OpenGlHelper.glGetUniformLocation(this.getShaderProgram(), "s_world_depth");
		this.clipPlaneDepthFBOUniformID = OpenGlHelper.glGetUniformLocation(this.getShaderProgram(),
				"s_clipPlane_depth");
		return true;
	}
