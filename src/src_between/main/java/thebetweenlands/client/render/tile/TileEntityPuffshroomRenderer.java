...
public class TileEntityPuffshroomRenderer extends TileEntitySpecialRenderer<TileEntityPuffshroom> {
	private static final ResourceLocation TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/tiles/puffshroom.png");

	private final ModelPuffshroom model = new ModelPuffshroom();

	@Override
	public void render(TileEntityPuffshroom tile, double x, double y, double z, float partialTicks, int destroyStage,
			float alpha) {
