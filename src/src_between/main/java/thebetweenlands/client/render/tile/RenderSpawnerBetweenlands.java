...
public class RenderSpawnerBetweenlands extends TileEntitySpecialRenderer<TileEntityMobSpawnerBetweenlands> {
	...
	private final static ResourceLocation TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/tiles/spawner_crystal.png");

	public static void renderSpawnerMob(MobSpawnerLogicBetweenlands spawnerLogic, double x, double y, double z,
			float partialTicks) {
		...
		if (entity != null) {
			...
			GlStateManager.rotate((float) (spawnerLogic.lastEntityRotation
					+ (spawnerLogic.entityRotation - spawnerLogic.lastEntityRotation) * (double) partialTicks) * 10.0F,
					0.0F, 1.0F, 0.0F);
	...
	@Override
	public void render(TileEntityMobSpawnerBetweenlands te, double x, double y, double z, float partialTicks,
		...
		GlStateManager.scale(0.2F + (float) Math.sin(counter2) * (float) Math.sin(counter2) / 2,
				0.2F + (float) Math.sin(counter2) * (float) Math.sin(counter2) / 2,
				0.2F + (float) Math.sin(counter2) * (float) Math.sin(counter2) / 2);
		GlStateManager.color(1, 4 + (float) Math.sin(counter2) * 3, (float) Math.sin(counter2) * 2,
				(float) Math.cos(counter2) * (float) Math.cos(counter2) * 2);
		this.spawnerCrystalModel.render();
		GlStateManager.popMatrix();
		...
		GlStateManager.scale(2.25F, 2.25F, 2.25F);
		GlStateManager.scale(0.2F + (float) Math.sin(counter3) * (float) Math.sin(counter3) / 2,
				0.2F + (float) Math.sin(counter3) * (float) Math.sin(counter3) / 2,
				0.2F + (float) Math.sin(counter3) * (float) Math.sin(counter3) / 2);
		GlStateManager.color(1, 4 + (float) Math.sin(counter3) * 3, (float) Math.sin(counter3) * 2,
				(float) Math.cos(counter3) * (float) Math.cos(counter3) * 2);
		this.spawnerCrystalModel.render();
		GlStateManager.popMatrix();
		...
		GlStateManager.scale(2.25F, 2.25F, 2.25F);
		GlStateManager.scale(0.2F + (float) Math.sin(counter4) * (float) Math.sin(counter4) / 2,
				0.2F + (float) Math.sin(counter4) * (float) Math.sin(counter4) / 2,
				0.2F + (float) Math.sin(counter4) * (float) Math.sin(counter4) / 2);
		GlStateManager.color(1, 4 + (float) Math.sin(counter4) * 3, (float) Math.sin(counter4) * 2,
				(float) Math.cos(counter4) * (float) Math.cos(counter4) * 2);
		this.spawnerCrystalModel.render();
		GlStateManager.popMatrix();
		...
		GlStateManager.scale(2.25F, 2.25F, 2.25F);
		GlStateManager.scale(0.2F + (float) Math.sin(counter5) * (float) Math.sin(counter5) / 2,
				0.2F + (float) Math.sin(counter5) * (float) Math.sin(counter5) / 2,
				0.2F + (float) Math.sin(counter5) * (float) Math.sin(counter5) / 2);
		GlStateManager.color(1, 4 + (float) Math.sin(counter5) * 3, (float) Math.sin(counter5) * 2,
				(float) Math.cos(counter5) * (float) Math.cos(counter5) * 2);
		this.spawnerCrystalModel.render();
		GlStateManager.popMatrix();
