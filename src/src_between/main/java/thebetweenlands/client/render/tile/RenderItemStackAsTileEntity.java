...
public class RenderItemStackAsTileEntity extends TileEntityItemStackRenderer {
	...
	public RenderItemStackAsTileEntity(Class<? extends TileEntity> te) {
		...
		this.map = null;
		Preconditions.checkNotNull(this.renderer, "TileEntity %s for ItemStack renderer does not have a renderer!",
				te.getName());
	}
	...
	public RenderItemStackAsTileEntity add(int meta, Class<? extends TileEntity> te) {
		...
		Preconditions.checkNotNull(renderer, "TileEntity %s for ItemStack renderer does not have a renderer!",
				te.getName());
