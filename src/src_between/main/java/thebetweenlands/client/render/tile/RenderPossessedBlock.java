...
public class RenderPossessedBlock extends TileEntitySpecialRenderer<TileEntityPossessedBlock> {
	private static final ResourceLocation TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/tiles/possessed_block.png");
	private final ModelPossessedBlock model = new ModelPossessedBlock();

	@Override
	public void render(TileEntityPossessedBlock te, double x, double y, double z, float partialTicks, int destroyStage,
			float alpha) {

		EnumFacing facing = StatePropertyHelper.getStatePropertySafely(te, BlockPossessedBlock.class,
				BlockPossessedBlock.FACING, EnumFacing.NORTH);
