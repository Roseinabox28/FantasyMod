...
public class RenderChestBetweenlands extends TileEntitySpecialRenderer<TileEntityChestBetweenlands> {
	private static final ResourceLocation TEXTURE_WEEDWOOD = new ResourceLocation(ModInfo.ID,
			"textures/tiles/weedwood_chest.png");
	private static final ResourceLocation TEXTURE_WEEDWOOD_LARGE = new ResourceLocation(ModInfo.ID,
			"textures/tiles/weedwood_chest_large.png");
	...
	@Override
	public void render(TileEntityChestBetweenlands te, double x, double y, double z, float partialTicks,
