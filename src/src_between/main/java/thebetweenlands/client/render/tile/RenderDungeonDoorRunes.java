...
public class RenderDungeonDoorRunes extends TileEntitySpecialRenderer<TileEntityDungeonDoorRunes> {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(ModInfo.ID,
			"textures/tiles/dungeon_door_runes.png");

	private static final ResourceLocation TEXTURE_1 = new ResourceLocation(ModInfo.ID,
			"textures/tiles/rune_overlay_1.png");
	private static final ResourceLocation TEXTURE_2 = new ResourceLocation(ModInfo.ID,
			"textures/tiles/rune_overlay_2.png");
	private static final ResourceLocation TEXTURE_3 = new ResourceLocation(ModInfo.ID,
			"textures/tiles/rune_overlay_3.png");
	private static final ResourceLocation TEXTURE_4 = new ResourceLocation(ModInfo.ID,
			"textures/tiles/rune_overlay_4.png");
	private static final ResourceLocation TEXTURE_5 = new ResourceLocation(ModInfo.ID,
			"textures/tiles/rune_overlay_5.png");
	private static final ResourceLocation TEXTURE_6 = new ResourceLocation(ModInfo.ID,
			"textures/tiles/rune_overlay_6.png");
	private static final ResourceLocation TEXTURE_7 = new ResourceLocation(ModInfo.ID,
			"textures/tiles/rune_overlay_7.png");
	private static final ResourceLocation TEXTURE_8 = new ResourceLocation(ModInfo.ID,
			"textures/tiles/rune_overlay_8.png");

	private static final ResourceLocation TEXTURE_RUNE_GLOW = new ResourceLocation(ModInfo.ID,
			"textures/tiles/dungeon_runes_glow.png");

	public void renderTile(TileEntityDungeonDoorRunes tile, double x, double y, double z, float partialTick,
		...
		if (!tile.isMimic())
			GlStateManager.translate(0F,
					0F + 0.1375F * (tile.last_tick_slate_1_rotate
							+ (tile.slate_1_rotate - tile.last_tick_slate_1_rotate) * partialTick) * 0.0625F,
					0F + 0.275F
							* (tile.last_tick_recess_pos + (tile.recess_pos - tile.last_tick_recess_pos) * partialTick)
							* 0.0625F);
		...
		if (tile.is_gate_entrance && tile.slate_1_rotate <= 270) {
			...
			IBakedModel itemModel = renderItem.getItemModelWithOverrides(tile.cachedStack(), (World) null,
					(EntityLivingBase) null);
			itemModel = ForgeHooksClient.handleCameraTransforms(itemModel, ItemCameraTransforms.TransformType.NONE,
					false);
	...
	@Override
	public void render(TileEntityDungeonDoorRunes tile, double x, double y, double z, float partialTicks,
			int destroyStage, float alpha) {
