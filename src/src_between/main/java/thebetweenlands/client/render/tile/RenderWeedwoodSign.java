...
public class RenderWeedwoodSign extends TileEntitySpecialRenderer<TileEntityWeedwoodSign> {
	private static final ResourceLocation SIGN_TEXTURE = new ResourceLocation(ModInfo.ID,
			"textures/tiles/weedwood_sign.png");

	private final ModelSign model = new ModelSign();

	@Override
	public void render(TileEntityWeedwoodSign te, double x, double y, double z, float partialTicks, int destroyStage,
			float alpha) {
