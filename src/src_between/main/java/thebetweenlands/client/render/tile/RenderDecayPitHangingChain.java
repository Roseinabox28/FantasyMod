...
public class RenderDecayPitHangingChain extends TileEntitySpecialRenderer<TileEntityDecayPitHangingChain> {
	...
	@Override
	public void render(TileEntityDecayPitHangingChain tile, double x, double y, double z, float partialTicks,
	...
	private void renderChainpart(TileEntityDecayPitHangingChain tile, double x, double y, double z, float scroll,
			float angle) {
