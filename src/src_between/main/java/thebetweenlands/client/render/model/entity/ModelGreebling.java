...
public class ModelGreebling extends MowzieModelBase {
	...
	public ModelGreebling() {
		...
		parts = new MowzieModelRenderer[] { root_0, body_base_0, chest_0, legleft1_0, legright1_0, head1_0, armleft1_0,
				armright1_0, jaw_0, head2_0, nose_0, earleft_0, earright_0, armleft2_0, lutebase_0, luteneck_0,
				endpiece1_0, armright2_0, strokestick_0, legleft2_0, legright2_0,

				cup_1, root_1, handle_1, body_base_1, chest_1, legleft1_1, legright1_1, head1_1, armright1_1,
				armleft1_1, jaw_1, head2_1, nose_1, earleft_1, earright_1, beard_1, armright2_1, panflute1_1,
				panflute2_1, panflute3_1, panflute4_1, armleft2_1, legleft2_1, legright2_1 };
		setInitPose();
	}
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if (greebling.getType() == 0) {
			float disappearFrame = greebling.disappearTimer > 0 ? (float) Math.pow(greebling.disappearTimer / 8f, 4)
					: 0;
