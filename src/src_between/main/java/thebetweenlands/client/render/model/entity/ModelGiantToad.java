...
public class ModelGiantToad extends MowzieModelBase {
	...
	public ModelGiantToad() {
		...
		parts = new MowzieModelRenderer[] { body_base, tubbyneck, leg_front_left1, leg_front_right1, sexy_toad_butt,
				leg_back_left1, leg_back_right1, head_base, snout1, lower_jaw, eyeleft1, eyebrow_left1, eyeright1,
				eyebrow_right1, beardthing_left1, beardthing_right1, snout2, beardthing_left3, beardthing_right3,
				eyebrow_left2, eyebrow_left3, eyebrow_left4, eyebrow_right2, eyebrow_right3, eyebrow_right4,
				beardthing_left2, beardthing_right2, leg_front_left2, foot_front_left1, foot_front_left2,
				toe_front_left1, toe_front_left2, toe_front_left3, toe_front_left4, leg_front_right2, foot_front_right1,
				foot_front_right2, toe_front_right1, toe_front_right2, toe_front_right3, toe_front_right4,
				leg_back_left2, foot_back_left1, foot_back_left2, toe_back_left1, toe_back_left2, toe_back_left3,
				toe_back_left4, leg_back_right2, foot_back_right1, foot_back_right2, toe_back_right1, toe_back_right2,
				toe_back_right3, toe_back_right4 };
