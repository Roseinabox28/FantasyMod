...
public interface IBakedModelDependant {
	/**
	 * Returns a list of model dependencies. If the model wasn't registered
	 * previously it will be loaded and baked with the arguments returned by
	 * {@link IBakedModelDependant#getModelState(IModel)},
	 * {@link IBakedModelDependant#getVertexFormat(IModel)} and
	 * {@link IBakedModelDependant#getTextureGetter(IModel)}.
	 * 
	 * @param modelLocation
	 * @return
	 */
