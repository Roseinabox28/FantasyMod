...
public class ModelShambler extends ModelBase {
	...
	@Override
	public void render(Entity entity, float limbSwing, float limbSwingAmount, float ticksExisted, float rotationYaw,
	...
	public void setLivingAnimations(EntityLivingBase entity, float limbSwing, float limbSwingAmount,
		...
		hindleg_left1.rotateAngleX = 0.5235987755982988F - (animation2 * 14F) + flap * 0.1F
				- flap * 0.075F / (180F / (float) Math.PI);
		hindleg_right1.rotateAngleX = 0.5235987755982988F - (animation * 14F) + flap * 0.1F
				- flap * 0.075F / (180F / (float) Math.PI);

		hindleg_left2.rotateAngleX = 0.4363323129985824F + (animation2 * 8F) - flap * 0.05F
				+ flap * 0.075F / (180F / (float) Math.PI);
		hindleg_right2.rotateAngleX = 0.4363323129985824F + (animation * 8F) - flap * 0.05F
				+ flap * 0.075F / (180F / (float) Math.PI);

		hindleg_left3.rotateAngleX = -1.0471975511965976F + (animation2 * 4F) + flap * 0.05F
				- flap * 0.075F / (180F / (float) Math.PI);
		hindleg_right3.rotateAngleX = -1.0471975511965976F + (animation * 4F) + flap * 0.05F
				- flap * 0.075F / (180F / (float) Math.PI);

		foot_left1.rotateAngleX = 0.4886921905584123F - (animation2 * 2F) - flap * 0.05F
				- flap * 0.075F / (180F / (float) Math.PI);
		foot_right1.rotateAngleX = 0.4886921905584123F - (animation * 2F) - flap * 0.05F
				- flap * 0.075F / (180F / (float) Math.PI);
		...
		mouth_arm1a.rotateAngleY = 0F + smoothedAngle / (180F / (float) Math.PI) * 4F
				- (!shambler.jawsAreOpen() ? 0F : flap * 0.3F);
		mouth_arm1a.rotateAngleX = 0.08726646259971647F - smoothedAngle / (180F / (float) Math.PI) * 3F
				- (!shambler.jawsAreOpen() ? 0F : flap * 0.1F);

		mouth_arm2a.rotateAngleY = 0F - smoothedAngle / (180F / (float) Math.PI) * 4F
				+ (!shambler.jawsAreOpen() ? 0F : flap * 0.3F);
		mouth_arm2a.rotateAngleX = 0.08726646259971647F - smoothedAngle / (180F / (float) Math.PI) * 3F
				- (!shambler.jawsAreOpen() ? 0F : flap * 0.1F);

		mouth_arm3a.rotateAngleY = 0F + smoothedAngle / (180F / (float) Math.PI) * 4F
				- (!shambler.jawsAreOpen() ? 0F : flap * 0.3F);
		mouth_arm3a.rotateAngleX = -0.08726646259971647F + smoothedAngle / (180F / (float) Math.PI) * 3F
				- (!shambler.jawsAreOpen() ? 0F : flap * 0.1F);

		mouth_arm4a.rotateAngleY = 0F - smoothedAngle / (180F / (float) Math.PI) * 4F
				+ (!shambler.jawsAreOpen() ? 0F : flap * 0.3F);
		mouth_arm4a.rotateAngleX = -0.08726646259971647F + smoothedAngle / (180F / (float) Math.PI) * 3F
				- (!shambler.jawsAreOpen() ? 0F : flap * 0.1F);

		mouth_arm1c.rotateAngleY = -0.5462880558742251F + smoothedAngle / (180F / (float) Math.PI) * 3F
				- (!shambler.jawsAreOpen() ? 0F : flap * 0.5F);
		mouth_arm2c.rotateAngleY = 0.5462880558742251F - smoothedAngle / (180F / (float) Math.PI) * 3F
				+ (!shambler.jawsAreOpen() ? 0F : flap * 0.5F);
		mouth_arm3c.rotateAngleY = -0.5462880558742251F + smoothedAngle / (180F / (float) Math.PI) * 3F
				- (!shambler.jawsAreOpen() ? 0F : flap * 0.5F);
		mouth_arm4c.rotateAngleY = 0.5462880558742251F - smoothedAngle / (180F / (float) Math.PI) * 3F
				+ (!shambler.jawsAreOpen() ? 0F : flap * 0.5F);

		tail2.rotateAngleX = 0.5009094953223726F - MathHelper.sin((animation) * 0.5009094953223726F) * 1F
				- 1F / 9 * shambler.getTongueLength() * 0.5F;
		tail3.rotateAngleX = 0.7740535232594852F - MathHelper.sin((animation) * 0.7740535232594852F) * 1F
				- 1F / 9 * shambler.getTongueLength() * 0.5F;
		tail4.rotateAngleX = 0.8651597102135892F - MathHelper.sin((animation) * 0.8651597102135892F) * 1F
				- 1F / 9 * shambler.getTongueLength();
		tail5.rotateAngleX = 0.8651597102135892F - MathHelper.sin((animation) * 0.8651597102135892F) * 1F
				- 1F / 9 * shambler.getTongueLength();
		tail6.rotateAngleX = 0.8196066167365371F - MathHelper.sin((animation) * 0.8196066167365371F) * 1F
				- 1F / 9 * shambler.getTongueLength() * 0.75F;
	}
