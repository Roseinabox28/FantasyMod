...
public class ModelPuffshroom extends ModelBase {
	...
	public void render(TileEntityPuffshroom tile, float partialTickTime) {
		...
		float interAnimationTicks_1 = tile.prev_animation_1
				+ (tile.animation_1 - tile.prev_animation_1) * partialTickTime;
		float interAnimationTicks_2 = tile.prev_animation_2
				+ (tile.animation_2 - tile.prev_animation_2) * partialTickTime;
		float interAnimationTicks_3 = tile.prev_animation_3
				+ (tile.animation_3 - tile.prev_animation_3) * partialTickTime;
		float interAnimationTicks_4 = tile.prev_animation_4
				+ (tile.animation_4 - tile.prev_animation_4) * partialTickTime;
		...
		back_r_tent_1.rotateAngleX = -0.7853981633974483F + interAnimationTicks_3 / (180F / (float) Math.PI) * 11.25F
				+ flap;
		front_r_tent_1.rotateAngleX = -0.7853981633974483F + interAnimationTicks_3 / (180F / (float) Math.PI) * 11.25F
				- flap2;
		back_l_tent_1.rotateAngleX = -0.7853981633974483F + interAnimationTicks_3 / (180F / (float) Math.PI) * 11.25F
				- flap2;
		front_l_tent_1.rotateAngleX = -0.7853981633974483F + interAnimationTicks_3 / (180F / (float) Math.PI) * 11.25F
				+ flap;
		...
		back_r_tent_3.rotateAngleX = -0.7853981633974483F
				+ (interAnimationTicks_3 - interAnimationTicks_4 * 0.5F) / (180F / (float) Math.PI) * 11.25F
				+ flap * 4F;
		front_r_tent_3.rotateAngleX = -0.7853981633974483F
				+ (interAnimationTicks_3 - interAnimationTicks_4 * 0.5F) / (180F / (float) Math.PI) * 11.25F
				- flap2 * 4F;
		back_l_tent_3.rotateAngleX = -0.7853981633974483F
				+ (interAnimationTicks_3 - interAnimationTicks_4 * 0.5F) / (180F / (float) Math.PI) * 11.25F
				- flap2 * 4F;
		front_l_tent_3.rotateAngleX = -0.7853981633974483F
				+ (interAnimationTicks_3 - interAnimationTicks_4 * 0.5F) / (180F / (float) Math.PI) * 11.25F
				+ flap * 4F;
		...
		if (tile.animation_1 < 8) {
			...
			if (tile.animation_4 >= 10)
				GlStateManager.scale(1.75F - interAnimationTicks_4 * 0.0625F, 1F,
						1.75F - interAnimationTicks_4 * 0.0625F);
