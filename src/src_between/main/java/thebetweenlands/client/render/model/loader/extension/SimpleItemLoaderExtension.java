...
public class SimpleItemLoaderExtension extends LoaderExtension {
	...
	public IModel loadModel(IModel original, ResourceLocation location, String arg) {
		...
		this.dummyReplacementMap.put(new ModelResourceLocation(
				new ResourceLocation(childModel.getNamespace(), childModel.getPath()), "inventory"), location);
	...
	private IModel findReplacementModelAndRegister(ResourceLocation location,
			ResourceLocation replacementModelLocation) {
