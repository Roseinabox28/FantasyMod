...
public class ModelBloodSnail extends ModelBase {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float rotationYaw,
		...
		super.setRotationAngles(limbSwing, limbSwingAngle, entityTickTime, rotationYaw, rotationPitch, unitPixel,
				entity);
		sensorleft1.rotateAngleX = sensorleft2.rotateAngleX = MathHelper.cos(limbSwing * 1F + (float) Math.PI) * 1.5F
				* limbSwingAngle + 0.5F;
		sensorright1.rotateAngleX = sensorright2.rotateAngleX = MathHelper.cos(limbSwing * 1F) * 1.5F * limbSwingAngle
				+ 0.5F;
		sensorleft1.rotateAngleY = sensorleft2.rotateAngleY = MathHelper.cos(limbSwing * 1F + (float) Math.PI) * 1.5F
				* limbSwingAngle + 0.2F;
		sensorright1.rotateAngleY = sensorright2.rotateAngleY = MathHelper.cos(limbSwing * 1F) * 1.5F * limbSwingAngle
				- 0.2F;
	}
}
