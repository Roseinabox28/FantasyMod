	...
	public void setLivingAnimations(EntityLivingBase entity, float limbSwing, float limbSwingAngle,
		...
		if (!crypt_crawler.isBiped()) {
			...
			if (crypt_crawler.standingAngle < 0.01f) {
				...
				leg_front_right3[0].rotateAngleX = 0.5918411493512771F - (standingAngle * 1.25F) - 0.17453292519943295F
						- animation2 * 18F + flap * 0.05F;
				...
				leg_front_left3[0].rotateAngleX = 0.5918411493512771F - (standingAngle * 1.25F) - 0.17453292519943295F
						- (animation * 18F) + flap * 0.05F;

				leg_back_right1[0].rotateAngleX = 0.27314402793711257F - (standingAngle * 0.75F) - 0.1F
						- (animation2 * 6F) - flap * 0.05F;
				leg_back_left1[0].rotateAngleX = 0.27314402793711257F - (standingAngle * 0.75F) - 0.1F
						- (animation3 * 6F) - flap * 0.05F;
				...
				leg_back_right2[0].rotateAngleX = standingAngle - 0.7740535232594852F
						+ (leg_back_right1[0].rotateAngleX + animation2) + flap * 0.1F;
				leg_back_left2[0].rotateAngleX = standingAngle - 0.7740535232594852F
						+ (leg_back_left1[0].rotateAngleX + animation3) + flap * 0.1F;

				leg_back_right3[0].rotateAngleX = 0.8651597102135892F - (standingAngle * 0.5F)
						- (leg_back_right1[0].rotateAngleX * 1.25F) - flap * 0.05F;
				leg_back_left3[0].rotateAngleX = 0.8651597102135892F - (standingAngle * 0.5F)
						- (leg_back_left1[0].rotateAngleX * 1.25F) - flap * 0.05F;
				...
				neck[0].rotateAngleX = 0.27314402793711257F - (standingAngle * 0.5F) - 0.17453292519943295F
						+ (animation2 * 2.9F) + flap * 0.025F;
				...
				leg_front_right1[0].rotateAngleX = 0.27314402793711257F + (standingAngle * 0.5F * flap)
						+ animation2 * 6F;
				...
				leg_back_right2[0].rotateAngleX = -0.7740535232594852F + (standingAngle * 1.25F)
						+ (leg_back_right1[0].rotateAngleX + animation2);
				leg_back_left2[0].rotateAngleX = -0.7740535232594852F + (standingAngle * 1.25F)
						+ (leg_back_left1[0].rotateAngleX + animation3);

				leg_back_right3[0].rotateAngleX = 0.8651597102135892F + (standingAngle * 0.125F)
						- leg_back_right1[0].rotateAngleX * 1.25F;
				leg_back_left3[0].rotateAngleX = 0.8651597102135892F + (standingAngle * 0.125F)
						- leg_back_left1[0].rotateAngleX * 1.25F;
				...
				neck[0].rotateAngleX = 0.27314402793711257F + (standingAngle * 0.25F) - 0.17453292519943295F
						+ animation2 * 2.9F;
