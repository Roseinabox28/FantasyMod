...
public class ModelPestleAndMortar extends ModelBase {
	...
	/*
	 * ModelRenderer driedherb1; ModelRenderer driedherb1a; ModelRenderer
	 * driedherb1b; ModelRenderer driedherb1c;
	 */
	public ModelPestleAndMortar() {
		 ...
		 * driedherb1.setRotationPoint(6.0F, 12.0F, 0.0F); driedherb1.addBox(0.0F,
		 * -1.0F, -3.0F, 0, 6, 6, 0.0F); setRotateAngle(driedherb1, -0.136659280431156F,
		 * 3.142F, -0.136659280431156F); driedherb1a = new ModelRenderer(this, 73, 47);
		 * driedherb1a.setRotationPoint(0.0F, 5.0F, 0.0F); driedherb1a.addBox(0.0F,
		 * 0.0F, -3.0F, 0, 4, 6, 0.0F); setRotateAngle(driedherb1a, -0.045553093477052F,
		 * 0.0F, 0.091106186954104F); driedherb1b = new ModelRenderer(this, 86, 48);
		 * driedherb1b.setRotationPoint(0.0F, 0.0F, 0.0F); driedherb1b.addBox(0.0F,
		 * 0.0F, -2.5F, 0, 6, 5, 0.0F); setRotateAngle(driedherb1b, -0.091106186954104F,
		 * 0.0F, -0.136659280431156F); driedherb1c = new ModelRenderer(this, 97, 48);
		 * driedherb1c.setRotationPoint(0.0F, 0.0F, 0.0F); driedherb1c.addBox(0.0F,
		 * -1.0F, -2.5F, 0, 7, 5, 0.0F); setRotateAngle(driedherb1c,
		 * -0.22759093446006054F, 0.22759093446006054F, -0.136659280431156F);
		 */
		...
		/*
		 * driedherb1.addChild(driedherb1a); driedherb1.addChild(driedherb1b);
