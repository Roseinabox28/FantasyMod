...
public class ModelDreadfulMummy extends MowzieModelBase {
	...
	public ModelDreadfulMummy() {
		...
		parts = new MowzieModelRenderer[] { shoulders, shoulderright, shoulderleft, neck, body_base, aestheticleg1,
				aestheticleg2, frontLeftArmJoint, frontRightArmJoint, backLeftLegJoint, armright1, armleft1, armleft2,
				head1, head2, tongue1, teeth_upper, jaw, teeth_lower, tongue2, tongue3, tongue4, tongue5, sexybutt,
				legright1, legleft1, legright2, aestheticleg1a, aestheticleg1b, aestheticleg2a, spiderleg1, spiderleg1a,
				spiderleg1b, spiderleg2, spiderleg2a, spiderleg2b, spiderleg3, spiderleg3a, spiderleg3b };
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		if (mummy.deathTicks > 0) {
			double contractAngle = this.body_base.rotateAngleX
					- this.body_base.rotateAngleX / (mummy.deathTicks / 120.0D + 1.0D);
