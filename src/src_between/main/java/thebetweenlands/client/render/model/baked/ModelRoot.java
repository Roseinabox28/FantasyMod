...
public class ModelRoot implements IModel {
	...
	public Collection<ResourceLocation> getTextures() {
		return Collections.unmodifiableCollection(
				Arrays.asList(new ResourceLocation[] { this.textureTop, this.textureMiddle, this.textureBottom }));
	}

	@Override
	public IBakedModel bake(IModelState state, VertexFormat format,
			java.util.function.Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
		return new ModelBakedRoot(format, bakedTextureGetter.apply(this.textureTop),
				bakedTextureGetter.apply(this.textureMiddle), bakedTextureGetter.apply(this.textureBottom));
	}
	...
	public static class ModelBakedRoot implements IBakedModel {
		...
		private ModelBakedRoot(VertexFormat format, TextureAtlasSprite textureTop, TextureAtlasSprite textureMiddle,
				TextureAtlasSprite textureBottom) {
			this.format = format;
			this.textureTop = textureTop;
			this.textureMiddle = textureMiddle;
			this.textureBottom = textureBottom;
