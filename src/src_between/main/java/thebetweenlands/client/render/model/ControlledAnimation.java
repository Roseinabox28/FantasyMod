...
public class ControlledAnimation {
	...
	/**
	 * It is the limit time, the maximum value that the timer can be. I represents
	...
	/**
	 * Returns a float that represents a fraction of the animation, a value between
	 * 0.0F and 1.0F.
	 */
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using 1/(1 + e^(4-8*x)). It is quite uniform
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using 1/(1 + e^(6-12*x)). It is quite uniform,
	 * but fast.
	 */
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using a sine function. It is fast in the
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using a sine function squared. It is very
	 * smooth.
	 */
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using a sine function to the power of ten. It
	 * is slow in the beginning and fast in the end.
	 */
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using a sine function to a specific power "i."
	 *
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using x^2 / (x^2 + (1-x)^2). It is smooth.
	 */
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using x^3 / (x^3 + (1-x)^3). It is steep.
	 */
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using x^n / (x^n + (1-x)^n). It is steeper
	 * when n increases.
	 *
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. It reaches 1.0F using 0.5 + arctan(PI * (x - 0.5)) /
	 * 2.00776964. It is super smooth.
	 */
	public float getAnimationProgressArcTan(float partialRenderTicks) {
		return (float) (0.5F
				+ 0.49806510671F * Math.atan(3.14159265359D * (getAnimationFraction(partialRenderTicks) - 0.5D)));
	}

	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. This value starts at 1.0F and ends at 1.0F. The equation used
	...
	/**
	 * Returns a value between 0.0F and 1.0F depending on the timer and duration of
	 * the animation. This value starts at 0.0F and ends at 0.0F. The equation used
