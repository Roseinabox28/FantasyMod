...
/**
 * BLRootSprite - TripleHeadedSheep Created using Tabula 7.0.0
 */
public class ModelRootSprite extends ModelBase {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		this.footright.rotateAngleX = MathHelper.cos(limbSwing * 2F + (float) Math.PI) * 1.4F * limbSwingAmount * 0.5F
				+ 0.1F - wobbleX;
