...
public class OverworldRiftSkyRenderer implements IRiftSkyRenderer {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		float[] afloat = this.calcSunriseSunsetColors(world, this.getCelestialAngle(worldTime, partialTicks),
				partialTicks);
		...
		if (afloat != null) {
			...
			GlStateManager.rotate(
					MathHelper.sin(this.getCelestialAngleRadians(worldTime, partialTicks)) < 0.0F ? 180.0F : 0.0F, 0.0F,
					0.0F, 1.0F);
		...
		if (BetweenlandsConfig.RENDERING.skyRiftClouds) {
			...
			WorldProviderBetweenlands providerBl = world.provider instanceof WorldProviderBetweenlands
					? (WorldProviderBetweenlands) world.provider
					: null;
	...
	public void updateFogColor(WorldClient world, float partialTicks, Minecraft mc) {
		...
		/*
		 * float f13 = this.fogColor2 + (this.fogColor1 - this.fogColor2) *
		 * partialTicks; this.fogColorRed *= f13; this.fogColorGreen *= f13;
