...
public class RiftVariant {
	public static final RiftVariant DEFAULT = new RiftVariant(
			...
			new ResourceLocation(ModInfo.ID, "textures/sky/rifts/sky_rift_overlay_1.png"), null, 0, 360, -90, 90, 0,
			360, 0.5f, 1, true, true);
	...
	public RiftVariant(ResourceLocation maskTexture, ResourceLocation overlayTexture,
			ResourceLocation altOverlayTexture, float minYaw, float maxYaw, float minPitch, float maxPitch,
			float minRoll, float maxRoll, float minScale, float maxScale, boolean mirrorU, boolean mirrorV) {
