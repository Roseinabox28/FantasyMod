...
public class LayerAttachedItems<T extends EntityLivingBase> implements LayerRenderer<T> {
	...
	public LayerAttachedItems<T> attach(ModelRenderer part, Function<T, ItemStack> stack, EnumHandSide side,
			float scale, Consumer<ModelRenderer> transformSetter) {
	...
	@Override
	public void doRenderLayer(EntityLivingBase entityIn, float limbSwing, float limbSwingAmount, float partialTicks,
