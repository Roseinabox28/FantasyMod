...
public class RenderMireSnailEgg extends RenderLiving<EntityMireSnailEgg> {
	public static final ResourceLocation TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/entity/mire_snail_egg.png");
	...
	protected void preRenderCallback(EntityMireSnailEgg entitylivingbaseIn, float partialTickTime) {
		GlStateManager.scale(2.5F + entitylivingbaseIn.pulseFloat, 2.5F + entitylivingbaseIn.pulseFloat,
				2.5F + entitylivingbaseIn.pulseFloat);
	}
