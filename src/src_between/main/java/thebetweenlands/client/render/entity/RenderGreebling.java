...
public class RenderGreebling extends RenderLiving<EntityGreebling> {
	public static final ResourceLocation TEXTURE_0 = new ResourceLocation(
			"thebetweenlands:textures/entity/greebling_0.png");
	public static final ResourceLocation TEXTURE_1 = new ResourceLocation(
			"thebetweenlands:textures/entity/greebling_1.png");
