...
public class RenderEmberling extends RenderLiving<EntityEmberling> {
	public static final ResourceLocation TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/entity/emberling.png");

	public RenderEmberling(RenderManager renderManagerIn) {
		super(renderManagerIn, new ModelEmberling(), 0.5F);
		addLayer(new LayerOverlay<EntityEmberling>(this,
				new ResourceLocation("thebetweenlands:textures/entity/emberling_glow.png")).setGlow(true));
	}
