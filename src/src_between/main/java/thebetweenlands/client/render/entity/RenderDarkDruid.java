...
public class RenderDarkDruid extends RenderLiving<EntityDarkDruid> {
	...
	public static class LayerDruidGlow implements LayerRenderer<EntityDarkDruid> {
		private static final ResourceLocation GLOW = new ResourceLocation(
				"thebetweenlands:textures/entity/dark_druid_glow.png");
		...
		@Override
		public void doRenderLayer(EntityDarkDruid entity, float limbSwing, float limbSwingAmount, float partialTicks,
			...
			if (!entity.isInvisible()) {
				...
				this.renderer.getMainModel().render(entity, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw,
						headPitch, scale);
