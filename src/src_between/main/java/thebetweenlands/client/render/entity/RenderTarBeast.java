...
public class RenderTarBeast extends RenderLiving<EntityTarBeast> {
	public static final ResourceLocation TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/entity/tar_beast.png");
	public static final ResourceLocation EYE_TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/entity/tar_beast_eyes.png");
