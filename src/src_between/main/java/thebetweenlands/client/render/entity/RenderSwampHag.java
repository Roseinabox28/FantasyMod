...
public class RenderSwampHag extends RenderLiving<EntitySwampHag> {
	public static final ResourceLocation TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/entity/swamp_hag.png");

	public RenderSwampHag(RenderManager rendermanagerIn) {
		super(rendermanagerIn, new ModelSwampHag(), 0.5F);
		this.addLayer(new LayerOverlay<EntitySwampHag>(this,
				new ResourceLocation("thebetweenlands:textures/entity/swamp_hag_eyes.png")).setGlow(true));
	}
