...
public class RenderSpiritTreeFaceLarge extends RenderWallFace<EntitySpiritTreeFaceLarge> {
	...
	public RenderSpiritTreeFaceLarge(RenderManager renderManager) {
		...
		this.addLayer(this.glow = new LayerOverlay<>(this,
				new ResourceLocation(ModInfo.ID, "textures/entity/spirit_tree_face_large_glow.png")).setGlow(true));
	}
	...
	protected void preRenderCallback(EntitySpiritTreeFaceLarge entity, float partialTicks) {
		...
		float scale = 0.8F
				+ entity.getHalfMovementProgress(partialTicks) * entity.getHalfMovementProgress(partialTicks) * 0.2F;
