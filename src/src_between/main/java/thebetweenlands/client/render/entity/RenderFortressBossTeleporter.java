...
public class RenderFortressBossTeleporter extends Render<EntityFortressBossTeleporter> {
	protected static final ResourceLocation MODEL_TEXTURE = new ResourceLocation(
	...
	@Override
	public void doRender(EntityFortressBossTeleporter entity, double x, double y, double z, float yaw,
			float partialTicks) {
		...
		GlStateManager.translate(MODEL.eye.rotationPointX * 0.065F / 2.0F, MODEL.eye.rotationPointY * 0.065F / 2.0F,
				MODEL.eye.rotationPointZ * 0.065F / 2.0F);
		...
		GlStateManager.translate(-MODEL.eye.rotationPointX * 0.065F / 2.0F,
				-MODEL.eye.rotationPointY * 0.065F / 2.0F + 0.3D, -MODEL.eye.rotationPointZ * 0.065F / 2.0F);
