...
public class LayerTarBeastEffects implements LayerRenderer<EntityTarBeast> {
	public static final ResourceLocation OVERLAY_TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/entity/tar_beast_overlay.png");
	...
	@Override
	public void doRenderLayer(EntityTarBeast entity, float limbSwing, float limbSwingAmount, float partialTicks,
