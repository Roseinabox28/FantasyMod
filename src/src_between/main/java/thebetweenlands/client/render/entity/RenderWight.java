...
public class RenderWight extends RenderLiving<EntityWight> {
	...
	public static final ResourceLocation TEXTURE_FROSTY = new ResourceLocation(
			"thebetweenlands:textures/entity/wight_frosty.png");
	...
	protected void preRenderCallback(EntityWight entity, float partialTickTime) {
		if (ShaderHelper.INSTANCE.isWorldShaderActive()) {
			...
			ShaderHelper.INSTANCE.getWorldShader()
					.addLight(new LightSource(entity.posX, entity.posY, entity.posZ, 10.0f, -1, -1, -1));
		}
