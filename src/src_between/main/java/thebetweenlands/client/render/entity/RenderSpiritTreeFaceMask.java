...
public class RenderSpiritTreeFaceMask extends Render<EntitySpiritTreeFaceMask> {
	private static final ResourceLocation TEXTURE_LARGE = new ResourceLocation(ModInfo.ID,
			"textures/entity/spirit_tree_face_large.png");
	private static final ResourceLocation TEXTURE_SMALL = new ResourceLocation(ModInfo.ID,
	...
	@Override
	public void doRender(EntitySpiritTreeFaceMask entity, double x, double y, double z, float entityYaw,
			float partialTicks) {
