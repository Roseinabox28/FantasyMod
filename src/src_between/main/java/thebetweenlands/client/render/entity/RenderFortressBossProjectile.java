...
public class RenderFortressBossProjectile extends Render<EntityFortressBossProjectile> {
	...
	@Override
	public void doRender(EntityFortressBossProjectile entity, double x, double y, double z, float rotationYaw,
			float partialTickTime) {
		renderProjectile(entity, x, y, z, rotationYaw, partialTickTime);
	}

	public void renderProjectile(EntityFortressBossProjectile entity, double x, double y, double z, float rotationYaw,
			float partialTickTime) {
