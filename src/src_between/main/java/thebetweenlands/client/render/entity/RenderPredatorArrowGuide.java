...
public class RenderPredatorArrowGuide extends Render<EntityPredatorArrowGuide> {
	...
	@Override
	public void doRender(EntityPredatorArrowGuide entity, double x, double y, double z, float entityYaw,
			float partialTicks) {
		...
		if (target != null) {
			...
			double targetIy = target.lastTickPosY + (target.posY - target.lastTickPosY) * partialTicks
					+ target.getEyeHeight();
