...
public class RenderMovingWall extends Render<EntityMovingWall> {
	...
	public void doRender(EntityMovingWall entity, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		IBakedModel itemModel1 = renderItem.getItemModelWithOverrides(entity.cachedStackTop(), (World) null,
				(EntityLivingBase) null);
		itemModel1 = ForgeHooksClient.handleCameraTransforms(itemModel1, ItemCameraTransforms.TransformType.NONE,
				false);

		IBakedModel itemModel2 = renderItem.getItemModelWithOverrides(entity.cachedStackMid(), (World) null,
				(EntityLivingBase) null);
		itemModel2 = ForgeHooksClient.handleCameraTransforms(itemModel2, ItemCameraTransforms.TransformType.NONE,
				false);

		IBakedModel itemModel3 = renderItem.getItemModelWithOverrides(entity.cachedStackBot(), (World) null,
				(EntityLivingBase) null);
		itemModel3 = ForgeHooksClient.handleCameraTransforms(itemModel3, ItemCameraTransforms.TransformType.NONE,
				false);
