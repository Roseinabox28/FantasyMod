...
public class ClientProxy extends CommonProxy implements IResourceManagerReloadListener {
	...
	public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
		...
		case GUI_LURKER_POUCH: {
			...
			if (!item.isEmpty() && item.getItem() instanceof ItemLurkerSkinPouch) {
				String name = item.hasDisplayName() ? item.getDisplayName()
						: I18n.format("container.bl.lurker_skin_pouch");
				return new GuiPouch(new ContainerPouch(player, player.inventory,
	...
	/*
	 * @Override public void registerDefaultBlockItemRenderer(Block block) { if
	 * (block instanceof BlockRegistry.ISubBlocksBlock) { List<String> models =
	 * ((BlockRegistry.ISubBlocksBlock) block).getModels(); if (block instanceof
	 * BlockDruidStone) {
	 * ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
	 * new ModelResourceLocation(ModInfo.ASSETS_PREFIX + models.get(0),
	 * "inventory"));
	 * ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 4,
	 * new ModelResourceLocation(ModInfo.ASSETS_PREFIX + models.get(1),
	 * "inventory")); } else for (int i = 0; i < models.size(); i++) { if
	 * (ConfigHandler.DEBUG.debug && createJSONFile)
	 ...
	 * new ModelResourceLocation(ModInfo.ASSETS_PREFIX + models.get(i),
	 * "inventory")); } } else { String name =
	 * block.getRegistryName().toString().replace("thebetweenlands:", ""); if
	 * (ConfigHandler.DEBUG.debug && createJSONFile)
	 * JsonRenderGenerator.createJSONForBlock(block, name);
	 * ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
	 * new ModelResourceLocation(ModInfo.ASSETS_PREFIX + name, "inventory")); } }
	 */
	@Override
	...
	public Map<Integer, ResourceLocation> getItemModelMap(Item item) {
		...
		if (item instanceof ItemRegistry.IMultipleItemModelDefinition) {
			for (Entry<Integer, ResourceLocation> model : ((ItemRegistry.IMultipleItemModelDefinition) item).getModels()
					.entrySet()) {
			...
			for (Entry<Integer, String> variant : ((ItemRegistry.IBlockStateItemModelDefinition) item).getVariants()
					.entrySet()) {
				map.put(variant.getKey(),
						new ModelResourceLocation(item.getRegistryName().toString(), variant.getValue()));
			}
		} else {
	...
	public void preInit() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityShockwaveSwordItem.class,
				manager -> new RenderShockwaveSwordItem(manager, Minecraft.getMinecraft().getRenderItem()));
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityAngryPebble.class,
				manager -> new RenderAngryPebble(manager, Minecraft.getMinecraft().getRenderItem()));
		RenderingRegistry.registerEntityRenderingHandler(EntityFortressBoss.class, RenderFortressBoss::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityFortressBossSpawner.class,
				RenderFortressBossSpawner::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityFortressBossBlockade.class,
				RenderFortressBossBlockade::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityFortressBossProjectile.class,
				RenderFortressBossProjectile::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityFortressBossTurret.class, RenderFortressBossTurret::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityFortressBossTeleporter.class,
				RenderFortressBossTeleporter::new);
		...
		RenderingRegistry.registerEntityRenderingHandler(EntitySpiritTreeFaceSmall.class,
				RenderSpiritTreeFaceSmall::new);
		RenderingRegistry.registerEntityRenderingHandler(EntitySpiritTreeFaceLarge.class,
				RenderSpiritTreeFaceLarge::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityTamedSpiritTreeFace.class,
				RenderSpiritTreeFaceSmall::new);
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityTriggeredFallingBlock.class,
				RenderTriggeredFallingBlock::new);
		RenderingRegistry.registerEntityRenderingHandler(EntitySludgeWallJet.class, RenderSludgeWallJet::new);
		RenderingRegistry.registerEntityRenderingHandler(EntityTriggeredSludgeWallJet.class,
				RenderTriggeredSludgeWallJet::new);
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityMobSpawnerBetweenlands.class,
				new RenderSpawnerBetweenlands());
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityDungeonDoorCombination.class,
				new RenderDungeonDoorCombination());
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityDecayPitHangingChain.class,
				new RenderDecayPitHangingChain());
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityDecayPitGroundChain.class,
				new RenderDecayPitGroundChain());
	...
	public void postInit() {
		...
		Item.getItemFromBlock(BlockRegistry.WEEDWOOD_CHEST)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityChestBetweenlands.class));
		Item.getItemFromBlock(BlockRegistry.DRUID_ALTAR)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityDruidAltar.class));
		Item.getItemFromBlock(BlockRegistry.COMPOST_BIN)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityCompostBin.class));
		Item.getItemFromBlock(BlockRegistry.PURIFIER)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityPurifier.class));
		Item.getItemFromBlock(BlockRegistry.MOB_SPAWNER).setTileEntityItemStackRenderer(
				new RenderItemStackAsTileEntity(TileEntityMobSpawnerBetweenlands.class));
		Item.getItemFromBlock(BlockRegistry.SPIKE_TRAP)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntitySpikeTrap.class));
		Item.getItemFromBlock(BlockRegistry.POSSESSED_BLOCK)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityPossessedBlock.class));
		Item.getItemFromBlock(BlockRegistry.ITEM_CAGE)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityItemCage.class));
		Item.getItemFromBlock(BlockRegistry.GECKO_CAGE)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityGeckoCage.class));
		Item.getItemFromBlock(BlockRegistry.INFUSER)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityInfuser.class));
		Item.getItemFromBlock(BlockRegistry.MORTAR)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityMortar.class));
		Item.getItemFromBlock(BlockRegistry.ANIMATOR)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityAnimator.class));
		Item.getItemFromBlock(BlockRegistry.ALEMBIC)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityAlembic.class));
		Item.getItemFromBlock(BlockRegistry.ITEM_SHELF)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityItemShelf.class));
		Item.getItemFromBlock(BlockRegistry.REPELLER)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityRepeller.class));
		Item.getItemFromBlock(BlockRegistry.TAR_LOOT_POT)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(renderer -> {
		...
		Item.getItemFromBlock(BlockRegistry.WAYSTONE)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityWaystone.class));
		Item.getItemFromBlock(BlockRegistry.WEEDWOOD_CHEST)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityChestBetweenlands.class));
		Item.getItemFromBlock(BlockRegistry.CENSER)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityCenser.class));
		Item.getItemFromBlock(BlockRegistry.WEEDWOOD_BARREL)
				.setTileEntityItemStackRenderer(new RenderItemStackAsTileEntity(TileEntityBarrel.class));
				...
				if (Item.getItemFromBlock(block) != Items.AIR) {
					Minecraft.getMinecraft().getItemColors()
							.registerItemColorHandler(
									(stack, tintIndex) -> tintedBlock.getColorMultiplier(((ItemBlock) stack.getItem())
											.getBlock().getStateFromMeta(stack.getMetadata()), null, null, tintIndex),
									block);
				}
				Minecraft.getMinecraft().getBlockColors().registerBlockColorHandler(tintedBlock::getColorMultiplier,
						block);
			}
		}
		...
		pixelLove = new FontRenderer(Minecraft.getMinecraft().gameSettings,
				new ResourceLocation("thebetweenlands:textures/gui/manual/font_atlas.png"),
		...
		/*
		 * if (ConfigHandler.blMainMenu) { Field background =
		 * ReflectionHelper.findField(Gui.class, "OPTIONS_BACKGROUND"); try {
		 * setFinalStatic(background, new ResourceLocation(ModInfo.ID,
		 * "textures/blocks/temple_bricks.png")); } catch (IllegalAccessException |
		 * NoSuchFieldException e) { e.printStackTrace(); } } }
		 * 
		 * private static void setFinalStatic(Field field, Object newValue) throws
		 * NoSuchFieldException, IllegalAccessException { field.setAccessible(true);
		 * Field modifiers = field.getClass().getDeclaredField("modifiers");
		 * modifiers.setAccessible(true); modifiers.setInt(field, field.getModifiers() &
		 * ~Modifier.FINAL); field.set(null, newValue);
		 */
	}
	...
	public void spawnCustomParticle(String particleName, World world, double x, double y, double z, double vecX,
		...
		if (particleName.equals("spell"))
			fx = new ParticleSpell.Factory().createParticle(EnumParticleTypes.SPELL.getParticleID(), world, x, y, z,
					vecX, vecY, vecZ, 0);

		if (particleName.equals("flame"))
			fx = new ParticleFlame.Factory().createParticle(EnumParticleTypes.FLAME.getParticleID(), world, x, y, z,
					vecX, vecY, vecZ, 0);

		if (particleName.equals("egg_sac")) {
			fx = new ParticleBreaking.SnowballFactory().createParticle(EnumParticleTypes.SNOWBALL.getParticleID(),
					world, x, y, z, vecX, vecY, vecZ, 0);
	...
	private void loadRiftVariants() {
		...
		try {
			IResource riftsFile = Minecraft.getMinecraft().getResourceManager()
					.getResource(new ResourceLocation(ModInfo.ID, "textures/sky/rifts/rifts.json"));
			...
			try (InputStreamReader reader = new InputStreamReader(riftsFile.getInputStream())) {
				...
				for (int i = 0; i < array.size(); i++) {
					...
					ResourceLocation textureOverlay = new ResourceLocation(
							JsonUtils.getString(jsonObj, "texture_overlay"));
					textureOverlay = new ResourceLocation(textureMask.getNamespace(),
							"textures/" + textureOverlay.getPath());
					...
					if (jsonObj.has("texture_alt_overlay")) {
						...
						textureAltOverlay = new ResourceLocation(textureAltOverlay.getNamespace(),
								"textures/" + textureAltOverlay.getPath());
					}
