...
public class GuiDownloadTerrainBetweenlands extends GuiScreen {
	...
	public static void onGuiOpened(GuiOpenEvent event) {
		...
		if (event.getGui() instanceof GuiDownloadTerrain && client.player != null
				&& (client.player.dimension == BetweenlandsConfig.WORLD_AND_DIMENSION.dimensionId
						|| prevDimension == BetweenlandsConfig.WORLD_AND_DIMENSION.dimensionId)) {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRenderer, I18n.format("multiplayer.downloadingTerrain"), this.width / 2,
