...
public class GuiFirefly extends Gui {
	public static final ResourceLocation FIREFLY_TEXTURE = new ResourceLocation(ModInfo.ID,
			"textures/gui/main/firefly.png");
	...
	public void drawFireFly(Minecraft minecraft, float partialTicks) {
		...
		GlStateManager.scale(
				(0.1F + (float) (Math.sin(interpUpdateCounter) * Math.sin(interpUpdateCounter)) / 4) * 0.1F,
				(0.1F + (float) (Math.sin(interpUpdateCounter) * Math.sin(interpUpdateCounter)) / 4) * 0.1F, 1);
