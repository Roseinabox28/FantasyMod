...
public class GuiDruidAltar extends GuiContainer {
	private static final ResourceLocation GUI_DRUID_ALTAR = new ResourceLocation(
			"thebetweenlands:textures/gui/druid_altar.png");
	...
	protected void drawGuiContainerForegroundLayer(int x, int y) {
		...
		// fontRendererObj.drawString(StatCollector.translateToLocal(tile.getInventoryName()),
		// 8, 6, 4210752);
	...
	protected void drawGuiContainerBackgroundLayer(float partialTickTime, int x, int y) {
		...
		/*
		 * I don't like this rendering in the gui if (tile.getStackInSlot(0) == null) {
