...
public class GuiBLFurnace extends GuiContainer {
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(
			"thebetweenlands:textures/gui/sulfur_furnace.png");
	...
	protected void drawGuiContainerForegroundLayer(int x, int y) {
		String s = this.tileFurnace.hasCustomName() ? this.tileFurnace.getName()
				: I18n.format(this.tileFurnace.getName(), new Object[0]);
