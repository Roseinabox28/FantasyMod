...
public class GuiItemNaming extends GuiContainer {
	public static final ResourceLocation GUI_TEXTURE = new ResourceLocation(
			"thebetweenlands:textures/gui/item_renaming.png");
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiItemNamingButton(1, xOffSet, yOffSet - 18, 46, 18,
				I18n.format("container.bl.item_renaming.save")));
	}
			...
			if (button.id == 1) {
				if (StringUtils.isNullOrEmpty(this.textFieldName.getText())) {
					...
					TheBetweenlands.networkWrapper
							.sendToServer(new MessageItemNaming(this.textFieldName.getText(), this.hand));
				}
