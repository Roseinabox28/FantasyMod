...
public class EntitySound<T extends Entity> extends SafeStreamSound implements IEntitySound {
	...
	public void update() {
		...
		if (this.fadeOut || this.entity == null || !this.entity.isEntityAlive() || this.entity.isDead
				|| !this.entity.world.isBlockLoaded(this.entity.getPosition()) || !this.isPlaying.test(this.entity)) {
			this.repeat = false;
			this.fadeOut = true;
