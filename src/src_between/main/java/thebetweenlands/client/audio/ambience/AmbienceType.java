...
public abstract class AmbienceType {
	...
	/**
	 * Defines the compatibility and priorities with other playing ambient tracks in
	 * the same layer
	 */
	public abstract AmbienceLayer getAmbienceLayer();

	/**
	 * Defines the priority over other ambient tracks. Higher number means higher
	 * priority.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the volume that lower priority ambiences should be clamped to. Return
	 * <= 0 if other sounds should should stop playing completely.
	 * 
	 * @return
	 */
