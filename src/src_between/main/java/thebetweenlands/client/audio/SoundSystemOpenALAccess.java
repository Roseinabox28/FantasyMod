...
public class SoundSystemOpenALAccess {
	...
	/**
	 * Cleans up any resources claimed by this object
	 */
	...
	/**
	 * Returns whether an error has occurred such that the OpenAL access can't be
	 * used
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the {@link SourceLWJGLOpenAL} for the specified sound, or null if
	 * none is found. Not synchronized -> must only be called through
	 * {@link #submitToSoundSystem(Callable)}
	 * 
	 * @param sound
	 * @return
	...
	/**
	 * Returns the {@link ChannelLWJGLOpenAL} for the specified sound, or null if
	 * none is found. Not synchronized -> must only be called through
	 * {@link #submitToSoundSystem(Callable)}
	 * 
	 * @param sound
	...
	/**
	 * Sets the current offset (i.e. time since start) for the specified sound. Not
	 * synchronized -> must only be called through
	 * {@link #submitToSoundSystem(Callable)}. <b>Only works for non-streamed
	 * sounds!</b>
	 * 
	 * @param sound
	 * @param seconds
	 ...
	 * or -1 if the sound is not playing. Not synchronized -> must only be called
	 * through {@link #submitToSoundSystem(Callable)}. <b>Only works for
	 * non-streamed sounds!</b>
	 * 
	 * @param sound
	 * @return
	 */
