	...
	public void update() {
		...
		if (this.entity != null && !this.entity.isDead) {
			if (this.mustFadeOut) {
				...
				if (!this.music.isMusicActive(Minecraft.getMinecraft().player)
						|| this.entity.getDistance(Minecraft.getMinecraft().player) > this.music
								.getMusicRange(Minecraft.getMinecraft().player)) {
					this.repeat = false;
					this.fadeOut = true;
