...
public class PurifierRecipeCategory implements IRecipeCategory {
	private final ResourceLocation backgroundLocation = new ResourceLocation(
			ModInfo.ID + ":textures/gui/manual/purifier_grid.png");
	@Nonnull
	protected final IDrawable background = BetweenlandsJEIPlugin.jeiHelper.getGuiHelper()
			.createDrawable(backgroundLocation, 0, 0, 107, 61);

	@Nonnull
	private final IDrawable tank = BetweenlandsJEIPlugin.jeiHelper.getGuiHelper().createDrawable(backgroundLocation,
			168, 1, 10, 58);
