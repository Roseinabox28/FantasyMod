...
public class SapCleanRecipeJEI implements ICraftingRecipeWrapper, ICustomCraftingRecipeWrapper {
	...
	public void getIngredients(IIngredients ingredients) {
		...
		for (ItemStack stack : coatableItems) {
			...
			((ICorrodible) corroded.getItem()).setCorrosion(corroded,
					((ICorrodible) corroded.getItem()).getMaxCorrosion(corroded));
	...
	public void setRecipe(IRecipeLayout recipeLayout, IIngredients ingredients) {
		...
		if (focus != null && focus.getValue() instanceof ItemStack
				&& ((ItemStack) focus.getValue()).getItem() instanceof ICorrodible) {
