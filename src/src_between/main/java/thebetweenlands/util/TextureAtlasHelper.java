...
public class TextureAtlasHelper {
	...
	/**
	 * Creates a new texture atlas helper. Some padding may be required in order to
	 * prevent texture bleeding caused by anisotropic filtering. The padding must be
	 * the same on all sides of a segment.
	 * 
	 ...
	 */
	public TextureAtlasHelper(int texWidth, int texHeight, int segmentWidth, int segmentHeight, int horizontalPadding,
			int verticalPadding) {
	...
	/**
	 * Creates a new texture atlas helper with equal texture, segment and padding
	 * width/height. Some padding may be required in order to prevent texture
	 * bleeding caused by anisotropic filtering. The padding must be the same on all
	 * sides of a segment.
	 * 
	...
	/**
	 * Returns the relative (0.0 - 1.0) min. and max. UVs for the given segment of
	 * the texture. Index 0 is min. UV coordinates and index 1 is max. UV
	 * coordinates.
	 * 
	...
	/**
	 * Returns the relative (0.0 - 1.0) min. and max. interpolated UVs for the given
	 * segment of the texture. Index 0 is min. UV coordinates and index 1 is max. UV
	 * coordinates.
	 * 
	 * @param segment Texture segment
	 * @param umin
