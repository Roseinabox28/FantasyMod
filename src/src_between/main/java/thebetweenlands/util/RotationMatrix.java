...
public class RotationMatrix {
	...
	/**
	 * Transforms/Rotates the given point around the given center and returns the
	 * result.
	 * 
	...
	public Vec3d transformVec(Vec3d point, Vec3d centerPoint) {
		...
		return new Vec3d(this.matrix[0] * px + this.matrix[1] * py + this.matrix[2] * pz + centerPoint.x,
