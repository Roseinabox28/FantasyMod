...
public class FakeClientWorld/* extends World */ {
	public static final WorldSettings worldSettings = new WorldSettings(0, GameType.SURVIVAL, true, false,
			WorldType.DEFAULT);
	 ...
	 * 
	 * @Override public DimensionType getDimensionType() { return
	 * DimensionType.OVERWORLD; }
	 * 
	 * @Override public long getWorldTime() { return worldInfo.getWorldTime(); } };
	 * 
	 * public FakeClientWorld() { super(saveHandler, worldInfo, worldProvider, new
	 * Profiler(), true); }
	 * 
	 ...
	 * 
	 * @Override public String makeString() { return null; }
	 * 
	 * @Override public boolean isChunkGeneratedAt(int p_191062_1_, int p_191062_2_)
	 * { return false; } }; }
	 * 
