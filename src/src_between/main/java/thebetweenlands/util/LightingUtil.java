...
public class LightingUtil {
	...
	/**
	 * Sets the currently used lighting (0 - 255). Use {@link LightingUtil#revert()}
	 * after rendering to revert to previous lighting.
	 *
	 * @param lighting
	 */
	public void setLighting(int lighting) {
		...
		OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, 238.0f / 255.0f * lighting,
				238.0f / 255.0f * lighting);
	}
