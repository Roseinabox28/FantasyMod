...
public class NBTHelper {
	...
	/**
	 * Returns <tt>true</tt> if the two specifies item stacks' NBT compound tags are
	 ...
	 */
	public static boolean areItemStackTagsEqualWithoutCapabilities(ItemStack a, ItemStack b,
			AbstractCapability<?, ?, ?>... exclusions) {
	...
	/**
	 * Returns <tt>true</tt> if the two specified NBT compound tags are <i>equal</i>
	 * to one another. Two NBT compound tags are considered equal if both NBT
	 * compounds tags contain all of the same keys with the same values, while
	 * ignoring tags whose keys are in the exclusions list.
	 * 
	 * @param a          one NBT compound tag to be tested for equality
	 * @param b          the other NBT compound tag to be tested for equality
	 * @param exclusions a list of tags to be excluded in checking equality
