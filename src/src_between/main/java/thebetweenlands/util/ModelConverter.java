...
public class ModelConverter {
	...
	public static final class Box {
		...
		public Box rotate(float rotation, float x, float y, float z, Vec3UV center) {
			ROTATION_MATRIX.setRotations((float) Math.toRadians(x * rotation), (float) Math.toRadians(y * rotation),
					(float) Math.toRadians(z * rotation));
		...
		private Model(List<Box> modelBoxList, Vec3UV fwdVec, Vec3UV upVec) {
			...
			for (Box box : modelBoxList) {
				...
				for (int i = 0; i < box.quads.length; i++) {
					...
					quads[i] = new Quad(new Vec3UV(quad.vertices[0]), new Vec3UV(quad.vertices[1]),
							new Vec3UV(quad.vertices[2]), new Vec3UV(quad.vertices[3]));
				}
	...
	// Holds a list of all parent components and sub-parent components of each
	// ModelRenderer of this model
	...
	/**
	 * Creates a new ModelConverter that converts a minecraft model to a list of
	 * vertices and UVs.
	 * 
	 * @param packing          The texture packing
	 * @param model            The model
	 * @param scale            Scale of the model (usually 0.065)
	 * @param renderDoubleFace Set to true if the faces should be rendered in both
	 *                         directions
	 */
	 ...
	 */
	public ModelConverter(@Nullable Packing packing, ModelBase model, double scale, boolean renderDoubleFace,
			float rotationX, float rotationY, float rotationZ, Vec3UV rotationCenter) {
	 ...
	 * @return
	 */
	private Vec3UV transformPosition(Vec3UV scaledPos, ModelRenderer modelRenderer, RotationMatrix rotationMatrix,
			double modelScale) {
		Vec3UV scaledRotPos = new Vec3UV(modelRenderer.rotationPointX * modelScale,
				modelRenderer.rotationPointY * modelScale, modelRenderer.rotationPointZ * modelScale);

		// Dirty fix to prevent some bugs when rotation == 0
		if (modelRenderer.rotateAngleX == 0.0F && modelRenderer.rotateAngleY == 0.0F
	 ...
	 * @return
	 */
	private Vec3UV getBoxCorner(boolean xb, boolean yb, boolean zb, ModelBox modelBox, ModelRenderer modelRenderer,
			double modelScale, RotationMatrix rotationMatrix) {
	...
	private void constructModel(ModelBase modelBase, double modelScale, boolean renderDoubleFace) {
		...
		for (ModelRenderer modelRenderer : (List<ModelRenderer>) modelBase.boxList) {
			for (ModelBox modelBox : (List<ModelBox>) modelRenderer.cubeList) {
				...
				// Face 1
				this.addQuadFace(o, oy, oxy, ox, mbVertices5[0], mbVertices5[3], mbVertices5[2], mbVertices5[1],
						modelWidth, modelHeight, renderDoubleFace, quadList, packerQuads);
				/*
				 * Quad face1 = new Quad( new Vec3UV(o, mbVertices5[0].texturePositionX,
				 * mbVertices5[0].texturePositionY, modelWidth, modelHeight), new Vec3UV(oy,
				 * mbVertices5[3].texturePositionX, mbVertices5[3].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxy, mbVertices5[2].texturePositionX,
				 * mbVertices5[2].texturePositionY, modelWidth, modelHeight), new Vec3UV(ox,
				 * mbVertices5[1].texturePositionX, mbVertices5[1].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face1); if(renderDoubleFace) { Quad face1d = new
				 * Quad( new Vec3UV(o, mbVertices5[0].texturePositionX,
				 * mbVertices5[0].texturePositionY, modelWidth, modelHeight), new Vec3UV(ox,
				 * mbVertices5[1].texturePositionX, mbVertices5[1].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxy, mbVertices5[2].texturePositionX,
				 * mbVertices5[2].texturePositionY, modelWidth, modelHeight), new Vec3UV(oy,
				 * mbVertices5[3].texturePositionX, mbVertices5[3].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face1d); }
				 */

				// Face 2
				this.addQuadFace(oz, oxz, oxyz, oyz, mbVertices6[1], mbVertices6[0], mbVertices6[3], mbVertices6[2],
						modelWidth, modelHeight, renderDoubleFace, quadList, packerQuads);
				/*
				 * Quad face2 = new Quad( new Vec3UV(oz, mbVertices6[1].texturePositionX,
				 * mbVertices6[1].texturePositionY, modelWidth, modelHeight), new Vec3UV(oxz,
				 * mbVertices6[0].texturePositionX, mbVertices6[0].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxyz, mbVertices6[3].texturePositionX,
				 * mbVertices6[3].texturePositionY, modelWidth, modelHeight), new Vec3UV(oyz,
				 * mbVertices6[2].texturePositionX, mbVertices6[2].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face2); if(renderDoubleFace) { Quad face2d = new
				 * Quad( new Vec3UV(oz, mbVertices6[1].texturePositionX,
				 * mbVertices6[1].texturePositionY, modelWidth, modelHeight), new Vec3UV(oyz,
				 * mbVertices6[2].texturePositionX, mbVertices6[2].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxyz, mbVertices6[3].texturePositionX,
				 * mbVertices6[3].texturePositionY, modelWidth, modelHeight), new Vec3UV(oxz,
				 * mbVertices6[0].texturePositionX, mbVertices6[0].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face2d); }
				 */

				// Face 3
				this.addQuadFace(oy, oyz, oxyz, oxy, mbVertices4[1], mbVertices4[2], mbVertices4[3], mbVertices4[0],
						modelWidth, modelHeight, renderDoubleFace, quadList, packerQuads);
				/*
				 * Quad face3 = new Quad( new Vec3UV(oy, mbVertices4[1].texturePositionX,
				 * mbVertices4[1].texturePositionY, modelWidth, modelHeight), new Vec3UV(oyz,
				 * mbVertices4[2].texturePositionX, mbVertices4[2].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxyz, mbVertices4[3].texturePositionX,
				 * mbVertices4[3].texturePositionY, modelWidth, modelHeight), new Vec3UV(oxy,
				 * mbVertices4[0].texturePositionX, mbVertices4[0].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face3); if(renderDoubleFace) { Quad face3d = new
				 * Quad( new Vec3UV(oy, mbVertices4[1].texturePositionX,
				 * mbVertices4[1].texturePositionY, modelWidth, modelHeight), new Vec3UV(oxy,
				 * mbVertices4[0].texturePositionX, mbVertices4[0].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxyz, mbVertices4[3].texturePositionX,
				 * mbVertices4[3].texturePositionY, modelWidth, modelHeight), new Vec3UV(oyz,
				 * mbVertices4[2].texturePositionX, mbVertices4[2].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face3d); }
				 */

				// Face 4
				this.addQuadFace(o, ox, oxz, oz, mbVertices3[2], mbVertices3[3], mbVertices3[0], mbVertices3[1],
						modelWidth, modelHeight, renderDoubleFace, quadList, packerQuads);
				/*
				 * Quad face4 = new Quad( new Vec3UV(o, mbVertices3[2].texturePositionX,
				 * mbVertices3[2].texturePositionY, modelWidth, modelHeight), new Vec3UV(ox,
				 * mbVertices3[3].texturePositionX, mbVertices3[3].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxz, mbVertices3[0].texturePositionX,
				 * mbVertices3[0].texturePositionY, modelWidth, modelHeight), new Vec3UV(oz,
				 * mbVertices3[1].texturePositionX, mbVertices3[1].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face4); if(renderDoubleFace) { Quad face4d = new
				 * Quad( new Vec3UV(o, mbVertices3[2].texturePositionX,
				 * mbVertices3[2].texturePositionY, modelWidth, modelHeight), new Vec3UV(oz,
				 * mbVertices3[1].texturePositionX, mbVertices3[1].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxz, mbVertices3[0].texturePositionX,
				 * mbVertices3[0].texturePositionY, modelWidth, modelHeight), new Vec3UV(ox,
				 * mbVertices3[3].texturePositionX, mbVertices3[3].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face4d); }
				 */

				// Face 5
				this.addQuadFace(ox, oxy, oxyz, oxz, mbVertices1[1], mbVertices1[2], mbVertices1[3], mbVertices1[0],
						modelWidth, modelHeight, renderDoubleFace, quadList, packerQuads);
				/*
				 * Quad face5 = new Quad( new Vec3UV(ox, mbVertices1[1].texturePositionX,
				 * mbVertices1[1].texturePositionY, modelWidth, modelHeight), new Vec3UV(oxy,
				 * mbVertices1[2].texturePositionX, mbVertices1[2].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxyz, mbVertices1[3].texturePositionX,
				 * mbVertices1[3].texturePositionY, modelWidth, modelHeight), new Vec3UV(oxz,
				 * mbVertices1[0].texturePositionX, mbVertices1[0].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face5); if(renderDoubleFace) { Quad face5d = new
				 * Quad( new Vec3UV(ox, mbVertices1[1].texturePositionX,
				 * mbVertices1[1].texturePositionY, modelWidth, modelHeight), new Vec3UV(oxz,
				 * mbVertices1[0].texturePositionX, mbVertices1[0].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oxyz, mbVertices1[3].texturePositionX,
				 * mbVertices1[3].texturePositionY, modelWidth, modelHeight), new Vec3UV(oxy,
				 * mbVertices1[2].texturePositionX, mbVertices1[2].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face5d); }
				 */

				// Face 6
				this.addQuadFace(o, oz, oyz, oy, mbVertices2[0], mbVertices2[1], mbVertices2[2], mbVertices2[3],
						modelWidth, modelHeight, renderDoubleFace, quadList, packerQuads);
				/*
				 * Quad face6 = new Quad( new Vec3UV(o, mbVertices2[0].texturePositionX,
				 * mbVertices2[0].texturePositionY, modelWidth, modelHeight), new Vec3UV(oz,
				 * mbVertices2[1].texturePositionX, mbVertices2[1].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oyz, mbVertices2[2].texturePositionX,
				 * mbVertices2[2].texturePositionY, modelWidth, modelHeight), new Vec3UV(oy,
				 * mbVertices2[3].texturePositionX, mbVertices2[3].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face6); if(renderDoubleFace) { Quad face6d = new
				 * Quad( new Vec3UV(o, mbVertices2[0].texturePositionX,
				 * mbVertices2[0].texturePositionY, modelWidth, modelHeight), new Vec3UV(oy,
				 * mbVertices2[3].texturePositionX, mbVertices2[3].texturePositionY, modelWidth,
				 * modelHeight), new Vec3UV(oyz, mbVertices2[2].texturePositionX,
				 * mbVertices2[2].texturePositionY, modelWidth, modelHeight), new Vec3UV(oz,
				 * mbVertices2[1].texturePositionX, mbVertices2[1].texturePositionY, modelWidth,
				 * modelHeight)); quadList.add(face6d); }
				 */
	...
	private void addQuadFace(Vec3UV v1, Vec3UV v2, Vec3UV v3, Vec3UV v4, PositionTextureVertex tv1,
			PositionTextureVertex tv2, PositionTextureVertex tv3, PositionTextureVertex tv4, double modelWidth,
			double modelHeight, boolean renderDoubleFace, List<Quad> quadList, List<TextureQuad> packerQuads) {
		...
		if (this.packing != null) {
			...
			Quad face = new Quad(
					new Vec3UV(v1, packerQuad, maxUVertex1 == 0 || maxUVertex2 == 0,
							maxVVertex1 == 0 || maxVVertex2 == 0, modelWidth, modelHeight),
					new Vec3UV(v4, packerQuad, maxUVertex1 == 3 || maxUVertex2 == 3,
							maxVVertex1 == 3 || maxVVertex2 == 3, modelWidth, modelHeight),
					new Vec3UV(v3, packerQuad, maxUVertex1 == 2 || maxUVertex2 == 2,
							maxVVertex1 == 2 || maxVVertex2 == 2, modelWidth, modelHeight),
					new Vec3UV(v2, packerQuad, maxUVertex1 == 1 || maxUVertex2 == 1,
							maxVVertex1 == 1 || maxVVertex2 == 1, modelWidth, modelHeight));
			quadList.add(face);
			if (renderDoubleFace) {
			...
			Quad face = new Quad(new Vec3UV(v1, tv1.texturePositionX, tv1.texturePositionY, modelWidth, modelHeight),
	...
	/**
	 * Recursively returns a list of all parents and sub-parents of the given
	 * ModelRenderer. Used to simulate previous rotations and transformations.
	 * 
