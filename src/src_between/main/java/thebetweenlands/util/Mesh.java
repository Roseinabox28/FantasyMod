...
public class Mesh {
	...
	public static List<Triangle> createBoxOccluded(double x, double y, double z, double x2, double y2, double z2,
			boolean front, boolean back, boolean bottom, boolean top, boolean right, boolean left, int colorFront,
			int colorBack, int colorBottom, int colorTop, int colorRight, int colorLeft) {
		double width = x2 - x;
		double height = y2 - y;
		double depth = z2 - z;
		...
		if (front) {
			// Front face
			triangles.add(new Triangle(new Vertex(x + width, y + height, z, new Vector3D(0, 0, 1), colorFront),
					new Vertex(x + width, y, z, new Vector3D(0, 0, 1), colorFront),
					new Vertex(x, y, z, new Vector3D(0, 0, 1), colorFront)));
			triangles.add(new Triangle(new Vertex(x, y, z, new Vector3D(0, 0, 1), colorFront),
					new Vertex(x, y + height, z, new Vector3D(0, 0, 1), colorFront),
					new Vertex(x + width, y + height, z, new Vector3D(0, 0, 1), colorFront)));
		}
		if (back) {
			// Back face
			triangles.add(new Triangle(new Vertex(x, y, z + depth, new Vector3D(0, 0, -1), colorBack),
