...
public class ElixirEffect {
	...
	public void registerPotion(String name) {
		this.potionEffect = (ElixirPotionEffect) new ElixirPotionEffect(this, this.effectName, this.color, this.icon)
		...
		for (ElixirAttributeModifier modifier : this.elixirAttributeModifiers) {
			this.potionEffect.registerPotionAttributeModifier(modifier.attribute, modifier.uuid, modifier.modifier,
					modifier.operation);
		}
	}
	 ...
	 * Instant effect
	 */
	protected void affectEntity(@Nullable Entity source, @Nullable Entity indirectSource, EntityLivingBase target,
	...
	public static class ElixirPotionEffect extends Potion {
		...
		public void renderInventoryEffect(int x, int y, PotionEffect effect, Minecraft mc) {
			...
			if (this.nameContainer == null) {
				this.nameContainer = new TextContainer(88, 100, this.localizedElixirName,
		...
		@Override
		public void affectEntity(@Nullable Entity source, @Nullable Entity indirectSource, EntityLivingBase target,
				int amplifier, double health) {
