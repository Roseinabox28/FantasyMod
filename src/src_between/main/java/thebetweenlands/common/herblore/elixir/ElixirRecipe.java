...
public class ElixirRecipe {
	...
	public ElixirRecipe(String name, int infusionGradient, int infusionFinishedColor, int infusionFailedColor,
			int idealInfusionTime, int infusionTimeVariation, int baseDuration, int durationModifier,
			int negativeBaseDuration, int negativeDurationModifier, ElixirEffect positiveElixir,
			ElixirEffect negativeElixir, IAspectType[] aspects) {
	...
	public ElixirRecipe(String name, int infusionGradient, int infusionFinishedColor, int infusionFailedColor,
			int idealInfusionTime, int infusionTimeVariation, int baseDuration, int durationModifier,
			int negativeBaseDuration, int negativeDurationModifier, ElixirEffect positiveElixir,
			ElixirEffect negativeElixir, IAspectType strengthAspect, IAspectType durationAspect,
			IAspectType[] aspects) {
		this.name = name;
