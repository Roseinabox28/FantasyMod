...
public class HLEntryRegistry {
	...
	public static void initAspectEntries() {
		...
		aspectPages.add(new Page("aspect_info", false, manualType, new PictureWidget(16, 12,
				"thebetweenlands:textures/gui/manual/manual_hl.png", 122, 150, 454, 271, 1024.0D, 1024.0D)));
		for (IAspectType aspect : AspectRegistry.ASPECT_TYPES) {
			aspectPages.addAll(PageCreators.AspectPages(aspect, manualType));
		}

		entryPages.add(new Page("aspect_list", false, manualType, new PictureWidget(16, 12,
				"thebetweenlands:textures/gui/manual/manual_hl.png", 122, 150, 162, 271, 1024.0D, 1024.0D)));
		int pageNumber = 1;
		...
		tempItems.add(0,
				new Page("ingredient_info", false, manualType, new PictureWidget(16, 12,
						"thebetweenlands:textures/gui/manual/manual_hl.png", 122, 150, 600, 271, 1024.0D, 1024.0D))
								.setPageNumber(tempNum));
		entryPages.add(new Page("ingredient_list", false, manualType, new PictureWidget(16, 12,
				"thebetweenlands:textures/gui/manual/manual_hl.png", 122, 150, 308, 271, 1024.0D, 1024.0D)));
		...
		entryPages.add(0,
				new Page("intro_1", false, manualType,
						new PictureWidget(16, 12, "thebetweenlands:textures/gui/manual/manual_hl.png", 122, 150, 16,
								271, 1024.0D, 1024.0D),
						new ButtonWidget(31, 49, 87, 9, 6, false), new ButtonWidget(31, 68, 55, 9, 1, true),
						new ButtonWidget(31, 86, 73, 9, tempNum, true)));
	...
	public static void initElixirEntries() {
		...
		for (ElixirEffect effect : ElixirEffectRegistry.getEffects()) {
			if (effect != ElixirEffectRegistry.EFFECT_PETRIFY && effect != ElixirEffectRegistry.EFFECT_ISOLATEDSENSES
					&& effect != ElixirEffectRegistry.EFFECT_LIMBLESS && effect != ElixirEffectRegistry.EFFECT_DEFORMED
					&& effect != ElixirEffectRegistry.EFFECT_HUNTERSSENSEMASTER
					&& effect != ElixirEffectRegistry.EFFECT_WINGS
					&& effect != ElixirEffectRegistry.EFFECT_GILLSGROWTH) {
				if (effect.isAntiInfusion())
					antiInfusionPages.addAll(PageCreators
							.elixirPages(ItemRegistry.ELIXIR.getElixirItem(effect, 1, 1, 0), manualType, effect));
				else
					infusionPages.addAll(PageCreators.elixirPages(ItemRegistry.ELIXIR.getElixirItem(effect, 1, 1, 0),
							manualType, effect));
			}
		}
		...
		infusionPages.add(0,
				new Page("infusions", false, manualType, new PictureWidget(16, 12,
						"thebetweenlands:textures/gui/manual/manual_hl.png", 122, 150, 16, 451, 1024.0D, 1024.0D))
								.setPageNumber(1));
		temp.clear();
		...
		antiInfusionPages.add(0,
				new Page("infusions", false, manualType, new PictureWidget(16, 12,
						"thebetweenlands:textures/gui/manual/manual_hl.png", 122, 150, 162, 451, 1024.0D, 1024.0D))
								.setPageNumber(infusionPages.size()));
		elixirPages.clear();
