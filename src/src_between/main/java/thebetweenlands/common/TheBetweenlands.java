...
public class TheBetweenlands {
	...
	public static void preInit(FMLPreInitializationEvent event) {
		...
		dimensionType = DimensionType.register(DIMENSION_NAME, "_betweenlands",
				BetweenlandsConfig.WORLD_AND_DIMENSION.dimensionId, WorldProviderBetweenlands.class, false);
		...
		// Temp packet
		networkWrapper.registerMessage(PacketParticle.class, PacketParticle.class, 100, Side.CLIENT); // ID 100 until
																										// added
		// Renderers
	...
	public void postInit(FMLPostInitializationEvent event) {
		 ...
		 * (String name : unlocalizedNames) { System.out.println("needs translation: " +
		 * name); }
		 * System.out.println("=================================================="); }
		 */
	}
	...
	public void serverLoad(FMLServerStartingEvent event) {
		...
		/*
		 * if (ConfigHandler.DEBUG.debug) { event.registerServerCommand(new
		 * CommandTickSpeed()); }
		 */
