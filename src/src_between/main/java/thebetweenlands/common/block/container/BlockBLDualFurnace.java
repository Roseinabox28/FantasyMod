...
public class BlockBLDualFurnace extends BlockContainer implements ICustomItemBlock {
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
		...
		if (world.isRemote)
			...
			if (tileentityfurnace != null)
				player.openGui(TheBetweenlands.instance, CommonProxy.GUI_BL_DUAL_FURNACE, world, pos.getX(), pos.getY(),
						pos.getZ());
			return true;
		}
	}
	...
	public static void setState(boolean active, World world, BlockPos pos) {
		...
		if (active)
			world.setBlockState(pos, BlockRegistry.SULFUR_FURNACE_DUAL_ACTIVE.getDefaultState().withProperty(FACING,
					iblockstate.getValue(FACING)), 3);
		else
			world.setBlockState(pos, BlockRegistry.SULFUR_FURNACE_DUAL.getDefaultState().withProperty(FACING,
					iblockstate.getValue(FACING)), 3);
