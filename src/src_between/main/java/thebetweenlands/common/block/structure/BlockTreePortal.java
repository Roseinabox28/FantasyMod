...
public class BlockTreePortal extends BasicBlock implements ICustomItemBlock {
	...
	public static boolean makePortalX(World world, BlockPos pos) {
		world.setBlockState(pos.add(0, 2, -1),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION,
								BlockPortalFrame.EnumPortalFrame.CORNER_TOP_RIGHT)
						.withProperty(BlockPortalFrame.X_AXIS, true));
		world.setBlockState(pos.add(0, 2, 0),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION, BlockPortalFrame.EnumPortalFrame.TOP)
						.withProperty(BlockPortalFrame.X_AXIS, true));
		world.setBlockState(pos.add(0, 2, 1),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION, BlockPortalFrame.EnumPortalFrame.CORNER_TOP_LEFT)
						.withProperty(BlockPortalFrame.X_AXIS, true));
		world.setBlockState(pos.add(0, 1, -1),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION, BlockPortalFrame.EnumPortalFrame.SIDE_RIGHT)
						.withProperty(BlockPortalFrame.X_AXIS, true));
		world.setBlockState(pos.add(0, 1, 1),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION, BlockPortalFrame.EnumPortalFrame.SIDE_LEFT)
						.withProperty(BlockPortalFrame.X_AXIS, true));
		...
		world.setBlockState(pos.add(0, -1, -1),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION,
								BlockPortalFrame.EnumPortalFrame.CORNER_BOTTOM_RIGHT)
						.withProperty(BlockPortalFrame.X_AXIS, true));
		world.setBlockState(pos.add(0, -1, 0),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION, BlockPortalFrame.EnumPortalFrame.BOTTOM)
						.withProperty(BlockPortalFrame.X_AXIS, true));
		world.setBlockState(pos.add(0, -1, 1),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION,
								BlockPortalFrame.EnumPortalFrame.CORNER_BOTTOM_LEFT)
						.withProperty(BlockPortalFrame.X_AXIS, true));

		if (isPatternValidX(world, pos)) {
			world.setBlockState(pos, BlockRegistry.TREE_PORTAL.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Z),
					2);
			world.setBlockState(pos.up(),
					BlockRegistry.TREE_PORTAL.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Z), 2);
			return true;
		}
		return false;
	}
	...
	public static boolean makePortalZ(World world, BlockPos pos) {
		world.setBlockState(pos.add(-1, 2, 0),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION,
								BlockPortalFrame.EnumPortalFrame.CORNER_TOP_RIGHT)
						.withProperty(BlockPortalFrame.X_AXIS, false));
		world.setBlockState(pos.add(0, 2, 0),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION, BlockPortalFrame.EnumPortalFrame.TOP)
						.withProperty(BlockPortalFrame.X_AXIS, false));
		world.setBlockState(pos.add(1, 2, 0),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION, BlockPortalFrame.EnumPortalFrame.CORNER_TOP_LEFT)
						.withProperty(BlockPortalFrame.X_AXIS, false));
		world.setBlockState(pos.add(-1, 1, 0),
				BlockRegistry.PORTAL_FRAME.getDefaultState()
						.withProperty(BlockPortalFrame.FRAME_POSITION, BlockPortalFrame.EnumPortalFrame.SIDE_RIGHT)
						.withProperty(BlockPortalFrame.X_AXIS, false));
		world.setBlockState(pos.add(1, 1, 0),
		...
		if (isPatternValidZ(world, pos)) {
			world.setBlockState(pos, BlockRegistry.TREE_PORTAL.getDefaultState().withProperty(AXIS, EnumFacing.Axis.X),
					2);
			world.setBlockState(pos.up(),
					BlockRegistry.TREE_PORTAL.getDefaultState().withProperty(AXIS, EnumFacing.Axis.X), 2);
			return true;
		}
	...
	public static boolean isPatternValidX(IBlockAccess world, BlockPos pos) {
		...
		if (!check(world, pos.down(), BlockRegistry.PORTAL_FRAME)
				&& !checkPortal(world, pos.down(), BlockRegistry.TREE_PORTAL, EnumFacing.Axis.Z)) {
			return false;
		}
	...
	public static boolean isPatternValidZ(IBlockAccess world, BlockPos pos) {
		// Layer 0
		if (!check(world, pos.down(), BlockRegistry.PORTAL_FRAME)
				&& !checkPortal(world, pos.down(), BlockRegistry.TREE_PORTAL, EnumFacing.Axis.X)) {
			return false;
		}
	...
	protected boolean canBlockStay(World world, BlockPos pos) {
		if (checkPortal(world, pos.up(), BlockRegistry.TREE_PORTAL, EnumFacing.Axis.Z) && isPatternValidX(world, pos))
			return true;
		if (checkPortal(world, pos.down(), BlockRegistry.TREE_PORTAL, EnumFacing.Axis.Z)
				&& isPatternValidX(world, pos.down()))
			return true;
		if (checkPortal(world, pos.up(), BlockRegistry.TREE_PORTAL, EnumFacing.Axis.X) && isPatternValidZ(world, pos))
			return true;
		if (checkPortal(world, pos.down(), BlockRegistry.TREE_PORTAL, EnumFacing.Axis.X)
				&& isPatternValidZ(world, pos.down()))
			return true;
		else {
	...
	public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
		if (!entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn.timeUntilPortal <= 0
				&& BetweenlandsConfig.WORLD_AND_DIMENSION.portalDimensionWhitelistSet.isListed(entityIn.dimension)) {
			...
			if (aabb != null && aabb.offset(pos).intersects(entityIn.getEntityBoundingBox())) {
				...
				List<LocationPortal> portals = worldStorage.getLocalStorageHandler()
						.getLocalStorages(LocationPortal.class, entityAabb, loc -> loc.intersects(entityAabb));
	...
	public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		for (int i = 0; i < 4; i++) {
			...
			if (worldIn.getBlockState(pos.add(-1, 0, 0)).getBlock() != this
					&& worldIn.getBlockState(pos.add(1, 0, 0)).getBlock() != this) {
			...
			BLParticles.PORTAL.spawn(worldIn, particleX, particleY, particleZ,
					ParticleArgs.get().withMotion(motionX, motionY, motionZ));
		}

		if (rand.nextInt(20) == 0) {
			worldIn.playSound(pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, SoundRegistry.PORTAL,
					SoundCategory.BLOCKS, 0.3F, rand.nextFloat() * 0.4F + 0.8F, false);
		}
	}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		...
		List<LocationPortal> portals = worldStorage.getLocalStorageHandler().getLocalStorages(LocationPortal.class,
				new AxisAlignedBB(pos).grow(1, 1, 1), null);
