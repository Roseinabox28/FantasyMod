...
public class BlockCarvedMudBrick extends BasicBlock implements ICustomItemBlock, ISubtypeItemBlockModelDefinition {
	...
	public static final PropertyEnum<EnumCarvedMudBrickType> VARIANT = PropertyEnum
			.<EnumCarvedMudBrickType>create("variant", EnumCarvedMudBrickType.class);

	public BlockCarvedMudBrick() {
		super(Material.ROCK);
		this.setDefaultState(
				this.blockState.getBaseState().withProperty(VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED));
		setHardness(1.5F);
		setResistance(10.0F);
	...
	public static enum EnumCarvedMudBrickType implements IStringSerializable {
		MUD_BRICKS_CARVED, MUD_BRICKS_CARVED_DECAY_1, MUD_BRICKS_CARVED_DECAY_2, MUD_BRICKS_CARVED_DECAY_3,
		MUD_BRICKS_CARVED_DECAY_4, MUD_BRICKS_CARVED_EDGE, MUD_BRICKS_CARVED_EDGE_DECAY_1,
		MUD_BRICKS_CARVED_EDGE_DECAY_2, MUD_BRICKS_CARVED_EDGE_DECAY_3, MUD_BRICKS_CARVED_EDGE_DECAY_4,
		MUD_BRICKS_DECAY_1, MUD_BRICKS_DECAY_2, MUD_BRICKS_DECAY_3, MUD_BRICKS_DECAY_4;
