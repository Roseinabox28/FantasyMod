...
public class BlockFenceBetweenlands extends Block {
	...
	public BlockFenceBetweenlands(IBlockState state) {
		...
		setResistance(5.0F);
		setDefaultState(
				this.blockState.getBaseState().withProperty(NORTH, Boolean.FALSE).withProperty(EAST, Boolean.FALSE)
	...
	public BlockFaceShape getBlockFaceShape(IBlockAccess world, IBlockState state, BlockPos pos, EnumFacing facing) {
		return facing != EnumFacing.UP && facing != EnumFacing.DOWN ? BlockFaceShape.MIDDLE_POLE
