...
public class BlockMobSpawnerBetweenlands extends BlockMobSpawner {
	...
	public static enum RandomSpawnerMob {
		SWAMP_HAG("thebetweenlands:swamp_hag", 200, 500, 4), WIGHT("thebetweenlands:wight", 400, 800, 2),
		BLOOD_SNAIL("thebetweenlands:blood_snail", 100, 400, 4), TERMITE("thebetweenlands:termite", 100, 300, 6),
	...
	public static MobSpawnerLogicBetweenlands setMob(World world, BlockPos pos, String mobName,
			Consumer<MobSpawnerLogicBetweenlands>... consumers) {
