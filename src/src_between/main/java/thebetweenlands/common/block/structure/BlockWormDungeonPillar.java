...
public class BlockWormDungeonPillar extends BasicBlock implements ICustomItemBlock, ISubtypeItemBlockModelDefinition {
	...
	public static final PropertyEnum<EnumWormPillarType> VARIANT = PropertyEnum.<EnumWormPillarType>create("variant",
			EnumWormPillarType.class);

	public BlockWormDungeonPillar() {
		super(Material.ROCK);
		this.setDefaultState(
				this.blockState.getBaseState().withProperty(VARIANT, EnumWormPillarType.WORM_PILLAR_VERTICAL));
		setHardness(1.5F);
		setResistance(10.0F);
	...
	public static enum EnumWormPillarType implements IStringSerializable {
		WORM_PILLAR_VERTICAL, WORM_PILLAR_VERTICAL_DECAY_1, WORM_PILLAR_VERTICAL_DECAY_2, WORM_PILLAR_VERTICAL_DECAY_3,
		WORM_PILLAR_VERTICAL_DECAY_4, WORM_PILLAR_VERTICAL_DECAY_FULL, WORM_PILLAR_TOP, WORM_PILLAR_TOP_DECAY_1,
		WORM_PILLAR_TOP_DECAY_2, WORM_PILLAR_TOP_DECAY_3, WORM_PILLAR_TOP_DECAY_4, WORM_PILLAR_TOP_DECAY_FULL;
