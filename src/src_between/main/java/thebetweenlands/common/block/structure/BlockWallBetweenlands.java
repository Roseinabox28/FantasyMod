...
public class BlockWallBetweenlands extends Block {
	...
	private boolean canConnectTo(IBlockAccess worldIn, BlockPos pos, EnumFacing facing) {
		...
		boolean flag = blockfaceshape == BlockFaceShape.MIDDLE_POLE_THICK
				|| blockfaceshape == BlockFaceShape.MIDDLE_POLE
						&& (block instanceof BlockFenceGate || block instanceof BlockFenceGateBetweenlands);
	...
	public BlockFaceShape getBlockFaceShape(IBlockAccess world, IBlockState state, BlockPos pos, EnumFacing facing) {
		return facing != EnumFacing.UP && facing != EnumFacing.DOWN ? BlockFaceShape.MIDDLE_POLE_THICK
	...
	public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing) {
		...
		return connector instanceof BlockWall || connector instanceof BlockFenceGate
				|| connector instanceof BlockWallBetweenlands || connector instanceof BlockFenceGateBetweenlands;
	}
