...
public class BlockBrazier extends Block {
	...
	public static final PropertyEnum<EnumBrazierHalf> HALF = PropertyEnum.<EnumBrazierHalf>create("half",
			EnumBrazierHalf.class);
	// protected static final AxisAlignedBB BRAZIER_AABB = new AxisAlignedBB(0.375D,
	// 0.0D, 0.375D, 0.625D, 1.0D, 0.625D);
	...
	public IBlockState getStateFromMeta(int meta) {
		return meta > 0 ? getDefaultState().withProperty(HALF, EnumBrazierHalf.UPPER)
				: getDefaultState().withProperty(HALF, EnumBrazierHalf.LOWER);
	}
	...
	public BlockFaceShape getBlockFaceShape(IBlockAccess worldIn, IBlockState state, BlockPos pos, EnumFacing face) {
		return face == EnumFacing.UP && state.getValue(HALF) == EnumBrazierHalf.UPPER ? BlockFaceShape.SOLID
