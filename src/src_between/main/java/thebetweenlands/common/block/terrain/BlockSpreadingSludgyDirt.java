...
public class BlockSpreadingSludgyDirt extends BlockSpreadingDeath {
	...
	public boolean canSpreadInto(World world, BlockPos pos, IBlockState state, BlockPos offsetPos,
		...
		return super.canSpreadInto(world, pos, state, offsetPos, offsetState)
				&& SurfaceType.GRASS_AND_DIRT.matches(offsetState);
	}
	...
	@Override
	public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess iblockaccess, BlockPos pos,
			EnumFacing side) {
