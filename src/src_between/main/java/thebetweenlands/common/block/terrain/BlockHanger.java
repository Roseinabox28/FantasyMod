...
public class BlockHanger extends Block implements IShearable, ISickleHarvestable, IStateMappedBlock,
		ISubtypeItemBlockModelDefinition, ICustomItemBlock, ITintedBlock {
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
		...
		boolean canHangOn = stateAbove.getMaterial() == Material.LEAVES
				|| stateAbove.isSideSolid(worldIn, pos.up(), EnumFacing.DOWN) || stateAbove.getBlock() == this;
