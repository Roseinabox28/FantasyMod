...
public class BlockGenericOre extends BasicBlock {
	...
	public BlockGenericOre(Material materialIn) {
		super(materialIn);
		this.setDefaultCreativeTab().setSoundType2(SoundType.STONE).setHardness(1.5F).setResistance(10.0F);
	}
	...
	public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		...
		if (rand.nextInt(3) == 0) {
			for (int l = 0; l < 5; l++) {
				...
				if (particleX < pos.getX() || particleX > pos.getX() + 1 || particleY < pos.getY()
						|| particleY > pos.getY() + 1 || particleZ < pos.getZ() || particleZ > pos.getZ() + 1) {
