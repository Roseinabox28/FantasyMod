...
public class BlockRubberLog extends BlockLog implements IStateMappedBlock {
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		return state.withProperty(NORTH, Boolean.valueOf(this.canConnectTo(worldIn, pos.north())))
				...
				.withProperty(UP, Boolean.valueOf(this.canConnectTo(worldIn, pos.up()))).withProperty(DOWN,
						Boolean.valueOf(
								worldIn.getBlockState(pos.down()).isSideSolid(worldIn, pos.down(), EnumFacing.UP)
										|| this.canConnectTo(worldIn, pos.down())));
	}
	...
	public IBlockState getStateForPlacement(World world, BlockPos pos, EnumFacing facing, float hitX, float hitY,
		...
		return this.getDefaultState().withProperty(NATURAL,
