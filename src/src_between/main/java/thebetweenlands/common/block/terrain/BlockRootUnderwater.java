...
public class BlockRootUnderwater extends BlockSwampWater {
	...
	protected BlockStateContainer createBlockState() {
		return BlockStateContainerHelper.extendBlockstateContainer((ExtendedBlockState) super.createBlockState(),
				new IProperty[0], new IUnlistedProperty[] { BlockRoot.POS_X, BlockRoot.POS_Y, BlockRoot.POS_Z,
						BlockRoot.NO_BOTTOM, BlockRoot.NO_TOP, BlockRoot.DIST_UP, BlockRoot.DIST_DOWN });
	}
	...
	public IBlockState getExtendedState(IBlockState oldState, IBlockAccess worldIn, BlockPos pos) {
		...
		return state.withProperty(BlockRoot.POS_X, pos.getX()).withProperty(BlockRoot.POS_Y, pos.getY())
				.withProperty(BlockRoot.POS_Z, pos.getZ()).withProperty(BlockRoot.DIST_UP, distUp)
				.withProperty(BlockRoot.DIST_DOWN, distDown).withProperty(BlockRoot.NO_TOP, noTop)
				.withProperty(BlockRoot.NO_BOTTOM, noBottom);
	}
