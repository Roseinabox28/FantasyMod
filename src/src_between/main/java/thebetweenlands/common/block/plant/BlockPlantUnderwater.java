...
public class BlockPlantUnderwater extends BlockSwampWater implements net.minecraftforge.common.IPlantable,
		IStateMappedBlock, IShearable, ISickleHarvestable, IFarmablePlant {
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
		...
		if (state.getBlock() instanceof IFluidBlock && ((IFluidBlock) state.getBlock()).getFluid() == this.getFluid()) {
			return super.canPlaceBlockAt(worldIn, pos) && (soil.getBlock().canSustainPlant(soil, worldIn, pos.down(),
	...
	public boolean canSustainPlant(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing direction,
		...
		return super.canSustainPlant(state, world, pos, direction, plantable)
				|| (plantable instanceof BlockPlantUnderwater
						&& ((BlockPlantUnderwater) plantable).canSustainPlant(state))
