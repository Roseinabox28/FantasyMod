...
public class BlockBasicHanger extends BlockBush {
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
		return isValidBlock(worldIn.getBlockState(pos.down()))
				&& canBlockStay(worldIn, pos, worldIn.getBlockState(pos));
	}
	...
	protected boolean isValidBlock(IBlockState block) {
		return block.getMaterial().blocksMovement() || block.getBlock() == BlockRegistry.LEAVES_WEEDWOOD_TREE
				|| block.getBlock() instanceof BlockBasicHanger;
	}
