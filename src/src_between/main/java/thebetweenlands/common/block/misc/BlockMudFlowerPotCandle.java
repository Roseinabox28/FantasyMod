...
public class BlockMudFlowerPotCandle extends Block {
	...
	public void onBlockClicked(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		if (!worldIn.isRemote) {
			...
			worldIn.playSound(null, pos, SoundType.WOOD.getBreakSound(), SoundCategory.BLOCKS,
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand,
		...
		if (world.isRemote) {
			...
			if (state.getValue(LIT))
				world.playSound(null, pos, SoundEvents.ITEM_FIRECHARGE_USE, SoundCategory.BLOCKS, 0.05F,
						1F + (world.rand.nextFloat() - world.rand.nextFloat()) * 0.8F);
			else
				world.playSound(null, pos, SoundEvents.BLOCK_LAVA_EXTINGUISH, SoundCategory.BLOCKS, 0.1F,
						2F + (world.rand.nextFloat() - world.rand.nextFloat()) * 0.8F);
			return true;
		}
	}
