...
public class BlockGroundItem extends Block implements BlockRegistry.ICustomItemBlock {
	...
	public boolean canStay(World world, BlockPos pos) {
		...
		return downState.isSideSolid(world, pos, EnumFacing.UP)
				|| downState.getBlockFaceShape(world, pos, EnumFacing.UP) == BlockFaceShape.SOLID;
	}
	...
	public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state,
		...
		if (te instanceof TileEntityGroundItem && !worldIn.isRemote
				&& !((TileEntityGroundItem) te).getStack().isEmpty()) {
