...
public class CustomDruidAltarRecipes extends CustomRecipes<IDruidAltarRecipe> {
	public CustomDruidAltarRecipes() {
		super("druid_altar",
				ImmutableMap.of("input/item_1", RecipeArg.ITEM_INPUT, "input/item_2", RecipeArg.ITEM_INPUT,
						"input/item_3", RecipeArg.ITEM_INPUT, "input/item_4", RecipeArg.ITEM_INPUT, "output",
						RecipeArg.ITEM_OUTPUT),
				ImmutableMap.of());
	}
