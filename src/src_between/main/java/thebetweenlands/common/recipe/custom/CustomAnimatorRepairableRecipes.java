...
public class CustomAnimatorRepairableRecipes extends CustomRecipes<IAnimatorRecipe> {
	public CustomAnimatorRepairableRecipes() {
		super("animator_repairable",
				ImmutableMap.of("input/item", RecipeArg.ITEM_INPUT, "input/min_fuel", RecipeArg.INT, "input/min_life",
						RecipeArg.INT, "input/max_fuel", RecipeArg.INT, "input/max_life", RecipeArg.INT),
				ImmutableMap.of());
	}
