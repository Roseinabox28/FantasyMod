...
public class DruidAltarRecipe implements IDruidAltarRecipe {
	...
	public static void addRecipe(ItemStack input1, ItemStack input2, ItemStack input3, ItemStack input4,
			ItemStack output) {
	...
	/*
	 * public static DruidAltarRecipe getDruidAltarRecipe(ItemStack output) { for
	 * (IDruidAltarRecipe druidAltarRecipe : druidAltarRecipes) { if
	 * (druidAltarRecipe.output.getItem() == output.getItem() &&
	 * druidAltarRecipe.output.getItemDamage() == output.getItemDamage()) return
	 * druidAltarRecipe; } return null; }
	 */

	public static IDruidAltarRecipe getDruidAltarRecipe(ItemStack input1, ItemStack input2, ItemStack input3,
			ItemStack input4) {
	...
	private static boolean matches(ItemStack input, ItemStack toCheck) {
		return toCheck.getItem() == input.getItem() && (input.getItemDamage() == OreDictionary.WILDCARD_VALUE
				|| toCheck.getItemDamage() == input.getItemDamage());
	}
	...
	public boolean containsInputItem(ItemStack input) {
		return matches(this.input1, input) || matches(this.input2, input) || matches(this.input3, input)
				|| matches(this.input4, input);
	}
}
