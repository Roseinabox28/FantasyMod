...
public class HearthgroveTarringRecipe extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
	...
	public ItemStack getCraftingResult(InventoryCrafting inv) {
		...
		return new ItemStack(BlockRegistry.LOG_HEARTHGROVE, tarredLogs,
				BlockRegistry.LOG_HEARTHGROVE.getMetaFromState(BlockRegistry.LOG_HEARTHGROVE.getDefaultState()
						.withProperty(BlockHearthgroveLog.LOG_AXIS, BlockLog.EnumAxis.Y)
						.withProperty(BlockHearthgroveLog.TARRED, true)));
	}
