...
public class StorageRegistry {
	private static final BiMap<ResourceLocation, Class<? extends ILocalStorage>> STORAGE_MAP = HashBiMap
			.<ResourceLocation, Class<? extends ILocalStorage>>create();
	...
	public static void preInit() {
		...
		register(new ResourceLocation(ModInfo.ID, "cragrock_tower"), LocationCragrockTower.class,
				LocationCragrockTower::new);
		...
		register(new ResourceLocation(ModInfo.ID, "sludge_worm_dungeon"), LocationSludgeWormDungeon.class,
				LocationSludgeWormDungeon::new);
	}
