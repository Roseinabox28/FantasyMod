...
public class ContainerAnimator extends Container {
	...
	public ContainerAnimator(InventoryPlayer playerInventory, TileEntityAnimator tile) {
		...
		addSlotToContainer(new SlotRestriction(tile, 2, 124, 57,
				new ItemStack(ItemRegistry.ITEMS_MISC, 1, ItemMisc.EnumItemMisc.SULFUR.getID()), 64, this));
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotIndex) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			stack = stack1.copy();
			if (slotIndex > 2) {
				if (stack1.getItem() == ItemRegistry.ITEMS_MISC
						&& stack1.getItemDamage() == ItemMisc.EnumItemMisc.SULFUR.getID())
				...
				if (stack1.getCount() == 1
						&& stack1 != new ItemStack(ItemRegistry.ITEMS_MISC, 1, ItemMisc.EnumItemMisc.SULFUR.getID())
						&& stack1.getItem() != ItemRegistry.LIFE_CRYSTAL)
