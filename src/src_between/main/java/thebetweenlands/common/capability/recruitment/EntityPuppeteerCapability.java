...
public class EntityPuppeteerCapability
	...
	public List<Entity> getPuppets() {
		return this.getEntity().getEntityWorld().getEntitiesWithinAABB(Entity.class,
				this.getEntity().getEntityBoundingBox().grow(24.0D, 24.0D, 24.0D), entity -> {
	...
	public Entity getActivatingEntity() {
		...
		} else if (this.activatingEntity == null || !this.activatingEntity.isEntityAlive()
				|| this.activatingEntity.getEntityId() != this.activatingEntityId) {
