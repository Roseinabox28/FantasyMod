 ...
 * <p>
 * Use their respective {@link Capability} to interface with the data.
 * <p>
 * <b>Note:</b> This class <b>must</b> be an implementation of the capability it
 * provides!
 *
...
public abstract class EntityCapability<F extends EntityCapability<F, T, E>, T, E extends Entity>
	...
	protected EntityCapability() {
		...
		Preconditions.checkState(this.getCapabilityClass().isAssignableFrom(this.getClass()),
				"Entity capability %s must implement %s", this.getClass().getName(),
				this.getCapabilityClass().getName());
	}
	 ...
	 * <p>
	 * <b>Note:</b> This is called before the capability is attached to the entity
	 */
	protected void init() {
	...
	/**
	 * Returns whether this capability is persistent for players. Capability must
	 * implement {@link ISerializableCapability}
	 * 
	 * @param oldPlayer
	 * @param newPlayer
	 * @param wasDead
	...
	/**
	 * Clones persistent data to the new capability. Only called if
	 * {@link #isPersistent(EntityPlayer, EntityPlayer)} returned true. Clones all
	 * data by default
	 * 
	 * @param oldPlayer
	 * @param newPlayer
	 ...
	 * @param newCapability
	 */
	public void clonePersistentData(EntityPlayer oldPlayer, EntityPlayer newPlayer, boolean wasDead,
