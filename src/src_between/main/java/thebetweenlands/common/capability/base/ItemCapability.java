...
public abstract class ItemCapability<F extends ItemCapability<F, T>, T> extends AbstractCapability<F, T, Item> {
	...
	protected ItemCapability() {
		...
		Preconditions.checkState(this.getCapabilityClass().isAssignableFrom(this.getClass()),
				"Item capability %s must implement %s", this.getClass().getName(), this.getCapabilityClass().getName());
	}
	 ...
	 * <p>
	 * <b>Note:</b> This is called before the capability is attached to the item
	 * stack
	 */
	protected void init() {
