...
public class PortalEntityCapability extends EntityCapability<PortalEntityCapability, IPortalCapability, EntityPlayer>
		implements IPortalCapability, ISerializableCapability {
	@Override
