...
public class FlightEntityCapability extends EntityCapability<FlightEntityCapability, IFlightCapability, EntityPlayer>
		implements IFlightCapability, ISerializableCapability {
	@Override
