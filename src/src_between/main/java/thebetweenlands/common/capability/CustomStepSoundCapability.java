...
public class CustomStepSoundCapability
		extends EntityCapability<CustomStepSoundCapability, ICustomStepSoundCapability, EntityPlayer>
		implements ICustomStepSoundCapability {
	@Override
