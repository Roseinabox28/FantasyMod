...
public enum EnumEquipmentInventory {
	...
	public static final ImmutableList<EnumEquipmentInventory> VALUES = ImmutableList
			.copyOf(EnumEquipmentInventory.values());
	...
	/**
	 * The maximum stack size (check {@link IInventory#getSizeInventory()} for the
	 * actual size!)
	 */
