...
public class BLDataFixers {
	...
	private static class TileEntityNameFixer implements IFixableData {
		...
		private static final String[] NAMES = new String[] { "druid_altar", "purifier", "weedwood_workbench",
				"compost_bin", "loot_pot", "mob_spawner", "wisp", "sulfur_furnace", "sulfur_furnace_dual",
				"betweenlands_chest", "rubber_tap", "spike_trap", "possessed_block", "item_cage", "weedwood_sign",
				"mud_flower_pot", "gecko_cage", "infuser", "mortar", "animator", "alembic", "dug_soil", "item_shelf",
				"tar_beast_spawner", "tar_loot_pot_1", "tar_loot_pot_2", "tar_loot_pot_3", "syrmorite_hopper",
				"moss_bed", "aspect_vial", "aspectrus_crop", "repeller", "present" };
