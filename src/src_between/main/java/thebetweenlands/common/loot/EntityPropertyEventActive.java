...
public class EntityPropertyEventActive implements EntityProperty {
	...
	public boolean testProperty(Random random, Entity entity) {
		...
		if (entity.world.provider instanceof WorldProviderBetweenlands) {
			IEnvironmentEvent event = ((WorldProviderBetweenlands) entity.world.provider).getEnvironmentEventRegistry()
					.forName(this.event);
	...
	public static class Serializer extends EntityProperty.Serializer<EntityPropertyEventActive> {
		...
		@Override
		public JsonElement serialize(EntityPropertyEventActive property,
		...
		@Override
		public EntityPropertyEventActive deserialize(JsonElement element,
				JsonDeserializationContext deserializationContext) {
			JsonObject obj = JsonUtils.getJsonObject(element, this.getName().getPath());
			return new EntityPropertyEventActive(new ResourceLocation(JsonUtils.getString(obj.get("event"), "event")),
					JsonUtils.getBoolean(obj.get("active"), "active"));
		}
	}
}