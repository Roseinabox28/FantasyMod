...
public class EntityPropertyHasItem implements EntityProperty {
	...
	public static enum StackSizeMatcher {
		GREATER((o, i) -> i > o), GREATER_EQ((o, i) -> i >= o), LESS((o, i) -> i < o), LESS_EQ((o, i) -> i <= o),
		EQUAL((o, i) -> i == o);
	...
	public EntityPropertyHasItem(boolean hasItem, boolean combineStacks, ItemStack item, StackSizeMatcher sizeMatcher,
			boolean held, boolean armor, boolean main) {
	...
	private boolean doesItemMatch(ItemStack stack) {
		...
		return stack.getItem() == this.item.getItem() && (this.item.getItemDamage() == OreDictionary.WILDCARD_VALUE
				|| this.item.getItemDamage() == stack.getItemDamage());
	}
	...
	public static class Serializer extends EntityProperty.Serializer<EntityPropertyHasItem> {
		...
		@Override
		public EntityPropertyHasItem deserialize(JsonElement element,
			...
			boolean combineStacks = obj.has("combine_stacks")
					? JsonUtils.getBoolean(obj.get("combine_stacks"), "combine_stacks")
					: false;
			JsonObject itemJson = JsonUtils.getJsonObject(obj.get("item"), "item");
			Item item = JsonUtils.getItem(itemJson.get("id"), "id");
			int meta = itemJson.has("meta") ? JsonUtils.getInt(itemJson.get("meta"), "meta")
