...
public abstract class TimedEnvironmentEvent extends BLEnvironmentEvent {
	...
	protected static final DataParameter<Integer> TICKS = GenericDataManager.createKey(TimedEnvironmentEvent.class,
			DataSerializers.VARINT);
	protected static final DataParameter<Integer> START_TICKS = GenericDataManager
			.createKey(TimedEnvironmentEvent.class, DataSerializers.VARINT);
