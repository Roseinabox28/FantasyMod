...
public class LocationPortal extends LocationStorage {
	...
	/**
	 * Sets the target dimension of this portal. A new portal will be generated on
	 * the other side when first entering the portal. The target dimension will be
	 * set in {@link #getOtherPortalDimension()}, the link of this portal will be
	 * overwritten
	 * 
	...
	/**
	 * Returns whether a target dimension was set. See
	 * {@link #setTargetDimension(int)}
	 * 
	 * @return
	 */
	...
	public boolean validateAndRemove() {
		...
		for (MutableBlockPos checkPos : MutableBlockPos.getAllInBoxMutable(
