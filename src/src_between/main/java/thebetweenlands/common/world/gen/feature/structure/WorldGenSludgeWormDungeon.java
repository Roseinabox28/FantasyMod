...
public class WorldGenSludgeWormDungeon extends WorldGenerator {
	...
	public void generateLocations(World world, Random rand, BlockPos pos) {
		...
		location = new LocationSludgeWormDungeon(worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(pos));
		location.addBounds(new AxisAlignedBB(pos.getX() - 3, pos.getY() + 30, pos.getZ() - 3, pos.getX() + 29,
				pos.getY() - 58, pos.getZ() + 29));
		location.linkChunks();
		location.setLayer(0);
		...
		// Maze
		LocationStorage locationMaze = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(pos), "sludge_worm_dungeon_maze", EnumLocationType.SLUDGE_WORM_DUNGEON);
		locationMaze.addBounds(new AxisAlignedBB(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 29,
				pos.getY() - 8 * 5 - 3, pos.getZ() + 29));
		...
		// Barrishee Lair
		locationBarrisheeLair = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(pos), "sludge_worm_dungeon_barrishee_lair",
				EnumLocationType.SLUDGE_WORM_DUNGEON);
		locationBarrisheeLair.addBounds(new AxisAlignedBB(pos.getX() + 20, pos.getY() - 24, pos.getZ() - 3,
				pos.getX() + 29, pos.getY() - 19, pos.getZ()));
		...
		// Crypt Walkways
		LocationStorage locationWalkays = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(pos), "sludge_worm_dungeon_winding_walkways",
				EnumLocationType.SLUDGE_WORM_DUNGEON);
		locationWalkays.addBounds(
				new AxisAlignedBB(pos.getX() - 3, pos.getY() - 43, pos.getZ() - 3, pos.getX(), pos.getY() - 24,
						pos.getZ() + 29),
				new AxisAlignedBB(pos.getX(), pos.getY() - 43, pos.getZ() - 3, pos.getX() + 29, pos.getY() - 24,
						pos.getZ()));
		...
		// Crypt Tunnels
		LocationStorage locationCryptTunnels = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(pos), "sludge_worm_dungeon_crypt_tunnels",
				EnumLocationType.SLUDGE_WORM_DUNGEON);
		locationCryptTunnels.addBounds(
				// entrance to tunnels
				new AxisAlignedBB(pos.getX() + 4, pos.getY() - 50, pos.getZ() + 28, pos.getX() - 3, pos.getY() - 43,
						pos.getZ() + 23),
				// tunnels, in order starting from entrance
				new AxisAlignedBB(pos.getX() - 3, pos.getY() - 45, pos.getZ() + 23, pos.getX() + 2, pos.getY() - 50,
						pos.getZ() + 21),
				new AxisAlignedBB(pos.getX() - 3, pos.getY() - 50, pos.getZ() + 20, pos.getX() + 1, pos.getY() - 46,
						pos.getZ() + 21),
				new AxisAlignedBB(pos.getX() + 1, pos.getY() - 47, pos.getZ() + 20, pos.getX() - 3, pos.getY() - 51,
						pos.getZ() + 18),
				new AxisAlignedBB(pos.getX() - 3, pos.getY() - 52, pos.getZ() + 18, pos.getX() + 1, pos.getY() - 48,
						pos.getZ() + 16),
				new AxisAlignedBB(pos.getX() - 3, pos.getY() - 49, pos.getZ() + 16, pos.getX() + 1, pos.getY() - 53,
						pos.getZ() + 12),
				new AxisAlignedBB(pos.getX() - 3, pos.getY() - 51, pos.getZ() + 12, pos.getX() + 1, pos.getY() - 57,
						pos.getZ() + 10),
				new AxisAlignedBB(pos.getX() - 3, pos.getY() - 52, pos.getZ() + 10, pos.getX() + 2, pos.getY() - 57,
						pos.getZ() + 7),
				new AxisAlignedBB(pos.getX() - 3, pos.getY() - 53, pos.getZ() + 7, pos.getX() + 2, pos.getY() - 57,
						pos.getZ() + 4),
				new AxisAlignedBB(pos.getX() - 2, pos.getY() - 57, pos.getZ() + 4, pos.getX() + 4, pos.getY() - 51,
						pos.getZ() - 1),
				new AxisAlignedBB(pos.getX() + 3, pos.getY() - 57, pos.getZ() - 2, pos.getX() + 23, pos.getY() - 54,
						pos.getZ() + 1),
				new AxisAlignedBB(pos.getX() + 22, pos.getY() - 57, pos.getZ() - 1, pos.getX() + 28, pos.getY() - 51,
						pos.getZ() + 4),
				new AxisAlignedBB(pos.getX() + 28, pos.getY() - 57, pos.getZ() + 4, pos.getX() + 25, pos.getY() - 54,
						pos.getZ() + 22),
				new AxisAlignedBB(pos.getX() + 28, pos.getY() - 57, pos.getZ() + 22, pos.getX() + 22, pos.getY() - 51,
						pos.getZ() + 27),
				new AxisAlignedBB(pos.getX() + 23, pos.getY() - 57, pos.getZ() + 28, pos.getX() + 3, pos.getY() - 54,
						pos.getZ() + 25),
				new AxisAlignedBB(pos.getX() + 4, pos.getY() - 57, pos.getZ() + 27, pos.getX() - 2, pos.getY() - 51,
						pos.getZ() + 22));
		...
		// Crypt
		locationCrypt = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(pos), "sludge_worm_dungeon_crypt", EnumLocationType.SLUDGE_WORM_DUNGEON);
		locationCrypt.addBounds(new AxisAlignedBB(pos.getX() - 3, pos.getY() - 57, pos.getZ() + 22, pos.getX() + 7,
				pos.getY() - 54, pos.getZ() + 12));
		...
		// Pit
		LocationStorage locationPit = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(pos), "sludge_worm_dungeon_pit", EnumLocationType.SLUDGE_WORM_DUNGEON);
		locationPit.addBounds(
				// entrance
				new AxisAlignedBB(pos.getX() + 1, pos.getY() - 43, pos.getZ() + 1, pos.getX() + 9, pos.getY() - 48,
						pos.getZ() + 4),
				// dome
				new AxisAlignedBB(pos.getX() + 1, pos.getY() - 49, pos.getZ() + 1, pos.getX() + 28, pos.getY() - 43,
						pos.getZ() + 22),
				new AxisAlignedBB(pos.getX() + 4, pos.getY() - 49, pos.getZ() + 22, pos.getX() + 25, pos.getY() - 43,
						pos.getZ() + 28),
				new AxisAlignedBB(pos.getX() + 3, pos.getY() - 54, pos.getZ() + 19, pos.getX() + 26, pos.getY() - 49,
						pos.getZ() + 9),
				new AxisAlignedBB(pos.getX() + 4, pos.getY() - 49, pos.getZ() + 9, pos.getX() + 24, pos.getY() - 54,
						pos.getZ() + 4),
				new AxisAlignedBB(pos.getX() + 8, pos.getY() - 49, pos.getZ() + 3, pos.getX() + 21, pos.getY() - 52,
						pos.getZ() + 4),
				new AxisAlignedBB(pos.getX() + 3, pos.getY() - 49, pos.getZ() + 19, pos.getX() + 26, pos.getY() - 54,
						pos.getZ() + 22),
				new AxisAlignedBB(pos.getX() + 6, pos.getY() - 49, pos.getZ() + 22, pos.getX() + 22, pos.getY() - 54,
						pos.getZ() + 26),
				new AxisAlignedBB(pos.getX() + 22, pos.getY() - 49, pos.getZ() + 22, pos.getX() + 23, pos.getY() - 51,
						pos.getZ() + 23),
				new AxisAlignedBB(pos.getX() + 21, pos.getY() - 54, pos.getZ() + 8, pos.getX() + 8, pos.getY() - 58,
						pos.getZ() + 21));
	...
	private void generateCryptCrawlerDungeon(World world, Random rand, BlockPos pos) {
		...
		// temp
		/*
		 * for (int x = 0; x < 32; x ++) for (int z = 0; z < 32; z ++) for (int y = -33;
		 * y < -19; y ++) this.setBlockAndNotifyAdequately(world, pos.add(x, y, z),
	...
	public void addGroundPlants(World world, BlockPos pos, Random rand, int x, int y, int z, boolean addMudNoise,
			boolean addMoss, boolean addWeeds, boolean addMushrooms) {
			...
			for (int horizontalZ = 0; horizontalZ < z; horizontalZ++) {
				if (addMudNoise)
					if (plantingChance(rand) && isPlantableAbove(world, pos.add(horizontalX, y, horizontalZ)))
						this.setBlockAndNotifyAdequately(world, pos.add(horizontalX, y, horizontalZ),
								blockHelper.COMPACTED_MUD_SLAB);
				if (isPlantableAbove(world, pos.add(horizontalX, y, horizontalZ)))
					if (addWeeds && plantingChance(rand))
						this.setBlockAndNotifyAdequately(world, pos.add(horizontalX, y + 1, horizontalZ),
								getRandomFloorPlant(rand));
					else if (addMushrooms && plantingChance(rand))
						this.setBlockAndNotifyAdequately(world, pos.add(horizontalX, y + 1, horizontalZ),
								getRandomMushroom(rand));
					else if (addMoss && rand.nextBoolean())
						this.setBlockAndNotifyAdequately(world, pos.add(horizontalX, y + 1, horizontalZ),
								blockHelper.MOSS.withProperty(BlockMoss.FACING, EnumFacing.UP));
			}
	}
			...
			for (int horizontalZ = 0; horizontalZ < z; horizontalZ++)
				for (int vertical = 0; vertical < y; vertical++)
					if (plantingChance(rand)
							&& isPlantableWall(world, pos.add(horizontalX, vertical, horizontalZ), facing))
						this.setBlockAndNotifyAdequately(world,
								pos.add(horizontalX, vertical, horizontalZ).offset(facing),
								blockHelper.MOSS.withProperty(BlockMoss.FACING, facing));
	}
		...
		for (int horizontalX = 0; horizontalX < x; horizontalX++)
			for (int horizontalZ = 0; horizontalZ < z; horizontalZ++) {
				for (EnumFacing facing : EnumFacing.HORIZONTALS) {
					if (world.getBlockState(pos.add(horizontalX, y + 1, horizontalZ).offset(facing)).isSideSolid(world,
							pos.add(horizontalX, y + 1, horizontalZ).offset(facing), facing.getOpposite())) {
						if (plantingChance(rand) && isPlantableAbove(world, pos.add(horizontalX, y, horizontalZ)))
							this.setBlockAndNotifyAdequately(world, pos.add(horizontalX, y + 1, horizontalZ),
									blockHelper.getRandomEdgePlant(rand, facing.getOpposite()));
					}
				}
			}
	}
	...
	public void addSphericalChamber(World world, Random rand, BlockPos pos) {
		...
		this.setBlockAndNotifyAdequately(world, pos.add(0, -4, 0), blockHelper.COMPACTED_MUD); // something other here
																								// maybe?
		...
		this.setBlockAndNotifyAdequately(world, pos.add(-1, -3, -1),
				blockHelper.MUD_BRICK_ROOF.withProperty(BlockMudBrickRoof.FACING, EnumFacing.NORTH)
						.withProperty(BlockMudBrickRoof.HALF, EnumHalf.BOTTOM));
		this.setBlockAndNotifyAdequately(world, pos.add(0, -3, -1),
				blockHelper.MUD_BRICK_ROOF.withProperty(BlockMudBrickRoof.FACING, EnumFacing.NORTH)
						.withProperty(BlockMudBrickRoof.HALF, EnumHalf.BOTTOM));
		this.setBlockAndNotifyAdequately(world, pos.add(1, -3, -1),
				blockHelper.MUD_BRICK_ROOF.withProperty(BlockMudBrickRoof.FACING, EnumFacing.NORTH)
						.withProperty(BlockMudBrickRoof.HALF, EnumHalf.BOTTOM));
		this.setBlockAndNotifyAdequately(world, pos.add(-1, -3, 1),
				blockHelper.MUD_BRICK_ROOF.withProperty(BlockMudBrickRoof.FACING, EnumFacing.SOUTH)
						.withProperty(BlockMudBrickRoof.HALF, EnumHalf.BOTTOM));
		this.setBlockAndNotifyAdequately(world, pos.add(0, -3, 1),
				blockHelper.MUD_BRICK_ROOF.withProperty(BlockMudBrickRoof.FACING, EnumFacing.SOUTH)
						.withProperty(BlockMudBrickRoof.HALF, EnumHalf.BOTTOM));
		...
		this.setBlockAndNotifyAdequately(world, pos.add(-1, -3, 0),
				blockHelper.MUD_BRICK_ROOF.withProperty(BlockMudBrickRoof.FACING, EnumFacing.WEST)
						.withProperty(BlockMudBrickRoof.HALF, EnumHalf.BOTTOM));
		this.setBlockAndNotifyAdequately(world, pos.add(1, -3, 0),
				blockHelper.MUD_BRICK_ROOF.withProperty(BlockMudBrickRoof.FACING, EnumFacing.EAST)
						.withProperty(BlockMudBrickRoof.HALF, EnumHalf.BOTTOM));
		...
		for (int yy = y + 1; y + 1 + height >= yy; yy++) {
			for (int i = radiusMud * -1; i <= radiusMud; ++i) {
				for (int j = radiusMud * -1; j <= radiusMud; ++j) {
					this.setBlockAndNotifyAdequately(world, new BlockPos(x + i, yy, z + j),
							Blocks.AIR.getDefaultState());
				}
			}
		}
		...
		for (int i = radiusMud * -1; i <= radiusMud; ++i) {
			for (int j = radiusMud * -1; j <= radiusMud; ++j) {
				...
				if (Math.round(Math.sqrt(dSq)) == radiusMud - 1)
					this.setBlockAndNotifyAdequately(world, new BlockPos(x + i, y, z + j),
							blockHelper.getMudBricksForLevel(rand, 0, 1));
				if (Math.round(Math.sqrt(dSq)) == radiusMud)
					this.setBlockAndNotifyAdequately(world, new BlockPos(x + i, y, z + j),
							rand.nextInt(3) == 0 ? blockHelper.getMudSlabsForLevel(rand, 0, EnumBlockHalfBL.BOTTOM)
									: blockHelper.getMudBricksForLevel(rand, 0, 1));
			}
		}
			...
			for (int i = radius * -1; i <= radius; ++i) {
				for (int j = radius * -1; j <= radius; ++j) {
					...
					if (Math.round(Math.sqrt(dSq)) == radius && yy - y < level2)
						this.setBlockAndNotifyAdequately(world, new BlockPos(x + i, yy, z + j),
								blockHelper.PITSTONE_BRICKS);

					if (Math.round(Math.sqrt(dSq)) == radius && yy - y > level2 && yy - y < level3) {
						if (yy == y + level2 + 1)
							this.setBlockAndNotifyAdequately(world, new BlockPos(x + i, yy, z + j),
									blockHelper.getMudBricksForLevel(rand, 0, 2));
						else if (yy == y + level2 + 6)
							this.setBlockAndNotifyAdequately(world, new BlockPos(x + i, yy, z + j),
									blockHelper.getMudBricksForLevel(rand, 0, 3));
						else
							this.setBlockAndNotifyAdequately(world, new BlockPos(x + i, yy, z + j),
									blockHelper.getMudBricksForLevel(rand, 0, 1));
					}
					...
					if (yy == y + level2) {
						...
						if (Math.round(Math.sqrt(dSq)) == radius)
							this.setBlockAndNotifyAdequately(world, new BlockPos(x + i, yy, z + j),
									blockHelper.getRandomBeam(EnumFacing.SOUTH, rand, 0, 0, false));
					}
	...
	public void generateDecayPit(World world, Random rand, BlockPos pos) {
		...
		this.setBlockAndNotifyAdequately(world, pos.add(0, -4, -12F), BlockRegistry.DECAY_PIT_GROUND_CHAIN
				.getDefaultState().withProperty(BlockDecayPitGroundChain.FACING, EnumFacing.WEST));
		this.setBlockAndNotifyAdequately(world, pos.add(12, -4, 0), BlockRegistry.DECAY_PIT_GROUND_CHAIN
				.getDefaultState().withProperty(BlockDecayPitGroundChain.FACING, EnumFacing.SOUTH));
		this.setBlockAndNotifyAdequately(world, pos.add(0, -4, 12), BlockRegistry.DECAY_PIT_GROUND_CHAIN
				.getDefaultState().withProperty(BlockDecayPitGroundChain.FACING, EnumFacing.EAST));
		this.setBlockAndNotifyAdequately(world, pos.add(-12, -4, 0), BlockRegistry.DECAY_PIT_GROUND_CHAIN
				.getDefaultState().withProperty(BlockDecayPitGroundChain.FACING, EnumFacing.NORTH));
		...
		for (int level = 0; level <= 7; level++) {
			...
			if (level <= 7) {
				...
				if (level == 1 || level == 3 || level == 5 || level == 7) {
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 5, 0),
							blockHelper.MUD_BRICKS_CLIMBABLE_SOUTH);
					if (level != 7) {
						this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 0, 28),
								blockHelper.MUD_BRICKS_CLIMBABLE_NORTH);
						this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 1, 28),
								blockHelper.MUD_BRICKS_CLIMBABLE_NORTH);
						this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 2, 28),
								blockHelper.MUD_BRICKS_CLIMBABLE_NORTH);
						this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 3, 28),
								blockHelper.MUD_BRICKS_CLIMBABLE_NORTH);
						this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 4, 28),
								blockHelper.MUD_BRICKS_CLIMBABLE_NORTH);
					}
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 1, 1),
							getMudBricksForLevel(rand, level, 1));
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 2, 1),
							getMudBricksForLevel(rand, level, 2));
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 3, 1),
							getMudBricksForLevel(rand, level, 3));
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 4, 1),
							getStairsForLevel(rand, level, EnumFacing.NORTH, EnumHalf.BOTTOM));
					if (world.isAirBlock(pos.add(1, yy + 1, 2)))
						this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 1, 2),
								getMudBricksForLevel(rand, level, 1));
					placeRuneCombination(world, pos.add(0, yy + 2, 0), level, rand);
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 3, 2),
							getStairsForLevel(rand, level, EnumFacing.NORTH, EnumHalf.BOTTOM));
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 2, 3),
							getStairsForLevel(rand, level, EnumFacing.WEST, EnumHalf.BOTTOM));
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 1, 3),
							getMudBricksForLevel(rand, level, 1));
					this.setBlockAndNotifyAdequately(world, pos.add(2, yy + 1, 3),
							getStairsForLevel(rand, level, EnumFacing.WEST, EnumHalf.BOTTOM));
				} else {
					this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 5, 28),
							blockHelper.MUD_BRICKS_CLIMBABLE_NORTH);
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 0, 0),
							blockHelper.MUD_BRICKS_CLIMBABLE_SOUTH);
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 1, 0),
							blockHelper.MUD_BRICKS_CLIMBABLE_SOUTH);
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 2, 0),
							blockHelper.MUD_BRICKS_CLIMBABLE_SOUTH);
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 3, 0),
							blockHelper.MUD_BRICKS_CLIMBABLE_SOUTH);
					this.setBlockAndNotifyAdequately(world, pos.add(1, yy + 4, 0),
							blockHelper.MUD_BRICKS_CLIMBABLE_SOUTH);
					this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 1, 27),
							getMudBricksForLevel(rand, level, 1));
					this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 2, 27),
							getMudBricksForLevel(rand, level, 2));
					this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 3, 27),
							getMudBricksForLevel(rand, level, 3));
					this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 4, 27),
							getStairsForLevel(rand, level, EnumFacing.SOUTH, EnumHalf.BOTTOM));
					if (world.isAirBlock(pos.add(27, yy + 1, 26)))
						this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 1, 26),
								getMudBricksForLevel(rand, level, 1));
					placeRuneCombination(world, pos.add(0, yy + 2, 0), level, rand);
					this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 3, 26),
							getStairsForLevel(rand, level, EnumFacing.SOUTH, EnumHalf.BOTTOM));
					this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 2, 25),
							getStairsForLevel(rand, level, EnumFacing.EAST, EnumHalf.BOTTOM));
					this.setBlockAndNotifyAdequately(world, pos.add(27, yy + 1, 25),
							getMudBricksForLevel(rand, level, 1));
					this.setBlockAndNotifyAdequately(world, pos.add(26, yy + 1, 25),
							getStairsForLevel(rand, level, EnumFacing.EAST, EnumHalf.BOTTOM));
				}
				if (level != 7)
	...
	public void generateMaze(World world, Random rand, BlockPos pos, int level) {
		...
		// System.out.println("Generated Maze At: X: " + pos.getX() + " Y: " +
		// pos.getY() + " Z: " + pos.getZ());
	}
	...
	private void buildLevel(World world, BlockPos pos, Random rand, int w, int h, int[][] maze, int level, int layer) {
		for (int i = 0; i < h; i++) {
			...
			for (int j = 0; j < w; j++) {
				if ((maze[j][i] & 1) == 0) {
					this.setBlockAndNotifyAdequately(world, pos.add(j * 4, 0, i * 4),
							(layer == 1 || layer == 2 || layer == 3) ? getPillarsForLevel(rand, level, layer)
									: getMudBricksForLevel(rand, level, layer));
					this.setBlockAndNotifyAdequately(world, pos.add(j * 4 + 1, 0, i * 4),
							getMudBricksForLevel(rand, level, layer));
					this.setBlockAndNotifyAdequately(world, pos.add(j * 4 + 2, 0, i * 4),
							getMudBricksForLevel(rand, level, layer));
					this.setBlockAndNotifyAdequately(world, pos.add(j * 4 + 3, 0, i * 4),
							getMudBricksForLevel(rand, level, layer));
					if (layer == 3)
			...
			for (int j = 0; j < w; j++) {
				...
				if ((maze[j][i] & 8) == 0) {
					this.setBlockAndNotifyAdequately(world, pos.add(j * 4, 0, i * 4),
							(layer == 1 || layer == 2 || layer == 3) ? getPillarsForLevel(rand, level, layer)
									: getMudBricksForLevel(rand, level, layer));
					this.setBlockAndNotifyAdequately(world, pos.add(j * 4, 0, i * 4 + 1),
							getMudBricksForLevel(rand, level, layer));
					this.setBlockAndNotifyAdequately(world, pos.add(j * 4, 0, i * 4 + 2),
							getMudBricksForLevel(rand, level, layer));
					this.setBlockAndNotifyAdequately(world, pos.add(j * 4, 0, i * 4 + 3),
							getMudBricksForLevel(rand, level, layer));
					if (layer == 3)
						addBeamSupports(world, pos.add(j * 4, 0, i * 4), rand, pos);
					if (layer == 4)
				...
				this.setBlockAndNotifyAdequately(world, pos.add(w * 4, 0, i * 4),
						(layer == 1 || layer == 2 || layer == 3) ? getPillarsForLevel(rand, level, layer)
								: getMudBricksForLevel(rand, level, layer));
				this.setBlockAndNotifyAdequately(world, pos.add(w * 4, 0, i * 4 + 1),
						getMudBricksForLevel(rand, level, layer));
				this.setBlockAndNotifyAdequately(world, pos.add(w * 4, 0, i * 4 + 2),
						getMudBricksForLevel(rand, level, layer));
				this.setBlockAndNotifyAdequately(world, pos.add(w * 4, 0, i * 4 + 3),
						getMudBricksForLevel(rand, level, layer));
				if (layer == 3)
		...
		for (int j = 0; j <= w * 4; j++) {
			this.setBlockAndNotifyAdequately(world, pos.add(j, 0, h * 4),
					(j % 4 == 0 && (layer == 1 || layer == 2 || layer == 3)) ? getPillarsForLevel(rand, level, layer)
							: getMudBricksForLevel(rand, level, layer));
			if (layer == 3 && j % 4 == 0)
		...
		for (EnumFacing facing : sides) {
			if (!isSolidStructureBlock(world.getBlockState(pos.offset(facing))) && world.isAirBlock(pos.offset(facing)))
				if (isWithinMazeAreaForGen(posOrigin, pos.offset(facing)))
					this.setBlockAndNotifyAdequately(world, pos.offset(facing),
							getRandomSupportBeam(facing, true, rand));
		}
	}
	...
	private void addBeams(World world, BlockPos pos, Random rand, int level, BlockPos posOrigin) {
		...
		for (EnumFacing facing : sides) {
			for (int count = 1; count <= 2; count++)
				if (!isSolidStructureBlock(world.getBlockState(pos.offset(facing, count)))
						&& world.isAirBlock(pos.offset(facing, count)))
					if (isWithinMazeAreaForGen(posOrigin, pos.offset(facing, count)))
						this.setBlockAndNotifyAdequately(world, pos.offset(facing, count),
								getRandomBeam(facing.rotateY(), rand, level, count, false));
			...
			for (int j = 0; j <= w * 4; j++)
				if (j % 4 != 0 && i % 4 != 0) {
					if (world.isAirBlock(pos.add(j, 0, i))
							&& !isSolidStructureBlock(world.getBlockState(pos.add(j, 0, i)))) {
						if (level == 0)
							this.setBlockAndNotifyAdequately(world, pos.add(j, 0, i),
									getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP));
	...
	private void addMazeCellFeature(World world, BlockPos pos, Random rand, int w, int h, int[][] maze, int level,
			int layer) {
		...
		for (int i = 0; i < h; i++) {
			for (int j = 0; j < w; j++) {
				if ((maze[j][i] & 2) == 0 && (maze[j][i] & 4) == 0 && (maze[j][i] & 8) == 0) {
					// SOUTH
					if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -4, 2 + i * 4))
							&& !isBlackListedForGen(pos.add(26, 0, 26), pos.add(2 + j * 4, -4, 2 + i * 4))
							&& !isBlackListedForGenSpecial(pos.add(26, 0, 2), pos.add(2 + j * 4, -4, 2 + i * 4),
									level == 3 ? true : false)
							&& !isBlackListedForGenSpecial(pos.add(2, 0, 26), pos.add(2 + j * 4, -4, 2 + i * 4),
									level == 5 ? true : false))
						if (!isSolidStructureBlock(world.getBlockState(pos.add(2 + j * 4, -4, 3 + i * 4))))
							microBuild.selectFeature(world, pos.add(2 + j * 4, -4, 2 + i * 4), EnumFacing.NORTH, rand,
									level, layer);
				}
				if ((maze[j][i] & 1) == 0 && (maze[j][i] & 4) == 0 && (maze[j][i] & 8) == 0) {
					...
					if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -4, 2 + i * 4))
						...
						if (!isSolidStructureBlock(world.getBlockState(pos.add(2 + j * 4, -4, 1 + i * 4))))
							microBuild.selectFeature(world, pos.add(2 + j * 4, -4, 2 + i * 4), EnumFacing.SOUTH, rand,
									level, layer);
				}
				if ((maze[j][i] & 1) == 0 && (maze[j][i] & 2) == 0 && (maze[j][i] & 4) == 0) {
					...
					if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -4, 2 + i * 4))
						...
						if (!isSolidStructureBlock(world.getBlockState(pos.add(3 + j * 4, -4, 2 + i * 4))))
							microBuild.selectFeature(world, pos.add(2 + j * 4, -4, 2 + i * 4), EnumFacing.WEST, rand,
									level, layer);
				}
				if ((maze[j][i] & 1) == 0 && (maze[j][i] & 2) == 0 && (maze[j][i] & 8) == 0) {
					...
					if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -4, 2 + i * 4))
						...
						if (!isSolidStructureBlock(world.getBlockState(pos.add(1 + j * 4, -4, 2 + i * 4))))
							microBuild.selectFeature(world, pos.add(2 + j * 4, -4, 2 + i * 4), EnumFacing.EAST, rand,
									level, layer);
				}
				...
				if (level == 2) {
					if ((maze[j][i] & 1) == 0 && (maze[j][i] & 2) == 0 && (maze[j][i] & 4) != 0
						...
						if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -4, 2 + i * 4))
								&& !isBlackListedForGen(pos.add(26, 0, 26), pos.add(2 + j * 4, -4, 2 + i * 4)))
							microBuild.spikeFeature(world, pos.add(2 + j * 4, -4, 2 + i * 4), EnumFacing.WEST, rand,
									level, layer);
					...
					if ((maze[j][i] & 1) != 0 && (maze[j][i] & 2) != 0 && (maze[j][i] & 4) == 0
						...
						if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -4, 2 + i * 4))
								&& !isBlackListedForGen(pos.add(26, 0, 26), pos.add(2 + j * 4, -4, 2 + i * 4)))
							microBuild.spikeFeature(world, pos.add(2 + j * 4, -4, 2 + i * 4), EnumFacing.NORTH, rand,
									level, layer);
				}
	...
	private void addFeature(World world, BlockPos pos, Random rand, int w, int h, int[][] maze, int level, int layer) {
		for (int i = 0; i < h; i++) {
			for (int j = 0; j < w; j++) {
				if ((maze[j][i] & 1) == 0) {
					if (layer == 2) {
						if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -3, 2 + i * 4))
								&& !isBlackListedForGen(pos.add(26, 0, 26), pos.add(2 + j * 4, -3, 2 + i * 4))
								&& !isBlackListedForGenSpecial(pos.add(26, 0, 2), pos.add(2 + j * 4, -3, 2 + i * 4),
										level == 3 ? true : false)
								&& !isBlackListedForGenSpecial(pos.add(2, 0, 26), pos.add(2 + j * 4, -3, 2 + i * 4),
										level == 5 ? true : false))
							if (rand.nextInt(25) == 0
									&& !isSolidStructureBlock(world.getBlockState(pos.add(2 + j * 4, 0, 1 + i * 4)))
									&& world.getBlockState(pos.add(2 + j * 4, 0, i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
								this.setBlockAndNotifyAdequately(world, pos.add(2 + j * 4, 0, 1 + i * 4),
										blockHelper.DUNGEON_WALL_CANDLE_SOUTH);
							else {
								if (rand.nextInt(5) == 0 && level != 2)
									if (world.getBlockState(pos.add(2 + j * 4, 0, i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(2 + j * 4, 0, i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_SOUTH, rand, level);
								if (rand.nextInt(5) == 0)
									if (world.getBlockState(pos.add(1 + j * 4, 0, i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(1 + j * 4, 0, i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_SOUTH, rand, level);
								if (rand.nextInt(5) == 0)
									if (world.getBlockState(pos.add(3 + j * 4, 0, i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(3 + j * 4, 0, i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_SOUTH, rand, level);
							}
					}
					...
					if (layer == 4) {
						if (!isSolidStructureBlock(world.getBlockState(pos.add(1 + j * 4, 0, 1 + i * 4))))
							this.setBlockAndNotifyAdequately(world, pos.add(1 + j * 4, 0, 1 + i * 4),
									getStairsForLevel(rand, level, EnumFacing.NORTH, EnumHalf.TOP));
						...
						if (!isSolidStructureBlock(world.getBlockState(pos.add(3 + j * 4, 0, 1 + i * 4))))
							this.setBlockAndNotifyAdequately(world, pos.add(3 + j * 4, 0, 1 + i * 4),
									getStairsForLevel(rand, level, EnumFacing.NORTH, EnumHalf.TOP));
					}

					if (layer == 5) {
						if (rand.nextInt(3) == 0)
							if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -6, 2 + i * 4))
									&& !isBlackListedForGen(pos.add(26, 0, 26), pos.add(2 + j * 4, -6, 2 + i * 4))
									&& !isBlackListedForGenSpecial(pos.add(26, 0, 2), pos.add(2 + j * 4, -6, 2 + i * 4),
											level == 3 ? true : false)
									&& !isBlackListedForGenSpecial(pos.add(2, 0, 26), pos.add(2 + j * 4, -6, 2 + i * 4),
											level == 5 ? true : false)) {
				...
				if ((maze[j][i] & 8) == 0) {
					if (layer == 2) {
						if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -3, 2 + i * 4))
								...
								&& !isBlackListedForGenSpecial(pos.add(2, 0, 26), pos.add(2 + j * 4, -3, 2 + i * 4),
										level == 5 ? true : false))
							if (rand.nextInt(25) == 0
									&& !isSolidStructureBlock(world.getBlockState(pos.add(1 + j * 4, 0, 2 + i * 4)))
									&& world.getBlockState(pos.add(j * 4, 0, 2 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
								this.setBlockAndNotifyAdequately(world, pos.add(1 + j * 4, 0, 2 + i * 4),
										blockHelper.DUNGEON_WALL_CANDLE_EAST);
							else {
								if (rand.nextInt(5) == 0 && level != 2)
									if (world.getBlockState(pos.add(j * 4, 0, 2 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(j * 4, 0, 2 + i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_EAST, rand, level);
								if (rand.nextInt(5) == 0)
									if (world.getBlockState(pos.add(j * 4, 0, 1 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(j * 4, 0, 1 + i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_EAST, rand, level);
								if (rand.nextInt(5) == 0)
									if (world.getBlockState(pos.add(j * 4, 0, 3 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(j * 4, 0, 3 + i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_EAST, rand, level);
							}
					}
					...
					if (layer == 4) {
						if (!isSolidStructureBlock(world.getBlockState(pos.add(1 + j * 4, 0, 1 + i * 4))))
							this.setBlockAndNotifyAdequately(world, pos.add(1 + j * 4, 0, 1 + i * 4),
									getStairsForLevel(rand, level, EnumFacing.WEST, EnumHalf.TOP));
						...
						if (!isSolidStructureBlock(world.getBlockState(pos.add(1 + j * 4, 0, 3 + i * 4))))
							this.setBlockAndNotifyAdequately(world, pos.add(1 + j * 4, 0, 3 + i * 4),
									getStairsForLevel(rand, level, EnumFacing.WEST, EnumHalf.TOP));
					}
				}
				...
				if ((maze[j][i] & 4) == 0) {
					if (layer == 2) {
						if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -3, 2 + i * 4))
								...
								&& !isBlackListedForGenSpecial(pos.add(2, 0, 26), pos.add(2 + j * 4, -3, 2 + i * 4),
										level == 5 ? true : false))
							if (rand.nextInt(25) == 0
									&& !isSolidStructureBlock(world.getBlockState(pos.add(3 + j * 4, 0, 2 + i * 4)))
									&& world.getBlockState(pos.add(4 + j * 4, 0, 2 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
								this.setBlockAndNotifyAdequately(world, pos.add(3 + j * 4, 0, 2 + i * 4),
										blockHelper.DUNGEON_WALL_CANDLE_WEST);
							else {
								if (rand.nextInt(5) == 0 && level != 2)
									if (world.getBlockState(pos.add(4 + j * 4, 0, 2 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(4 + j * 4, 0, 2 + i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_WEST, rand, level);
								if (rand.nextInt(5) == 0)
									if (world.getBlockState(pos.add(4 + j * 4, 0, 1 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(4 + j * 4, 0, 1 + i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_WEST, rand, level);
								if (rand.nextInt(5) == 0)
									if (world.getBlockState(pos.add(4 + j * 4, 0, 3 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(4 + j * 4, 0, 3 + i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_WEST, rand, level);
							}
					}
					...
					if (layer == 4) {
						if (!isSolidStructureBlock(world.getBlockState(pos.add(3 + j * 4, 0, 1 + i * 4))))
							this.setBlockAndNotifyAdequately(world, pos.add(3 + j * 4, 0, 1 + i * 4),
									getStairsForLevel(rand, level, EnumFacing.EAST, EnumHalf.TOP));
						...
						if (!isSolidStructureBlock(world.getBlockState(pos.add(3 + j * 4, 0, 3 + i * 4))))
							this.setBlockAndNotifyAdequately(world, pos.add(3 + j * 4, 0, 3 + i * 4),
									getStairsForLevel(rand, level, EnumFacing.EAST, EnumHalf.TOP));
					}
				}
				...
				if ((maze[j][i] & 2) == 0) {
					if (layer == 2) {
						if (!isBlackListedForGen(pos.add(2, 0, 2), pos.add(2 + j * 4, -3, 2 + i * 4))
								...
								&& !isBlackListedForGenSpecial(pos.add(2, 0, 26), pos.add(2 + j * 4, -3, 2 + i * 4),
										level == 5 ? true : false))
							if (rand.nextInt(25) == 0
									&& !isSolidStructureBlock(world.getBlockState(pos.add(2 + j * 4, 0, 3 + i * 4)))
									&& world.getBlockState(pos.add(2 + j * 4, 0, 4 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
								this.setBlockAndNotifyAdequately(world, pos.add(2 + j * 4, 0, 3 + i * 4),
										blockHelper.DUNGEON_WALL_CANDLE_NORTH);
							else {
								if (rand.nextInt(5) == 0 && level != 2)
									if (world.getBlockState(pos.add(2 + j * 4, 0, 4 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(2 + j * 4, 0, 4 + i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_NORTH, rand, level);
								if (rand.nextInt(5) == 0)
									if (world.getBlockState(pos.add(1 + j * 4, 0, 4 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(1 + j * 4, 0, 4 + i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_NORTH, rand, level);
								if (rand.nextInt(5) == 0)
									if (world.getBlockState(pos.add(3 + j * 4, 0, 4 + i * 4))
											.getBlock() instanceof BlockCarvedMudBrick)
										setAlcoveForLevel(world, pos.add(3 + j * 4, 0, 4 + i * 4),
												blockHelper.MUD_BRICKS_ALCOVE_NORTH, rand, level);
							}
					}
					...
					if (layer == 4) {
						if (!isSolidStructureBlock(world.getBlockState(pos.add(1 + j * 4, 0, 3 + i * 4))))
							this.setBlockAndNotifyAdequately(world, pos.add(1 + j * 4, 0, 3 + i * 4),
									getStairsForLevel(rand, level, EnumFacing.SOUTH, EnumHalf.TOP));
		...
		if (level <= 6) {
			if (level == 1 || level == 3 || level == 5) {
				...
				if (level == 3) {
					...
					for (int x = -1; x <= 1; x++)
						for (int y = -1; y <= 1; y++)
							this.setBlockAndNotifyAdequately(world, pos.add(26 + x, y, 0),
									Blocks.AIR.getDefaultState());
				...
				if (level == 5) {
					...
					for (int z = -1; z <= 1; z++)
						for (int y = -1; y <= 1; y++)
							this.setBlockAndNotifyAdequately(world, pos.add(0, y, 26 + z),
									Blocks.AIR.getDefaultState());
				}
			} else {
	...
	// Floor
	private void buildFloor(World world, BlockPos pos, Random rand, int w, int h, boolean addFeature,
			boolean addSpawners, int level) {
		for (int i = 0; i <= h * 4; i++) {
			for (int j = 0; j <= w * 4; j++) {
				...
				if (rand.nextInt(15) == 0 && addFeature && !isSolidStructureBlock(world.getBlockState(pos.add(j, 1, i)))
						&& world.getBlockState(pos.add(j, 0, i)).getBlock() instanceof BlockMudTiles) {
					if (!isBlackListedAreaForGen(pos.add(2, 0, 2), pos.add(j, 0, i), 1)
							&& !isBlackListedAreaForGen(pos.add(26, 0, 26), pos.add(j, 0, i), 1)
							&& !isBlackListedAreaForGenSpecial(pos.add(26, 0, 2), pos.add(j, 0, i), 1,
									level == 3 ? true : false)
							&& !isBlackListedAreaForGenSpecial(pos.add(2, 0, 26), pos.add(j, 0, i), 1,
									level == 5 ? true : false)) {
						if (rand.nextBoolean() && rand.nextBoolean())
							this.setBlockAndNotifyAdequately(world, pos.add(j, 0, i),
									blockHelper.getMudTilesWater(rand));
				...
				if (world.getBlockState(pos.add(j, 0, i)).getBlock() instanceof BlockMudTiles
						&& world.isAirBlock(pos.add(j, 1, i)))
					if (rand.nextInt(15) == 0)
						if (!isBlackListedAreaForGen(pos.add(2, 0, 2), pos.add(j, 0, i), 1)
								...
								&& !isBlackListedAreaForGenSpecial(pos.add(2, 0, 26), pos.add(j, 0, i), 1,
										level == 5 ? true : false))
							this.setBlockAndNotifyAdequately(world, pos.add(j, 1, i),
									rand.nextBoolean() ? getRandomMushroom(rand) : getRandomFloorPlant(rand));
			}
		}
	}
	...
	protected boolean isProtectedBlock(IBlockState state) {
		...
		if (block != Blocks.AIR && block != BlockRegistry.MOB_SPAWNER && block != BlockRegistry.LOOT_POT
				...
				&& block instanceof BlockHangingPlant == false && block != BlockRegistry.VALONITE_BLOCK
				&& block != BlockRegistry.SYRMORITE_BLOCK && block != BlockRegistry.OCTINE_BLOCK
				&& block != BlockRegistry.WEEDWOOD_CHEST && block != BlockRegistry.POSSESSED_BLOCK
				&& block != BlockRegistry.WEAK_POLISHED_LIMESTONE && block != BlockRegistry.WEAK_BETWEENSTONE_TILES
				&& block != BlockRegistry.WEAK_MOSSY_BETWEENSTONE_TILES && block != BlockRegistry.LOOT_URN
				&& block != BlockRegistry.PUFFSHROOM && block != BlockRegistry.STAGNANT_WATER
				&& block != BlockRegistry.ROPE && block != BlockRegistry.DEAD_MOSS && block != BlockRegistry.DEAD_LICHEN
				&& block != BlockRegistry.MUD_TILES_WATER && block != BlockRegistry.HANGER) {
			return true;
		}
		return false;
	}
	...
	public void setBlockAndNotifyAdequately(World worldIn, BlockPos pos, IBlockState state) {
		...
		TileEntityLootInventory lootInv = tile instanceof TileEntityLootInventory ? (TileEntityLootInventory) tile
				: null;
		TileEntityChestBetweenlands lootChest = tile instanceof TileEntityChestBetweenlands
				? (TileEntityChestBetweenlands) tile
				: null;
