...
public class WorldGenUndergroundRuins extends WorldGenHelper {
	...
	private boolean structure1(World world, Random random, int x, int y, int z, LocationStorage location) {
		...
		rotatedCubeVolume(world, x, y, z, 6, 1, 2 + random.nextInt(2), Blocks.AIR.getDefaultState(), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 2 + random.nextInt(4), 2, 5, Blocks.AIR.getDefaultState(), 1, 1, 1,
				direction);
	...
	private boolean structure2(World world, Random random, int x, int y, int z, LocationStorage location) {
		...
		if (rotatedCubeCantReplace(world, x, y, z, 4, height - 3, 0, 5, height - 3, depth, direction)
				|| rotatedCubeCantReplace(world, x, y, z, 0, height - 3, 6, 4, height - 3, 5, direction))
			return false;
		...
		location.addBounds(
				this.rotatedAABB(world, x, y, z, 4, height - 3, 0, 5, height - 3, depth, direction).grow(2, 2, 2));
		...
		rotatedCubeVolume(world, x, y, z, 8, height - 1, 2 + random.nextInt(7), Blocks.AIR.getDefaultState(), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, height - 1, 2, PITSTONE_BRICK_WALL, 1, 1, 4, direction);
		rotatedCubeVolume(world, x, y, z, 4, height - 1, 3 + random.nextInt(2), Blocks.AIR.getDefaultState(), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 3 + random.nextInt(4), height - 1, 10, Blocks.AIR.getDefaultState(), 1, 1, 1,
				direction);
		...
		rotatedLootPot(world, random, x, y, z, 7, height - 1, 9, direction, 1, 2, 3,
				LootTableRegistry.DUNGEON_POT_LOOT);
	...
	private boolean structure3(World world, Random random, int x, int y, int z, LocationStorage location) {
		...
		rotatedCubeVolume(world, x, y, z, 1, 0, 0,
				getStateFromRotation(3, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 4, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 0, 0, 1,
				getStateFromRotation(0, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 4,
				direction);
		rotatedCubeVolume(world, x, y, z, 1, 0, 5,
				getStateFromRotation(1, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 4, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 0, 1,
				getStateFromRotation(2, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 4,
				direction);
	...
	private boolean structure4(World world, Random random, int x, int y, int z, LocationStorage location) {
		...
		// TODO: Check stairs
		rotatedCubeVolume(world, x, y, z, 2, 2, 4,
				getStateFromRotation(3, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
	...
	private boolean structure5(World world, Random random, int x, int y, int z, LocationStorage location) {
		...
		// TODO: Check stairs
		rotatedCubeVolume(world, x, y, z, 0, 2, 2,
				getStateFromRotation(3, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 0, 2, 3,
				getStateFromRotation(0, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 0, 2, 4,
				getStateFromRotation(1, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);

		rotatedCubeVolume(world, x, y, z, 1, 3, 0,
				getStateFromRotation(3, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 7, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 1, 3, 1,
				getStateFromRotation(0, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 6,
				direction);
		rotatedCubeVolume(world, x, y, z, 2, 3, 6,
				getStateFromRotation(1, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 6, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 7, 3, 1,
				getStateFromRotation(2, direction, PITSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 5,
				direction);
	 ...
	 * depth = 13; width = 8; int direction = 0;//random.nextInt(4); if
	 * (!rotatedCubeCantReplace(world, x, y, z, 0, 0, 0, width, 1, depth, direction)
	 * || !rotatedCubeCantReplace(world, x, y, z, 0, 5, 0, width, 1, depth,
	 * direction) || !rotatedCubeCantReplace(world, x, y, z, 2, 6, 0, 6, 3, depth,
	 * direction)) return false; if (!makePitstoneSupport(world, x, y, z, 0, -1, 0,
	 * width, depth, direction, true)) return false; makePitstoneSupport(world, x,
	 * y, z, 0, -1, 0, width, depth, direction, false);
	 * 
	 * rotatedCubeVolume(world, random, x, y, z, 1, 0, 1, PITSTONE_BRICK_STAIRS, 0,
	 * 1, 1, 12, direction); rotatedCubeVolume(world, random, x, y, z, 2, 0, 0,
	 * PITSTONE_BRICK_STAIRS, 2, 4, 1, 1, direction); rotatedCubeVolume(world,
	 * random, x, y, z, 2, 0, 12, PITSTONE_BRICK_STAIRS, 3, 4, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 2, 0, 1, PITSTONE_TILES, 0, 4, 1,
	 * 11, direction); rotatedCubeVolume(world, random, x, y, z, 6, 0, 1,
	 * PITSTONE_BRICK_STAIRS, 1, 1, 1, 12, direction); rotatedCubeVolume(world,
	 * random, x, y, z, 1, 0, 0, BLBlockRegistry.chiseledPitstone, 0, 1, 1, 1,
	 * direction); rotatedCubeVolume(world, random, x, y, z, 1, 0, 4,
	 * BLBlockRegistry.chiseledPitstone, 0, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 1, 0, 8,
	 * BLBlockRegistry.chiseledPitstone, 0, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 1, 0, 12,
	 * BLBlockRegistry.chiseledPitstone, 0, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 6, 0, 0,
	 * BLBlockRegistry.chiseledPitstone, 0, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 6, 0, 4,
	 * BLBlockRegistry.chiseledPitstone, 0, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 6, 0, 8,
	 * BLBlockRegistry.chiseledPitstone, 0, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 6, 0, 12,
	 * BLBlockRegistry.chiseledPitstone, 0, 1, 1, 1, direction);
	 * 
	 * rotatedCubeVolume(world, random, x, y, z, 1, 1, 0, PITSTONE_PILLAR, 0, 1, 4,
	 * 1, direction); rotatedCubeVolume(world, random, x, y, z, 1, 1, 4,
	 * PITSTONE_PILLAR, 0, 1, 4, 1, direction); rotatedCubeVolume(world, random, x,
	 * y, z, 1, 1, 8, PITSTONE_PILLAR, 0, 1, 4, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 1, 1, 12, PITSTONE_PILLAR, 0, 1, 4,
	 * 1, direction); rotatedCubeVolume(world, random, x, y, z, 6, 1, 0,
	 * PITSTONE_PILLAR, 0, 1, 4, 1, direction); rotatedCubeVolume(world, random, x,
	 * y, z, 6, 1, 4, PITSTONE_PILLAR, 0, 1, 4, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 6, 1, 8, PITSTONE_PILLAR, 0, 1, 4,
	 * 1, direction); rotatedCubeVolume(world, random, x, y, z, 6, 1, 12,
	 * PITSTONE_PILLAR, 0, 1, 4, 1, direction);
	 * 
	 * rotatedCubeVolume(world, random, x, y, z, 6, 5, 0, PITSTONE_BRICK_SLAB, 8, 2,
	 * 1, 13, direction); rotatedCubeVolume(world, random, x, y, z, 0, 5, 0,
	 * PITSTONE_BRICK_SLAB, 8, 2, 1, 13, direction); rotatedCubeVolume(world,
	 * random, x, y, z, 1, 5, 0, PITSTONE_BRICKS, 0, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 1, 5, 4, PITSTONE_BRICKS, 0, 1, 1,
	 * 1, direction); rotatedCubeVolume(world, random, x, y, z, 1, 5, 8,
	 * PITSTONE_BRICKS, 0, 1, 1, 1, direction); rotatedCubeVolume(world, random, x,
	 * y, z, 1, 5, 12, PITSTONE_BRICKS, 0, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 6, 5, 0, PITSTONE_BRICKS, 0, 1, 1,
	 * 1, direction); rotatedCubeVolume(world, random, x, y, z, 6, 5, 4,
	 * PITSTONE_BRICKS, 0, 1, 1, 1, direction); rotatedCubeVolume(world, random, x,
	 * y, z, 6, 5, 8, PITSTONE_BRICKS, 0, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 6, 5, 12, PITSTONE_BRICKS, 0, 1, 1,
	 * 1, direction); rotatedCubeVolume(world, random, x, y, z, 2, 5, 0,
	 * PITSTONE_BRICK_SLAB, 8, 4, 1, 1, direction); rotatedCubeVolume(world, random,
	 * x, y, z, 2, 5, 4, PITSTONE_BRICK_SLAB, 8, 4, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 2, 5, 8, PITSTONE_BRICK_SLAB, 8, 4,
	 * 1, 1, direction); rotatedCubeVolume(world, random, x, y, z, 2, 5, 12,
	 * PITSTONE_BRICK_SLAB, 8, 4, 1, 1, direction);
	 * 
	 * rotatedCubeVolume(world, random, x, y, z, 1, 6, 0, PITSTONE_BRICK_SLAB, 0, 1,
	 * 1, 13, direction); rotatedCubeVolume(world, random, x, y, z, 6, 6, 0,
	 * PITSTONE_BRICK_SLAB, 0, 1, 1, 13, direction); rotatedCubeVolume(world,
	 * random, x, y, z, 2, 6, 1, PITSTONE_BRICKS, 0, 4, 1, 11, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 2, 6, 0, PITSTONE_BRICK_SLAB, 8, 1,
	 * 1, 1, direction); rotatedCubeVolume(world, random, x, y, z, 5, 6, 0,
	 * PITSTONE_BRICK_SLAB, 8, 1, 1, 1, direction); rotatedCubeVolume(world, random,
	 * x, y, z, 2, 6, 12, PITSTONE_BRICK_SLAB, 8, 1, 1, 1, direction);
	 * rotatedCubeVolume(world, random, x, y, z, 5, 6, 12, PITSTONE_BRICK_SLAB, 8,
	 * 1, 1, 1, direction);
	 * 
	 * rotatedCubeVolume(world, random, x, y, z, 3, 7, 0, PITSTONE_BRICK_SLAB, 0, 1,
	 * 1, 13, direction); rotatedCubeVolume(world, random, x, y, z, 4, 7, 0,
	 * PITSTONE_BRICK_SLAB, 0, 1, 1, 13, direction);
	 * 
	 * if (random.nextInt(2) == 0) rotatedLootPot(world, random, x, y, z, 5, 1, 2,
	 * 0); if (random.nextInt(2) == 0) rotatedLootPot(world, random, x, y, z, 2, 1,
	 * 6, 0); if (random.nextInt(2) == 0) rotatedLootPot(world, random, x, y, z, 5,
	 * 1, 10, 0); System.out.println("generated at: " + x + " " + y + " " + z);
	 * return true; }
	 */

	private boolean makePitstoneSupport(World world, int x, int y, int z, int offsetX, int offsetY, int offsetZ,
			int sizeWidth, int sizeDepth, int direction, boolean simulate) {
		x -= width / 2;
		z -= depth / 2;
		switch (direction) {
		case 0:
			if (world.isAreaLoaded(new BlockPos(x + offsetX, y, z + offsetZ),
					new BlockPos(x + offsetX + sizeWidth, y + offsetZ, z + offsetZ + sizeWidth))) {
				for (int xx = x + offsetX; xx < x + offsetX + sizeWidth; xx++)
					for (int zz = z + offsetZ; zz < z + offsetZ + sizeDepth; zz++) {
						int yy = y + offsetY;
						int times = 0;
						while (world.getBlockState(this.getCheckPos(xx, yy, zz)).getBlock().isReplaceable(world,
								this.getCheckPos(xx, yy, zz))) {
							if (!simulate)
								world.setBlockState(new BlockPos(xx, yy, zz), BlockRegistry.PITSTONE.getDefaultState(),
										2 | 16);
							yy--;
							times++;
							if (times > 4) {
			...
			break;
		case 1:
			if (world.isAreaLoaded(new BlockPos(x + offsetZ, y, z + depth - offsetX - sizeWidth - 1),
					new BlockPos(x + offsetZ + sizeDepth, y + offsetZ, z + depth - offsetX - 1))) {
			...
			break;
		case 2:
			if (world.isAreaLoaded(new BlockPos(x - offsetX - sizeWidth - 1, y, z + depth - offsetZ - sizeDepth - 1),
					new BlockPos(x + width - offsetX - 1, y + offsetZ, z + depth - offsetZ - 1))) {
			...
			break;
		case 3:
			if (world.isAreaLoaded(new BlockPos(x + width - offsetZ - sizeDepth - 1, y, z + offsetX),
					new BlockPos(x + width - offsetZ - 1, y + offsetZ, z + offsetX + sizeWidth))) {
	...
	public boolean generate(World world, Random random, BlockPos position) {
		...
		while (y > WorldProviderBetweenlands.CAVE_WATER_HEIGHT) {
			if (world.getBlockState(this.getCheckPos(x, y - 1, z)).getBlock() == BlockRegistry.PITSTONE
					&& world.isAirBlock(this.getCheckPos(x, y, z))) {
				shouldStop = false;
				break;
			}
			y--;
		...
		LocationStorage locationStorage = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(position), "underground_ruins", EnumLocationType.RUINS);
