...
public class WorldGenSmallRuins extends WorldGenHelper {
	...
	private static final IBlockState BETWEENSTONE_BRICK_STAIRS = BlockRegistry.BETWEENSTONE_BRICK_STAIRS
			.getDefaultState();
	private static final IBlockState BETWEENSTONE_BRICK_SLAB = BlockRegistry.BETWEENSTONE_BRICK_SLAB.getDefaultState();
	private static final IBlockState BETWEENSTONE_BRICK_SLAB_UPSIDE_DOWN = BETWEENSTONE_BRICK_SLAB
	...
	private static final IBlockState SMOOTH_BETWEENSTONE_WALL = BlockRegistry.SMOOTH_BETWEENSTONE_WALL
			.getDefaultState();
	...
	private static final IBlockState WEEDWOOD_PLANK_SLAB_UPSIDE_DOWN = WEEDWOOD_PLANK_SLAB
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP);
	...
	public boolean generate(World world, Random random, BlockPos position) {
		...
		LocationStorage locationStorage = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(position), "ruins", EnumLocationType.RUINS);
	...
	private boolean structure1(World world, Random random, int x, int y, int z, boolean doGen,
		...
		if (rotatedCubeCantReplace(world, x, y, z, 0, 0, 0, width, height, depth, direction))
			return false;
		if (!rotatedCubeMatches(world, x, y, z, 2, -1, 0, 1, 1, 1, direction, SurfaceType.MIXED_GROUND)
				|| !rotatedCubeMatches(world, x, y, z, 6, -1, 0, 1, 1, 1, direction, SurfaceType.MIXED_GROUND))
			return false;

		AxisAlignedBB aabb = this.rotatedAABB(world, x, y, z, 0, 0, 0, width, height, depth, direction).grow(6, 6, 6);
		if (!world.isAreaLoaded(new BlockPos(aabb.minX, aabb.minY, aabb.minZ),
		...
		if (doGen) {
			...
			rotatedCubeVolume(world, x, y, z, 1, height - 5, 0, getStateFromRotation(0, direction,
					BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);

			rotatedCubeVolume(world, x, y, z, 0, height - 4, 0, BETWEENSTONE_BRICK_SLAB, 2, 1, 1, direction);

			rotatedCubeVolume(world, x, y, z, 2, height - 3, 0,
					getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 3, height - 3, 0, getStateFromRotation(2, direction,
					BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 4, height - 3, 0, BETWEENSTONE_BRICK_SLAB_UPSIDE_DOWN, 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 5, height - 3, 0, getStateFromRotation(0, direction,
					BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);

			rotatedCubeVolume(world, x, y, z, 3, height - 2, 0, BETWEENSTONE_BRICK_SLAB, 3, 1, 1, direction);

			rotatedCubeVolume(world, x, y, z, 6, height - 1, 0,
					getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 7, height - 1, 0, getStateFromRotation(2, direction,
					BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedLootPot(world, random, x, y, z, 4, height - 2, 0, direction, 1, 2, 5,
					LootTableRegistry.COMMON_POT_LOOT);
		}
		return true;
	}
	...
	private boolean structure2(World world, Random random, int x, int y, int z, boolean doGen,
		...
		if (doGen) {
			...
			rotatedCubeVolume(world, x, y, z, 3, height - 6, 0, getStateFromRotation(2, direction,
					BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 4, height - 6, 0, BETWEENSTONE_BRICK_SLAB_UPSIDE_DOWN, 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 5, height - 6, 0, getStateFromRotation(0, direction,
					BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 6, height - 6, 0,
					getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);

			rotatedCubeVolume(world, x, y, z, 3, height - 5, 0, BETWEENSTONE_BRICK_SLAB, 3, 1, 1, direction);

			rotatedCubeVolume(world, x, y, z, 2, height - 2, 0,
					getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 1, height - 2, 0, getStateFromRotation(0, direction,
					BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
	...
	private boolean structure3(World world, Random random, int x, int y, int z, boolean doGen,
		...
		if (!rotatedCubeMatches(world, x, y, z, 2, -1, 0, 1, 1, 1, direction, SurfaceType.MIXED_GROUND)
				|| !rotatedCubeMatches(world, x, y, z, 6, -1, 0, 1, 1, 1, direction, SurfaceType.MIXED_GROUND)
				|| !rotatedCubeMatches(world, x, y, z, 2, -1, 4, 1, 1, 1, direction, SurfaceType.MIXED_GROUND)
				|| !rotatedCubeMatches(world, x, y, z, 6, -1, 4, 1, 1, 1, direction, SurfaceType.MIXED_GROUND))
			return false;
		...
		if (doGen) {
			...
			rotatedCubeVolume(world, x, y, z, 1, 4, 0, getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 1, 4, 4, getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 3, 5, 0, getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 3, 5, 4, getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 5, 5, 0, getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 5, 5, 4, getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 2, 5, 1, getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 6, 5, 1, getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 2, 5, 3, getStateFromRotation(3, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 6, 5, 3, getStateFromRotation(3, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
	...
	private boolean structure4(World world, Random random, int x, int y, int z, boolean doGen,
		...
		for (int zz = z; zz < z + width; zz++)
			for (int yy = y; yy < y + height; yy++)
				for (int xx = x; xx > x - width; xx--)
					if (!world.isBlockLoaded(this.getCheckPos(xx, yy, zz)) || !(world
							.getBlockState(new BlockPos(xx, yy, zz)).getBlock() == Blocks.AIR
							|| (world.getBlockState(new BlockPos(xx, yy, zz)).getBlock() == BlockRegistry.SWAMP_WATER
									&& yy < y + height - 2)))
						return false;
		...
		if (!SurfaceType.MIXED_GROUND.matches(world.getBlockState(new BlockPos(x - width, y - 1, z + 1)))
				|| !SurfaceType.MIXED_GROUND.matches(world.getBlockState(new BlockPos(x - width, y - 1, z + width - 1)))
				|| !SurfaceType.MIXED_GROUND.matches(world.getBlockState(new BlockPos(x - 1, y - 1, z + width)))
				|| !SurfaceType.MIXED_GROUND.matches(world.getBlockState(new BlockPos(x - 1, y - 1, z + width))))
			return false;
		if (doGen) {
			...
			for (int yy = y; yy < y + height; yy++) {
				if (yy <= y + height - 5) {
					...
					world.setBlockState(new BlockPos(x - width + 1, yy, z + 1),
							getStateFromRotation(3, 0, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 3);
					world.setBlockState(new BlockPos(x - width + 1, yy, z + 2), getStateFromRotation(1, 0,
							BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 3);
					...
					for (zz = z + 3; zz <= z + width - 3; zz++) {
						...
						world.setBlockState(new BlockPos(x - width + 1, yy, zz), BETWEENSTONE_BRICK_SLAB_UPSIDE_DOWN,
								3);
					}
					world.setBlockState(new BlockPos(x - width + 1, yy, zz), getStateFromRotation(3, 0,
							BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 3);
					world.setBlockState(new BlockPos(x - width + 1, yy + 1, zz), BETWEENSTONE_BRICK_SLAB);
				}
			}
			...
			for (int yy = y; yy < y + height; yy++) {
				if (yy <= y + height - 5) {
					...
					world.setBlockState(new BlockPos(x - width + 2, yy, z + width - 1), getStateFromRotation(2, 0,
							BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 3);
					world.setBlockState(new BlockPos(x - width + 2, yy + 1, z + width - 1), BETWEENSTONE_BRICK_SLAB);
					int xx;
					for (xx = x - width + 3; xx <= x - 3; xx++) {
						world.setBlockState(new BlockPos(xx, yy, z + width - 1), BETWEENSTONE_BRICK_SLAB_UPSIDE_DOWN,
								3);
					...
					world.setBlockState(new BlockPos(xx, yy, z + width - 1), getStateFromRotation(0, 0,
							BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 3);
					world.setBlockState(new BlockPos(xx, yy + 1, z + width - 1), BETWEENSTONE_BRICK_SLAB);
				}
			}
			...
			for (int yy = y; yy < y + height; yy++) {
				if (yy <= y + height - 5) {
					...
					if (yy == y + height - 3) {
						world.setBlockState(new BlockPos(x, yy, z + width - 1), getStateFromRotation(2, 0,
								BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 3);
					}
					world.setBlockState(new BlockPos(x - 1, yy, z + width - 1), BETWEENSTONE_BRICKS);
				} else if (yy == y + height - 1) {
					world.setBlockState(new BlockPos(x - 1, yy, z + width - 1),
							getStateFromRotation(2, 0, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 3);
				}
			}
		}
		return true;
	...
	private boolean structure6(World world, Random random, int x, int y, int z, boolean doGen,
		...
		if (rotatedCubeCantReplace(world, x, y, z, 0, 0, 0, width, 1, depth, direction))
			return false;
		if (!rotatedCubeMatches(world, x, y, z, 0, -1, 0, 1, 1, 1, direction, SurfaceType.MIXED_GROUND)
				|| !rotatedCubeMatches(world, x, y, z, width - 1, -1, 0, 1, 1, 1, direction, SurfaceType.MIXED_GROUND))
			return false;
		...
		if (doGen) {
			...
			rotatedCubeVolume(world, x, y, z, 0, 0, 0, CHISELED_BETWEENSTONE, 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 1, 0, 0,
					getStateFromRotation(7, direction, BETWEENSTONE_PILLAR, EnumRotationSequence.PILLAR_SIDEWAYS),
					width - 2, 1, 1, direction);
	...
	private boolean structure7(World world, Random random, int x, int y, int z, boolean doGen,
		...
		if (doGen) {
			...
			rotatedCubeVolume(world, x, y, z, 0, 1, 3,
					getStateFromRotation(3, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 0, 2, 0, getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 6, 8, 2,
					getStateFromRotation(3, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 7, 0, 2, BETWEENSTONE_BRICKS, 1, 7, 1, direction);
			rotatedCubeVolume(world, x, y, z, 7, 7, 2,
					getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 8, 0, 2, BETWEENSTONE_BRICKS, 1, 2, 1, direction);
			rotatedCubeVolume(world, x, y, z, 8, 2, 2, getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 10, 4, 2,
					getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			...
			rotatedCubeVolume(world, x, y, z, 6, 5, 3,
					getStateFromRotation(1, direction, WEEDWOOD_PLANK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR),
					1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 6, 8, 3, getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 10, 3, 3,
					getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			...
			rotatedCubeVolume(world, x, y, z, 7, 5, 4,
					getStateFromRotation(0, direction, WEEDWOOD_LOG, EnumRotationSequence.LOG_SIDEWAYS), 5, 1, 1,
					direction);
			...
			rotatedCubeVolume(world, x, y, z, 6, 5, 5,
					getStateFromRotation(3, direction, WEEDWOOD_PLANK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR),
					1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 6, 8, 5, getStateFromRotation(3, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 10, 6, 5,
					getStateFromRotation(3, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			...
			rotatedCubeVolume(world, x, y, z, 2, 8, 6,
					getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 3, 8, 6, getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 5, 8, 6, getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 6, 10, 6,
					getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			...
			rotatedCubeVolume(world, x, y, z, 10, 5, 6,
					getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			...
			rotatedCubeVolume(world, x, y, z, 6, 8, 7, getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 9, 5, 8,
					getStateFromRotation(0, direction, WEEDWOOD_LOG, EnumRotationSequence.LOG_SIDEWAYS), 3, 1, 1,
					direction);
			...
			rotatedCubeVolume(world, x, y, z, 6, 8, 9, getStateFromRotation(1, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 10, 5, 9,
					getStateFromRotation(3, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			...
			rotatedCubeVolume(world, x, y, z, 2, 4, 10,
					getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 3, 0, 10, BETWEENSTONE_BRICKS, 7, 2, 1, direction);
			rotatedCubeVolume(world, x, y, z, 3, 2, 10, getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 4, 2, 10, BETWEENSTONE_BRICKS, 2, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 5, 3, 10,
					getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 5, 8, 10, getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 5, 9, 10, BETWEENSTONE_BRICK_SLAB, 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 5, 11, 10, getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 6, 4, 10, getStateFromRotation(3, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			rotatedCubeVolume(world, x, y, z, 6, 5, 10, BETWEENSTONE_BRICKS, 1, 6, 1, direction);
			rotatedCubeVolume(world, x, y, z, 6, 11, 10,
					getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 7, 2, 10,
					getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 7, 6, 10, getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 9, 6, 10, getStateFromRotation(0, direction, BETWEENSTONE_BRICK_STAIRS,
					EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 10, 6, 10,
					getStateFromRotation(2, direction, BETWEENSTONE_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
					direction);
	...
	private boolean addLocationArea(World world, int x, int y, int z, int offsetX, int offsetY, int offsetZ,
			int sizeWidth, int sizeHeight, int sizeDepth, int direction, LocationStorage location) {
		location.addBounds(
				rotatedAABB(world, x, y, z, offsetX, offsetY, offsetZ, sizeWidth, sizeHeight, sizeDepth, direction)
						.grow(6, 6, 6));
		return true;
	}
	...
	private void generateLoot(World world, Random random, int x, int y, int z) {
		world.setBlockState(new BlockPos(x, y, z),
				getRandomBlock(random, EnumFacing.byHorizontalIndex(random.nextInt(4))), 2);
	...
	private IBlockState getRandomBlock(Random rand, EnumFacing dir) {
		...
		case 0:
			return BlockRegistry.LOOT_POT.getDefaultState().withProperty(BlockLootPot.VARIANT, EnumLootPot.POT_1)
					.withProperty(BlockLootPot.FACING, dir);
		case 1:
