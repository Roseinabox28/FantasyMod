...
public class WorldGenMudStructures extends WorldGenHelper {
	...
	private static final IBlockState MUD_BRICK_SLAB_UPSIDE_DOWN = MUD_BRICK_SLAB
	...
	public boolean generate(World worldIn, Random rand, BlockPos position) {
		...
		if (generated) {
			...
			LocationStorage locationStorage = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
					LocalRegion.getFromBlockPos(position), "abandoned_shack", EnumLocationType.RUINS);
	...
	private boolean structure1(World world, Random random, int x, int y, int z) {
		...
		if (!world.isAreaLoaded(new BlockPos(aabbGrown.minX, aabbGrown.minY, aabbGrown.minZ),
				new BlockPos(aabbGrown.maxX, aabbGrown.maxY, aabbGrown.maxZ)))
			return false;
		...
		rotatedCubeVolume(world, x, y, z, 0, 1, 0,
				getStateFromRotation(3, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 3, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 1, 0, MUD_FLOWER_POT, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 0, 1, 1,
				getStateFromRotation(0, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);
		...
		rotatedCubeVolume(world, x, y, z, 0, 1, 3,
				getStateFromRotation(0, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 2, direction);
		rotatedCubeVolume(world, x, y, z, 1, 0, 4, MUD_BRICKS, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 1, 1, 4,
				getStateFromRotation(1, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);
		...
		rotatedCubeVolume(world, x, y, z, 5, 1, 4,
				getStateFromRotation(1, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 1, 4,
				getStateFromRotation(2, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);
	...
	private boolean structure2(World world, Random random, int x, int y, int z) {
		...
		rotatedCubeVolume(world, x, y, z, 1, 1, 0,
				getStateFromRotation(3, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 0, 0, 1, MUD_BRICKS, 1, 1, 5, direction);
		rotatedCubeVolume(world, x, y, z, 0, 1, 1,
				getStateFromRotation(0, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 5, direction);
		...
		rotatedCubeVolume(world, x, y, z, 1, 1, 5,
				getStateFromRotation(1, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 5, 1, 1, direction);
		...
		rotatedCubeVolume(world, x, y, z, 5, 1, 1,
				getStateFromRotation(2, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 4, direction);
		rotatedCubeVolume(world, x, y, z, 4, 0, 0, MUD_BRICKS, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 1, 0,
				getStateFromRotation(3, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);

		rotatedCubeVolume(world, x, y, z, 1, 1, 2,
				getStateFromRotation(2, direction, MUD_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 3,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, 1, 2,
				getStateFromRotation(0, direction, MUD_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1, 3,
				direction);
	...
	private boolean structure3(World world, Random random, int x, int y, int z) {
		...
		rotatedCubeVolume(world, x, y, z, 1, 1, 1,
				getStateFromRotation(3, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);
		...
		rotatedCubeVolume(world, x, y, z, 4, 2, 1,
				getStateFromRotation(0, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);
		...
		rotatedCubeVolume(world, x, y, z, 7, 1, 3,
				getStateFromRotation(3, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);
		...
		rotatedCubeVolume(world, x, y, z, 6, 2, 6,
				getStateFromRotation(2, direction, MUD_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1, direction);
