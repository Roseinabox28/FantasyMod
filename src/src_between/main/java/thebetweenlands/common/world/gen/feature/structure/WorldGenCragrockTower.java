...
public class WorldGenCragrockTower extends WorldGenHelper {
	...
	public boolean generate(World worldIn, Random rand, BlockPos pos) {
		...
		MOSSY_CRAGROCK_TOP = BlockRegistry.CRAGROCK.getDefaultState().withProperty(BlockCragrock.VARIANT,
				BlockCragrock.EnumCragrockType.MOSSY_1);
		MOSSY_CRAGROCK_BOTTOM = BlockRegistry.CRAGROCK.getDefaultState().withProperty(BlockCragrock.VARIANT,
				BlockCragrock.EnumCragrockType.MOSSY_2);
		...
		CRAGROCK_BRICK_SLAB_UPSIDEDOWN = BlockRegistry.CRAGROCK_BRICK_SLAB.getDefaultState()
				.withProperty(BlockSlabBetweenlands.HALF, BlockSlabBetweenlands.EnumBlockHalfBL.TOP);
		SMOOTH_CRAGROCK_SLAB = BlockRegistry.SMOOTH_CRAGROCK_SLAB.getDefaultState();
		SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN = BlockRegistry.SMOOTH_CRAGROCK_SLAB.getDefaultState()
				.withProperty(BlockSlabBetweenlands.HALF, BlockSlabBetweenlands.EnumBlockHalfBL.TOP);
		...
		this.towerLocation = new LocationCragrockTower(this.worldStorage, new StorageUUID(UUID.randomUUID()),
				LocalRegion.getFromBlockPos(pos));
				...
				for (int xx = x; xx < x + width; xx++)
					for (int zz = z; zz < z + depth; zz++) {
						if (!(world.getBlockState(this.getCheckPos(xx, yy, zz)).getBlock() == BlockRegistry.BETWEENSTONE
								|| world.getBlockState(this.getCheckPos(xx, yy, zz))
										.getBlock() == BlockRegistry.CRAGROCK
								|| world.getBlockState(this.getCheckPos(xx, yy, zz))
										.getBlock() == BlockRegistry.SWAMP_DIRT
								|| world.getBlockState(this.getCheckPos(xx, yy, zz))
										.getBlock() == BlockRegistry.SWAMP_GRASS
								|| world.getBlockState(this.getCheckPos(xx, yy, zz))
										.getBlock() == BlockRegistry.WEEDWOOD_BUSH
								|| world.getBlockState(this.getCheckPos(xx, yy, zz)).getBlock() instanceof BlockBush
								|| world.getBlockState(this.getCheckPos(xx, yy, zz)).getBlock().isReplaceable(world,
										this.getCheckPos(xx, yy, zz))))
							return false;
					}
			break;
		case 1:
	...
	private boolean tower(World world, Random random, int x, int y, int z) {
		...
		for (int xo = -8; xo <= 8; xo++) {
			for (int zo = -8; zo <= 8; zo++) {
				...
				if (localPoint.getY() - y >= 0 && localPoint.getY() - y <= 5
						&& localPoint.getY() > highestPoint.getY()) {
		...
		if (!rotatedCubeMatches(world, x, y, z, 1, -1, 7, 2, 1, 1, direction, SurfaceType.MIXED_GROUND_OR_REPLACEABLE)
				|| !rotatedCubeMatches(world, x, y, z, 14, -1, 7, 2, 1, 1, direction,
						SurfaceType.MIXED_GROUND_OR_REPLACEABLE))
			return false;
		...
		rotatedCubeVolume(world, x, y, z, 5, 0, 7,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 2, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 7, 0, 7,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 0, 7, SMOOTH_CRAGROCK, 1, 1, 8, direction);
		rotatedCubeVolume(world, x, y, z, 9, 0, 7,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 10, 0, 7,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 2, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 0, 8,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 6, 0, 8, SMOOTH_CRAGROCK, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 0, 8,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 9, 0, 8,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 10, 0, 8, SMOOTH_CRAGROCK, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 0, 8,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, 0, 9, SMOOTH_CRAGROCK, 1, 1, 3, direction);
		rotatedCubeVolume(world, x, y, z, 5, 0, 9,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 6, 0, 9,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 7, 0, 9, SMOOTH_CRAGROCK, 3, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 0, 9,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 0, 9,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 5, 0, 11,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 6, 0, 11,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 7, 0, 11, SMOOTH_CRAGROCK, 3, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 0, 11,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 0, 11,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 0, 12,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 6, 0, 12, SMOOTH_CRAGROCK, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 0, 12,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 9, 0, 12,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 10, 0, 12, SMOOTH_CRAGROCK, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 0, 12,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 0, 13,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 2, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 7, 0, 13,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 9, 0, 13,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 10, 0, 13,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 2, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 7, 0, 14, SMOOTH_CRAGROCK, 3, 1, 1, direction);

		// CEILING
		rotatedCubeVolume(world, x, y, z, 7, 4, 6,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 3,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 4, 7,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 2,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 4, 7,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 4, 7, CRAGROCK_BRICK_SLAB_UPSIDEDOWN, 1, 1, 2, direction);
		rotatedCubeVolume(world, x, y, z, 9, 4, 7,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 4, 7,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 2,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 4, 8,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		...
		rotatedCubeVolume(world, x, y, z, 11, 4, 8,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 4, 9,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 3, direction);
		rotatedCubeVolume(world, x, y, z, 5, 4, 9,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 4, 9,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 4, 9,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 3, direction);
		...
		rotatedCubeVolume(world, x, y, z, 5, 4, 11,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 4, 11,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 4, 12,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 2, direction);
		rotatedCubeVolume(world, x, y, z, 11, 4, 12,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 2, direction);
		rotatedCubeVolume(world, x, y, z, 6, 4, 13,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 4, 13,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 4, 13, SMOOTH_CRAGROCK, 1, 1, 3, direction);
		rotatedCubeVolume(world, x, y, z, 9, 4, 13,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 4, 13,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 4, 14,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 4, 14,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);

		// INTERIOR
		rotatedCubeVolume(world, x, y, z, 8, 1, 9,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 2, 10,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 3, 11,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 4, 12,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 1, 10,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 1, 11, SMOOTH_CRAGROCK, 1, 2, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 3, 12,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 3, 13,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 1, 14, SMOOTH_CRAGROCK, 1, 3, 1, direction);
		rotatedSpawner(world, x, y, z, 8, 2, 13, direction, "thebetweenlands:termite").setMaxEntities(6)
				.setDelayRange(120, 300).setSpawnInAir(false);
		...
		// CEILING
		rotatedCubeVolume(world, x, y, z, 7, 9, 6,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 3, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 9, 7,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 2, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 9, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 9, 7, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 1, 1, 2, direction);
		rotatedCubeVolume(world, x, y, z, 9, 9, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 9, 7,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 2, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 9, 8,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		...
		rotatedCubeVolume(world, x, y, z, 11, 9, 8,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 9, 9,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				3, direction);
		rotatedCubeVolume(world, x, y, z, 5, 9, 9,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 9, 9,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 9, 9,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				3, direction);
		...
		rotatedCubeVolume(world, x, y, z, 5, 9, 11,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 9, 11,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 9, 12,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				2, direction);
		rotatedCubeVolume(world, x, y, z, 11, 9, 12,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				2, direction);
		rotatedCubeVolume(world, x, y, z, 6, 9, 13,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 9, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 9, 13, CRAGROCK_BRICKS, 1, 1, 2, direction);
		rotatedCubeVolume(world, x, y, z, 9, 9, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 9, 13,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 9, 14,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 9, 14,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);

		// INTERIOR
		rotatedCubeVolume(world, x, y, z, 8, 5, 8,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 6, 9,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 7, 10,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 8, 11,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 9, 12,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 5, 9,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 6, 10,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 7, 11,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 8, 12,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 8, 14,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 7, 15,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		...
		// FLOOR 2
		// CEILING/WALLS
		rotatedCubeVolume(world, x, y, z, 7, 12, 6,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 3, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 12, 7,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 2, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 12, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 12, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 12, 7,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 2, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 12, 8,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 12, 8,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 12, 9,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				3, direction);
		rotatedCubeVolume(world, x, y, z, 5, 12, 9,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 12, 9,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 12, 9,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				3, direction);
		rotatedCubeVolume(world, x, y, z, 5, 12, 11,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 12, 11,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 12, 12,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				2, direction);
		rotatedCubeVolume(world, x, y, z, 11, 12, 12,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				2, direction);
		rotatedCubeVolume(world, x, y, z, 6, 12, 13,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 12, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 12, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 12, 13,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 12, 14,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 3, 1,
				1, direction);
		...
		// BLOCKADE 1
		blockades.clear();
		rotatedCubeVolume(world, x, y, z, 7, 14, 12, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 4, 1, 1, direction,
				pos -> blockades.add(pos));
		...
		rotatedSpawner(world, x, y, z, 8, 17, 10, direction, "thebetweenlands:chiromaw").setMaxEntities(4)
				.setCheckRange(16.0D).setSpawnRange(3).setDelayRange(180, 500);
		...
		rotatedCubeVolume(world, x, y, z, 6, 22, 8,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 23, 8, SMOOTH_CRAGROCK_SLAB, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 22, 8,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 4,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 22, 9,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 4, direction);
		...
		// BLOCKADE 2
		blockades.clear();
		rotatedCubeVolume(world, x, y, z, 6, 23, 9, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 1, 1, 4, direction,
				pos -> blockades.add(pos));
		...
		rotatedSpawner(world, x, y, z, 8, 26, 10, direction, "thebetweenlands:swamp_hag").setMaxEntities(3)
				.setCheckRange(16.0D).setDelayRange(180, 500).setSpawnInAir(false);
		...
		rotatedCubeVolume(world, x, y, z, 10, 31, 8,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 32, 8, SMOOTH_CRAGROCK_SLAB, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 31, 9,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 31, 9,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 31, 11,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 31, 11,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 31, 12,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 31, 12,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 31, 13,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 31, 13,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 31, 13,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 31, 12,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 31, 12,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 31, 10, SMOOTH_CRAGROCK, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 30, 10, INACTIVE_GLOWING_SMOOTH_CRAGROCK, 1, 1, 1, direction,
				pos -> inactiveGlowingCragrockBlocks.add(pos));
		rotatedCubeVolume(world, x, y, z, 11, 29, 10,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		...
		// BLOCKADE 3
		blockades.clear();
		rotatedCubeVolume(world, x, y, z, 6, 32, 8, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 4, 1, 1, direction,
				pos -> blockades.add(pos));
		rotatedCubeVolume(world, x, y, z, 7, 32, 7, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 3, 1, 1, direction,
				pos -> blockades.add(pos));
		...
		rotatedSpawner(world, x, y, z, 8, 35, 10, direction, "thebetweenlands:pyrad").setMaxEntities(3)
				.setCheckRange(16.0D).setDelayRange(180, 500).setSpawnInAir(false)
		...
		rotatedCubeVolume(world, x, y, z, 10, 40, 12,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 41, 12, SMOOTH_CRAGROCK_SLAB, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 40, 12,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 40, 13,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 40, 13,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 40, 12,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 40, 12,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 40, 11,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 40, 10,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 2, direction);
		rotatedCubeVolume(world, x, y, z, 5, 40, 9,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 40, 9,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 40, 8,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 40, 13, SMOOTH_CRAGROCK, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 39, 13, INACTIVE_GLOWING_SMOOTH_CRAGROCK, 1, 1, 1, direction,
				pos -> inactiveGlowingCragrockBlocks.add(pos));
		rotatedCubeVolume(world, x, y, z, 8, 38, 13,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		...
		// BLOCKADE 4
		blockades.clear();
		rotatedCubeVolume(world, x, y, z, 10, 41, 8, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 1, 1, 4, direction,
				pos -> blockades.add(pos));
		rotatedCubeVolume(world, x, y, z, 11, 41, 9, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 1, 1, 3, direction,
				pos -> blockades.add(pos));
		...
		rotatedSpawner(world, x, y, z, 8, 44, 10, direction, "thebetweenlands:wight").setMaxEntities(2)
				.setCheckRange(24.0D).setDelayRange(300, 600).setSpawnInAir(false);
		...
		rotatedCubeVolume(world, x, y, z, 6, 49, 12,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 50, 12, SMOOTH_CRAGROCK_SLAB, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 49, 11,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 49, 11,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 49, 9,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 49, 9,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 49, 8,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 49, 8,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 49, 7,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 49, 7,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 49, 7,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 49, 8,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 49, 8,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 49, 10, SMOOTH_CRAGROCK, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 48, 10, INACTIVE_GLOWING_SMOOTH_CRAGROCK, 1, 1, 1, direction,
				pos -> inactiveGlowingCragrockBlocks.add(pos));
		rotatedCubeVolume(world, x, y, z, 5, 47, 10,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		...
		// BLOCKADE 5
		blockades.clear();
		rotatedCubeVolume(world, x, y, z, 7, 50, 12, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 4, 1, 1, direction,
				pos -> blockades.add(pos));
		rotatedCubeVolume(world, x, y, z, 7, 50, 13, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 3, 1, 1, direction,
				pos -> blockades.add(pos));
		...
		rotatedCubeVolume(world, x, y, z, 3, 53, 14,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 53, 14,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 54, 14,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 54, 14,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 3, 55, 11,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 56, 11,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 3, 57, 8,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 58, 8,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 5, 59, 5,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 60, 5,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 8, 61, 4,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 62, 4,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 11, 59, 5,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 60, 5,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 13, 57, 8,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 58, 8,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 13, 55, 11,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 56, 11,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedSpawner(world, x, y, z, 8, 54, 5, direction, "thebetweenlands:swamp_hag").setMaxEntities(3)
				.setCheckRange(10.0D).setDelayRange(150, 500).setSpawnInAir(false);
		...
		rotatedSpawner(world, x, y, z, 8, 54, 15, direction, "thebetweenlands:wight").setMaxEntities(2)
				.setCheckRange(24.0D).setDelayRange(300, 600).setSpawnInAir(false);
		...
		rotatedLootChest(world, random, x, y, z, 7, 52, 15, direction, 5, 8, 2, 3,
				LootTableRegistry.DUNGEON_CHEST_LOOT);
		...
		rotatedCubeVolume(world, x, y, z, 0, 1, 6,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 0, 2, 6,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 0, 3, 9,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 0, 4, 9,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 0, 5, 12,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 0, 6, 12,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 2, 7, 15,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 2, 8, 15,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 5, 9, 17,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 10, 17,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 8, 11, 18,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 12, 18,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 16, 1, 6,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 16, 2, 6,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 16, 3, 9,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 16, 4, 9,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 16, 5, 12,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 16, 6, 12,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 14, 7, 15,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 14, 8, 15,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 11, 9, 17,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 10, 17,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		for (int steps = 0; steps < 17; steps++) {
			...
			if (!stairBlockRight.getBlock().isReplaceable(world, stairPosRight)
					|| stairBlockRight.getMaterial().isLiquid()
					|| !stairBlockLeft.getBlock().isReplaceable(world, stairPosLeft)
					|| stairBlockLeft.getMaterial().isLiquid() || steps == 16) {
				stair1Length = steps;
			...
			if (steps % 2 == 0) {
				rotatedCubeVolumeExtendedDown(world, x, y, z, 0, -steps, 6 - steps * 2, CRAGROCK_PILLAR, 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 0, 1 - steps, 6 - steps * 2,
						getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 0, 2 - steps, 6 - steps * 2,
						getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 0, 3 - steps, 6 - steps * 2, AIR, 1, 1, 1, direction,
						pos -> inactiveWisps.add(pos));

				rotatedCubeVolumeExtendedDown(world, x, y, z, 3, -steps, 6 - steps * 2, CRAGROCK_PILLAR, 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 3, 1 - steps, 6 - steps * 2,
						getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 3, 2 - steps, 6 - steps * 2,
						getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 3, 3 - steps, 6 - steps * 2, AIR, 1, 1, 1, direction,
						pos -> inactiveWisps.add(pos));
			}

			rotatedCubeVolume(world, x, y, z, 1, -1 - steps, 8 - steps * 2, CRAGROCK_BRICK_SLAB_UPSIDEDOWN, 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 2, -1 - steps, 8 - steps * 2, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 1, 1, 1,
					direction);
		...
		for (int steps = 0; steps < 17; steps++) {
			...
			if (steps % 2 == 0) {
				rotatedCubeVolumeExtendedDown(world, x, y, z, 0 + 13, -steps, 6 - steps * 2, CRAGROCK_PILLAR, 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 0 + 13, 1 - steps, 6 - steps * 2,
						getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 0 + 13, 2 - steps, 6 - steps * 2,
						getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 0 + 13, 3 - steps, 6 - steps * 2, AIR, 1, 1, 1, direction,
						pos -> inactiveWisps.add(pos));

				rotatedCubeVolumeExtendedDown(world, x, y, z, 3 + 13, -steps, 6 - steps * 2, CRAGROCK_PILLAR, 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 3 + 13, 1 - steps, 6 - steps * 2,
						getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 3 + 13, 2 - steps, 6 - steps * 2,
						getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
						direction);
				rotatedCubeVolume(world, x, y, z, 3 + 13, 3 - steps, 6 - steps * 2, AIR, 1, 1, 1, direction,
						pos -> inactiveWisps.add(pos));
			}

			rotatedCubeVolume(world, x, y, z, 2 + 13, -1 - steps, 8 - steps * 2, CRAGROCK_BRICK_SLAB_UPSIDEDOWN, 1, 1,
					1, direction);
			rotatedCubeVolume(world, x, y, z, 1 + 13, -1 - steps, 8 - steps * 2, SMOOTH_CRAGROCK_SLAB_UPSIDEDOWN, 1, 1,
					1, direction);
			...
			rotatedCubeVolume(world, x, y, z, 2 + 13, -1 - steps, 6 - steps * 2, CRAGROCK_BRICK_SLAB, 1, 1, 1,
					direction);
			rotatedCubeVolume(world, x, y, z, 1 + 13, -1 - steps, 6 - steps * 2, SMOOTH_CRAGROCK_SLAB, 1, 1, 1,
					direction);
		}
		...
		rotatedCubeVolume(world, x, y, z, 7, 13, 5,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 3, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 7, 13, 6,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 9, 13, 6,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 6, 13, 6,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 10, 13, 6,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 4, 13, 8,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 2,
				direction);
		rotatedCubeVolume(world, x, y, z, 12, 13, 8,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 2,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 13, 9,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 13, 9,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 13, 10,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 2,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 13, 10,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 2,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, 13, 11,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 12, 13, 11,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, 13, 12,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, 13, 13, SMOOTH_CRAGROCK_SLAB, 1, 1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 13, 12,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		...
		rotatedCubeVolume(world, x, y, z, 6, 13, 14,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 2, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 9, 13, 14,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 2, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 7, 13, 15,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 13, 15,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 9, 13, 15,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 7, 23, 6,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 23, 6,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 7, 23, 14,
				getStateFromRotation(0, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 9, 23, 14,
				getStateFromRotation(2, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 23, 9,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 23, 11,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 23, 9,
				getStateFromRotation(3, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 23, 11,
				getStateFromRotation(1, direction, SMOOTH_CRAGROCK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1,
				1, 1, direction);
		...
		rotatedCubeVolume(world, x, y, z, 8, 7, 4,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 8, 4,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 9, 4,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 10, 4, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 13, 4,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 14, 4,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 15, 4,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 14, 5,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 15, 5,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 7, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 8, 5,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 9, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 10, 5, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 13, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 14, 5,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 15, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 14, 6,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 15, 6,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 7, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 8, 5,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 9, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 10, 5, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 13, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 14, 5,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 15, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 14, 6,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 15, 6,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 7, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 8, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 9, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 10, 7, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 13, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 14, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 15, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 12, 14, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 12, 15, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 14, 7, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 14, 8, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 14, 9, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 14, 10, 10, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 14, 13, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 14, 14, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 14, 15, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 14, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 15, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 7, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 8, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 9, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 10, 13, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 13, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 14, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 13, 15, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 12, 14, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 12, 15, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 7, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 8, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 9, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 10, 7, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 13, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 14, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 15, 7,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, 14, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, 15, 7,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 2, 7, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 2, 8, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 2, 9, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 2, 10, 10, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 2, 13, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 2, 14, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 2, 15, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 14, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 15, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 7, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 8, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 9, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 10, 13, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 13, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 14, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 3, 15, 13,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, 14, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 4, 15, 13,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 7, 16,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 8, 16,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 9, 16,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 10, 16, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 13, 16,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 14, 16,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 15, 16,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 14, 15,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 8, 15, 15,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 7, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 8, 15,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 9, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 10, 15, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 11, 13, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 14, 15,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 15, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 14, 14,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 11, 15, 14,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 7, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 8, 15,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 9, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 10, 15, SMOOTH_CRAGROCK_WALL, 1, 3, 1, direction);
		rotatedCubeVolume(world, x, y, z, 5, 13, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 14, 15,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 15, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 14, 14,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.STAIR), 1, 1, 1,
				direction);
		rotatedCubeVolume(world, x, y, z, 5, 15, 14,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 48, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 49, 5,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 50, 5,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 48, 8,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 49, 8,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 50, 8,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 48, 8,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 49, 8,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 50, 8,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 48, 6,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 49, 6,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 50, 6,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 48, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 49, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 3, 50, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 48, 14,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 49, 14,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 6, 50, 14,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 48, 6,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 49, 6,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 50, 6,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 48, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 49, 10,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 13, 50, 10,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 48, 14,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 49, 14,
				getStateFromRotation(0, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 10, 50, 14,
				getStateFromRotation(2, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 48, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 49, 15,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 8, 50, 15,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 48, 12,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 49, 12,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 4, 50, 12,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 48, 12,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 49, 12,
				getStateFromRotation(3, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		rotatedCubeVolume(world, x, y, z, 12, 50, 12,
				getStateFromRotation(1, direction, CRAGROCK_BRICK_STAIRS, EnumRotationSequence.UPSIDE_DOWN_STAIR), 1, 1,
				1, direction);
		...
		default:
		case 0:
			locationBounds = new AxisAlignedBB(x - 1, y - 8, z + 1, x + width + 1, y + height, z + depth + 1).grow(6, 6,
					6);
			entrance = new BlockPos(x + width / 2, y + 5, z + depth / 2 + 8);
			break;
		case 1:
			locationBounds = new AxisAlignedBB(x + 1, y - 8, z + depth - width - 1, x + depth + 1, y + height,
					z + depth + 1).grow(6, 6, 6);
			entrance = new BlockPos(x + width / 2 + 9, y + 5, z + depth / 2 + 1);
			break;
		case 2:
			locationBounds = new AxisAlignedBB(x - 1 + width - width, y - 8, z + depth - depth - 1, x + 1 + width,
					y + height, z + depth - 1).grow(6, 6, 6);
			entrance = new BlockPos(x + width / 2, y + 5, z + depth / 2 - 8);
			break;
		case 3:
			locationBounds = new AxisAlignedBB(x - 1 + width - depth, y - 8, z - 1, x - 1 + width, y + height,
					z + 1 + width).grow(6, 6, 6);
			entrance = new BlockPos(x + width / 2 - 9, y + 5, z + depth / 2 - 1);
			break;
		}
		x += width / 2;
