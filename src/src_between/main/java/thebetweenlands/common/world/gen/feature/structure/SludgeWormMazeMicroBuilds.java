...
public class SludgeWormMazeMicroBuilds {
	...
	public void spikeFeature(World world, BlockPos pos, EnumFacing facing, Random rand, int level, int layer) {
		...
		rotatedCubeVolume(world, rand, pos, 2, 1, 0,
				blockHelper.MUD_BRICKS_SPIKE_TRAP.withProperty(BlockMudBrickSpikeTrap.FACING, facing.rotateY()), 1, 1,
				1, facing);
		rotatedCubeVolume(world, rand, pos, -2, 1, 0, blockHelper.MUD_BRICKS_SPIKE_TRAP
				.withProperty(BlockMudBrickSpikeTrap.FACING, facing.getOpposite().rotateY()), 1, 1, 1, facing);
	}

	private void buildCryptBench1(World world, BlockPos pos, EnumFacing facing, Random rand, int level, int layer) {
		rotatedCubeVolume(world, rand, pos, -1, 0, -1,
				blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 0, 0, -1, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 0, -1, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 2, -1,
				blockHelper.getStairsForLevel(rand, level, facing.rotateY(), EnumHalf.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 0, 2, -1, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 2, -1,
				blockHelper.getStairsForLevel(rand, level, facing.getOpposite().rotateY(), EnumHalf.TOP), 1, 1, 1,
				facing);
	...
	private void buildWallPillarRoom(World world, BlockPos pos, EnumFacing facing, Random rand, int level, int layer) {
		...
		rotatedCubeVolume(world, rand, pos, 1, 0, 1, blockHelper.MUD_BRICK_WALL, 1, 3, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 3, 1, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1,
				facing);
	...
	private void buildBigPillarCandle(World world, BlockPos pos, EnumFacing facing, Random rand, int level, int layer) {
		...
		rotatedCubeVolume(world, rand, pos, 1, 3, 1, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 2, 1,
				blockHelper.getStairsForLevel(rand, level, facing.getOpposite(), EnumHalf.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 2, 1,
				blockHelper.getStairsForLevel(rand, level, facing.getOpposite(), EnumHalf.TOP), 1, 1, 1, facing);
	}

	private void buildWallPillarShelfRoom(World world, BlockPos pos, EnumFacing facing, Random rand, int level,
			int layer) {
		rotatedCubeVolume(world, rand, pos, -1, 0, 1, blockHelper.MUD_BRICK_WALL, 1, 3, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 0, 1, blockHelper.MUD_BRICK_WALL, 1, 3, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 3, 1, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1,
		...
		rotatedCubeVolume(world, rand, pos, 1, 0, -1, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 1, -1,
				blockHelper.ITEM_SHELF.withProperty(BlockItemShelf.FACING, facing.getOpposite()), 3, 2, 1, facing); // TODO
																													// loot?
	}

	private void buildWallPillarCentral(World world, BlockPos pos, EnumFacing facing, Random rand, int level,
			int layer) {
		rotatedCubeVolume(world, rand, pos, 0, 0, 1, blockHelper.MUD_BRICK_WALL, 1, 3, 1, facing);
		rotatedCubeVolume(world, rand, pos, 0, 3, 1, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 0, 0, 0,
				blockHelper.CHEST.withProperty(BlockChestBetweenlands.FACING, facing.getOpposite()), 1, 1, 1, facing); // TODO
																														// loot?
	}

	private void buildBigPillarTableRoom(World world, BlockPos pos, EnumFacing facing, Random rand, int level,
			int layer) {
		...
		rotatedCubeVolume(world, rand, pos, -1, 1, 1, blockHelper.getPillarsForLevel(rand, level, 2), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 2, 1, blockHelper.getPillarsForLevel(rand, level, 3), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 0, 0, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 0, 0, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		...
		rotatedCubeVolume(world, rand, pos, -1, 1, -1, blockHelper.getRandomLootUrn(rand, facing), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 1, -1, blockHelper.getRandomLitCandle(rand), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 2, 0, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 2, 0, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 2, -1,
				blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 2, -1, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 0, -1,
				blockHelper.getStairsForLevel(rand, level, facing.getOpposite(), EnumHalf.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 0, -1,
	...
	private void buildWallPillarRoomLowJamb(World world, BlockPos pos, EnumFacing facing, Random rand, int level,
			int layer) {
		rotatedCubeVolume(world, rand, pos, -1, 0, 1, blockHelper.MUD_BRICK_WALL, 1, 2, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 0, 1, blockHelper.MUD_BRICK_WALL, 1, 2, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 2, 1, blockHelper.getMudBricksForLevel(rand, level, 2), 1, 1, 1,
				facing);
	...
	private void buildOpenShrineRoom(World world, BlockPos pos, EnumFacing facing, Random rand, int level, int layer) {
		rotatedCubeVolume(world, rand, pos, -1, 0, 1,
				blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.BOTTOM), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 0, 1,
				blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.BOTTOM), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 0, 0, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1,
				facing);
		...
		rotatedCubeVolume(world, rand, pos, 1, 1, -1,
				blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.BOTTOM), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 0, 1, -1, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1,
				facing);
	...
	private void buildMudWallJamb(World world, BlockPos pos, EnumFacing facing, Random rand, int level, int layer) {
		...
		rotatedCubeVolume(world, rand, pos, 1, 0, -1, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 0, 0, blockHelper.getStairsForLevel(rand, level, facing, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 0, 0, blockHelper.getStairsForLevel(rand, level, facing, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 1, -1, blockHelper.getRandomLitCandle(rand), 1, 1, 1, facing);
	...
	private void buildCubbyHole(World world, BlockPos pos, EnumFacing facing, Random rand, int level, int layer) {
		rotatedCubeVolume(world, rand, pos, 0, 0, -1, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 0, 1, -1, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 0, 2, -1, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, -1, 0, -1,
				blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 0, -1, blockHelper.getMudSlabsForLevel(rand, level, EnumBlockHalfBL.TOP),
		...
		rotatedCubeVolume(world, rand, pos, -1, 1, -1, blockHelper.getRandomLootUrn(rand, facing), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 1, -1, blockHelper.getRandomLootUrn(rand, facing), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 2, 0,
				blockHelper.getStairsForLevel(rand, level, facing.getOpposite(), EnumHalf.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 0, 2, 0,
				blockHelper.getStairsForLevel(rand, level, facing.getOpposite(), EnumHalf.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 2, 0,
				blockHelper.getStairsForLevel(rand, level, facing.getOpposite(), EnumHalf.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 0, 3, 1, blockHelper.getMudBricksForLevel(rand, level, 1), 1, 1, 1, facing);
	...
	public void addBarrisheeCubby(World world, BlockPos pos, EnumFacing facing, Random rand, int level) {
		for (int x = 0; x < 9; x++) {
			for (int z = 0; z < 3; z++) {
				...
				this.dungeon.setBlockAndNotifyAdequately(world, pos.add(x, 0, z),
						blockHelper.getTilesForLevel(rand, 3));
				this.dungeon.setBlockAndNotifyAdequately(world, pos.add(x, 4, z),
						blockHelper.getMudBricksForLevel(rand, 3, 1));
				if (x == 0 || x == 8) {
					if (z > 0) {
						for (int y = 1; y <= 3; y++)
							this.dungeon.setBlockAndNotifyAdequately(world, pos.add(x, y, z),
									blockHelper.getMudBricksForLevel(rand, 3, y));
					}
				}
				if (z == 0) {
					for (int y = 1; y <= 3; y++)
						this.dungeon.setBlockAndNotifyAdequately(world, pos.add(x, y, 0),
								blockHelper.getMudBricksForLevel(rand, 3, y));
				}
			}
		}
		...
		this.dungeon.setBlockAndNotifyAdequately(world, pos.add(5, 1, 1),
				blockHelper.getRandomLootUrn(rand, facing.getOpposite()));
		this.dungeon.setBlockAndNotifyAdequately(world, pos.add(1, 1, 1),
				blockHelper.CHEST.withProperty(BlockChestBetweenlands.FACING, facing.rotateYCCW()));
		this.dungeon.setBlockAndNotifyAdequately(world, pos.add(1, 1, 2),
				blockHelper.CHEST.withProperty(BlockChestBetweenlands.FACING, facing.rotateYCCW()));
		this.dungeon.setBlockAndNotifyAdequately(world, pos.add(1, 3, 1),
				blockHelper.getMudBricksForLevel(rand, level, 0));
		this.dungeon.setBlockAndNotifyAdequately(world, pos.add(1, 3, 2),
				blockHelper.getMudBricksForLevel(rand, level, 0));
		this.dungeon.setBlockAndNotifyAdequately(world, pos.add(1, 2, 1),
				blockHelper.getStairsForLevel(rand, level, facing.rotateY(), EnumHalf.TOP));
		this.dungeon.setBlockAndNotifyAdequately(world, pos.add(1, 2, 2),
				blockHelper.getStairsForLevel(rand, level, facing.rotateY(), EnumHalf.TOP));
		this.dungeon.setBlockAndNotifyAdequately(world, pos.add(2, 3, 1),
				blockHelper.getStairsForLevel(rand, level, facing.rotateY(), EnumHalf.TOP));
		this.dungeon.setBlockAndNotifyAdequately(world, pos.add(2, 3, 2),
				blockHelper.getStairsForLevel(rand, level, facing.rotateY(), EnumHalf.TOP));
	}
	...
	public void buildCryptCrawlerWalkwaysStairsNormal(World world, BlockPos pos, EnumFacing facing, Random rand) {
		rotatedCubeVolume(world, rand, pos, 0, 0, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateY())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 0, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateYCCW())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -1, 1, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateY())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -2, 1, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateYCCW())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -2, 2, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateY())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -3, 2, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateYCCW())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -3, 3, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateY())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -4, 3, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateYCCW())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -4, 4, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateY())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -5, 5, 0,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing.rotateY())
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
	...
	public void buildCryptCrawlerTunnelsConnect(World world, BlockPos pos, EnumFacing facing, Random rand) {
		...
		rotatedCubeVolume(world, rand, pos, 3, 1, 13, blockHelper.COMPACTED_MUD_MIRAGE, 1, 2, 1, facing); // mirage
																											// blocks
		...
		// stairs
		rotatedCubeVolume(world, rand, pos, 1, 3, 18,
				blockHelper.MUD_BRICK_STAIRS_DECAY_1.withProperty(BlockStairsBetweenlands.FACING, facing)
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 3, 22,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing)
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 4, 3, 18,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing)
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 4, 3, 22,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing)
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 7, 3, 18,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing)
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);

		rotatedCubeVolume(world, rand, pos, 2, 1, 14,
				blockHelper.MUD_BRICK_STAIRS_DECAY_3.withProperty(BlockStairsBetweenlands.FACING, facing.rotateY())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 2, 3, 15,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing.rotateY())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 2, 3, 19,
				blockHelper.MUD_BRICK_STAIRS_DECAY_1.withProperty(BlockStairsBetweenlands.FACING, facing.rotateY())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 2, 3, 23,
				blockHelper.MUD_BRICK_STAIRS_DECAY_2.withProperty(BlockStairsBetweenlands.FACING, facing.rotateY())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 0, 1, 22,
				blockHelper.MUD_BRICK_STAIRS_DECAY_3.withProperty(BlockStairsBetweenlands.FACING, facing.rotateY())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 2, 1, 24,
				blockHelper.MUD_BRICK_STAIRS_DECAY_3.withProperty(BlockStairsBetweenlands.FACING, facing.rotateY())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 5, 3, 19,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing.rotateY())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 5, 3, 23,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing.rotateY())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);

		rotatedCubeVolume(world, rand, pos, 2, 2, 14,
				blockHelper.MUD_BRICK_STAIRS_DECAY_2.withProperty(BlockStairsBetweenlands.FACING, facing.getOpposite())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 3, 16,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing.getOpposite())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 4, 3, 20,
				blockHelper.MUD_BRICK_STAIRS_DECAY_1.withProperty(BlockStairsBetweenlands.FACING, facing.getOpposite())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 4, 1, 15,
				blockHelper.MUD_BRICK_STAIRS_DECAY_2.withProperty(BlockStairsBetweenlands.FACING, facing.getOpposite())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 3, 20,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing.getOpposite())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 7, 3, 16,
				blockHelper.MUD_BRICK_STAIRS_DECAY_1.withProperty(BlockStairsBetweenlands.FACING, facing.getOpposite())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 7, 3, 20,
				blockHelper.MUD_BRICK_STAIRS_DECAY_2.withProperty(BlockStairsBetweenlands.FACING, facing.getOpposite())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);

		rotatedCubeVolume(world, rand, pos, 4, 2, 14,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing.rotateYCCW())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 6, 3, 15,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing.rotateYCCW())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 4, 2, 24,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing.rotateYCCW())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 3, 3, 24,
				blockHelper.MUD_BRICK_STAIRS_DECAY_1.withProperty(BlockStairsBetweenlands.FACING, facing.rotateYCCW())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 3, 3, 19,
				blockHelper.MUD_BRICK_STAIRS.withProperty(BlockStairsBetweenlands.FACING, facing.rotateYCCW())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 8, 1, 16,
				blockHelper.MUD_BRICK_STAIRS_DECAY_3.withProperty(BlockStairsBetweenlands.FACING, facing.rotateYCCW())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 8, 1, 21,
				blockHelper.MUD_BRICK_STAIRS_DECAY_3.withProperty(BlockStairsBetweenlands.FACING, facing.rotateYCCW())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.BOTTOM),
				1, 1, 2, facing);
		rotatedCubeVolume(world, rand, pos, 4, 1, 24,
				blockHelper.MUD_BRICK_STAIRS_DECAY_2.withProperty(BlockStairsBetweenlands.FACING, facing.rotateYCCW())
						.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);

		// slabs
		rotatedCubeVolume(world, rand, pos, 1, 1, 20,
				blockHelper.MUD_BRICK_SLAB_DECAY_3.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.BOTTOM), 1,
				1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 7, 1, 23,
				blockHelper.MUD_BRICK_SLAB_DECAY_3.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.BOTTOM), 1,
				1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 5, 3, 15,
				blockHelper.MUD_BRICK_SLAB.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 4, 3, 16,
				blockHelper.MUD_BRICK_SLAB.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 6, 3, 19,
				blockHelper.MUD_BRICK_SLAB.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 3, 3, 23,
				blockHelper.MUD_BRICK_SLAB.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 7, 3, 23,
				blockHelper.MUD_BRICK_SLAB.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP), 1, 1, 1,
				facing);
		...
		rotatedCubeVolume(world, rand, pos, 5, 1, 15, blockHelper.getRandomLootUrn(rand, facing.getOpposite()), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 7, 1, 16, blockHelper.getRandomLootUrn(rand, facing.rotateY()), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 7, 1, 20, blockHelper.getRandomLootUrn(rand, facing.rotateY()), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 1, 1, 18, blockHelper.getRandomLootUrn(rand, facing.rotateYCCW()), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 1, 1, 22, blockHelper.getRandomLootUrn(rand, facing.rotateYCCW()), 1, 1, 1,
				facing);
		...
		rotatedCubeVolume(world, rand, pos, 7, 3, 22,
				blockHelper.COMPACTED_MUD_SLAB.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP), 1, 1, 1,
				facing);
