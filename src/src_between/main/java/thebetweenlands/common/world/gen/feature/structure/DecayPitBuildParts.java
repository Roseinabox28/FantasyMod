...
public class DecayPitBuildParts {
	...
	public void buildMainAreaPart(World world, BlockPos pos, EnumFacing facing, Random rand, int level, int layer) {
		...
		rotatedCubeVolume(world, rand, pos, 8, 7, 7,
				blockHelper.getStairsForLevel(rand, 7, facing.rotateY(), BlockStairsBetweenlands.EnumHalf.BOTTOM), 1, 1,
				1, facing);
		rotatedCubeVolume(world, rand, pos, 7, 7, 8,
				blockHelper.getStairsForLevel(rand, 7, facing.getOpposite(), BlockStairsBetweenlands.EnumHalf.BOTTOM),
				1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 9, 7, 7,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.BOTTOM), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 7, 7, 9,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.BOTTOM), 1, 1, 1,
				facing);
		...
		rotatedCubeVolume(world, rand, pos, 10, 9, 0,
				blockHelper.getStairsForLevel(rand, 7, facing.rotateYCCW(), BlockStairsBetweenlands.EnumHalf.TOP), 1, 1,
				3, facing);
		rotatedCubeVolume(world, rand, pos, 10, 9, 3,
				blockHelper.getStairsForLevel(rand, 7, facing.getOpposite(), BlockStairsBetweenlands.EnumHalf.TOP), 1,
				1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 11, 9, 3,
				blockHelper.getStairsForLevel(rand, 7, facing.rotateYCCW(), BlockStairsBetweenlands.EnumHalf.TOP), 1, 1,
				1, facing);
		rotatedCubeVolume(world, rand, pos, 11, 9, 4,
				blockHelper.getStairsForLevel(rand, 7, facing.getOpposite(), BlockStairsBetweenlands.EnumHalf.TOP), 1,
				1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 10, 10, 0,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.BOTTOM), 1, 1, 4,
				facing);
		rotatedCubeVolume(world, rand, pos, 11, 10, 4,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.BOTTOM), 1, 1, 1,
				facing);

		rotatedCubeVolume(world, rand, pos, 1, 9, 10,
				blockHelper.getStairsForLevel(rand, 7, facing, BlockStairsBetweenlands.EnumHalf.TOP), 2, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 3, 9, 10,
				blockHelper.getStairsForLevel(rand, 7, facing.rotateY(), BlockStairsBetweenlands.EnumHalf.TOP), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 3, 9, 11,
				blockHelper.getStairsForLevel(rand, 7, facing, BlockStairsBetweenlands.EnumHalf.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 4, 9, 11,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 4, 10, 11,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.BOTTOM), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 1, 10, 10,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.BOTTOM), 3, 1, 1,
				facing);
		...
		rotatedCubeVolume(world, rand, pos, 13, 11, 0,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.BOTTOM), 1, 1, 2,
				facing);
		rotatedCubeVolume(world, rand, pos, 13, 14, 0,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 2, facing);
		rotatedCubeVolume(world, rand, pos, 13, 11, 2,
				blockHelper.getStairsForLevel(rand, 7, facing, BlockStairsBetweenlands.EnumHalf.BOTTOM), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 13, 14, 2,
				blockHelper.getStairsForLevel(rand, 7, facing, BlockStairsBetweenlands.EnumHalf.TOP), 1, 1, 1, facing);
		...
		rotatedCubeVolume(world, rand, pos, 1, 11, 13,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.BOTTOM), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 1, 14, 13,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 2, 11, 13,
				blockHelper.getStairsForLevel(rand, 7, facing.rotateYCCW(), BlockStairsBetweenlands.EnumHalf.BOTTOM), 1,
				1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 2, 14, 13,
				blockHelper.getStairsForLevel(rand, 7, facing.rotateYCCW(), BlockStairsBetweenlands.EnumHalf.TOP), 1, 1,
				1, facing);
		...
		rotatedCubeVolume(world, rand, pos, 8, 14, 0,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 6, facing);
		for (int count = 0; count < 9; count++)
			rotatedCubeVolume(world, rand, pos, 9, 14, 0 + count,
					blockHelper.getRandomBeam(facing.getOpposite(), rand, level, 0, false), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 10, 14, 0,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 7, facing);
		rotatedCubeVolume(world, rand, pos, 11, 14, 0,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 2, facing);
		rotatedCubeVolume(world, rand, pos, 12, 14, 1,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 1, facing);

		rotatedCubeVolume(world, rand, pos, 1, 14, 7,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 14, 8,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 5, 1, 1, facing);
		for (int count = 0; count < 9; count++)
			rotatedCubeVolume(world, rand, pos, 1 + count, 14, 9,
					blockHelper.getRandomBeam(facing.rotateYCCW(), rand, level, 0, false), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 14, 10,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 6, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 14, 11,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 2, facing);
		...
		rotatedCubeVolume(world, rand, pos, 1, 14, 1,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 2, facing);
		rotatedCubeVolume(world, rand, pos, 2, 14, 0,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 2, facing);
		...
		rotatedCubeVolume(world, rand, pos, 6, 14, 6,
				blockHelper.getStairsForLevel(rand, 7, facing, BlockStairsBetweenlands.EnumHalf.TOP), 3, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 6, 14, 7,
				blockHelper.getStairsForLevel(rand, 7, facing.rotateYCCW(), BlockStairsBetweenlands.EnumHalf.TOP), 1, 1,
				2, facing);

		rotatedCubeVolume(world, rand, pos, 8, 13, 7,
				blockHelper.getStairsForLevel(rand, 7, facing.rotateY(), BlockStairsBetweenlands.EnumHalf.TOP), 1, 1, 1,
				facing);
		rotatedCubeVolume(world, rand, pos, 9, 13, 7,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 2, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 11, 13, 7,
				blockHelper.getStairsForLevel(rand, 7, facing.rotateYCCW(), BlockStairsBetweenlands.EnumHalf.TOP), 1, 1,
				1, facing);
		rotatedCubeVolume(world, rand, pos, 7, 13, 8,
				blockHelper.getStairsForLevel(rand, 7, facing.getOpposite(), BlockStairsBetweenlands.EnumHalf.TOP), 1,
				1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 7, 13, 9,
				blockHelper.getMudSlabsForLevel(rand, 7, BlockSlabBetweenlands.EnumBlockHalfBL.TOP), 1, 1, 2, facing);
		rotatedCubeVolume(world, rand, pos, 7, 13, 11,
				blockHelper.getStairsForLevel(rand, 7, facing, BlockStairsBetweenlands.EnumHalf.TOP), 1, 1, 1, facing);
		...
		rotatedCubeVolume(world, rand, pos, 2, 1, 0,
				...
				1, 1, 3, facing);
		rotatedCubeVolume(world, rand, pos, 1, 1, 2,
				blockHelper.COMPACTED_MUD_SLOPE.withProperty(BlockCompactedMudSlope.FACING, facing)
						.withProperty(BlockCompactedMudSlope.HALF, EnumHalf.BOTTOM),
				1, 1, 1, facing);
		...
		rotatedCubeVolume(world, rand, pos, 4, 2, 0, blockHelper.DECAY_PIT_INVISIBLE_FLOOR_BLOCK
				.withProperty(BlockDecayPitInvisibleFloorBlock.FACING, facing.rotateY()), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 4, 2, 1, blockHelper.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_R_1
				.withProperty(BlockDecayPitInvisibleFloorBlockR1.FACING, facing.rotateY()), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 4, 2, 2, blockHelper.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_R_2
				.withProperty(BlockDecayPitInvisibleFloorBlockR2.FACING, facing.rotateY()), 1, 1, 1, facing);

		if (facing == EnumFacing.SOUTH || facing == EnumFacing.NORTH)
			rotatedCubeVolume(world, rand, pos, 3, 2, 3, blockHelper.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_DIAGONAL
					.withProperty(BlockDecayPitInvisibleFloorBlockDiagonal.FLIPPED, false), 1, 1, 1, facing);
		else
			rotatedCubeVolume(world, rand, pos, 3, 2, 3, blockHelper.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_DIAGONAL
					.withProperty(BlockDecayPitInvisibleFloorBlockDiagonal.FLIPPED, true), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 1, 2, 4, blockHelper.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_L_1
				.withProperty(BlockDecayPitInvisibleFloorBlockL1.FACING, facing.getOpposite()), 1, 1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 2, 2, 4, blockHelper.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_L_2
				.withProperty(BlockDecayPitInvisibleFloorBlockL2.FACING, facing.getOpposite()), 1, 1, 1, facing);
	...
	public void addSpikes(World world, BlockPos pos, EnumFacing facing, Random rand, int level, int layer) {
		rotatedCubeVolume(world, rand, pos, -2, 7, 12,
				blockHelper.MUD_BRICKS_SPIKE_TRAP.withProperty(BlockMudBrickSpikeTrap.FACING, facing.getOpposite()), 5,
				1, 1, facing);
		rotatedCubeVolume(world, rand, pos, -2, 8, 12,
				blockHelper.MUD_BRICKS_SPIKE_TRAP.withProperty(BlockMudBrickSpikeTrap.FACING, facing.getOpposite()), 1,
				1, 1, facing);
		rotatedCubeVolume(world, rand, pos, 2, 8, 12,
				blockHelper.MUD_BRICKS_SPIKE_TRAP.withProperty(BlockMudBrickSpikeTrap.FACING, facing.getOpposite()), 1,
				1, 1, facing);
