...
public class DecorationHelper {
	...
	public static final WorldGenerator GEN_SWAMP_TALLGRASS = new WorldGenPlantCluster(
			BlockRegistry.SWAMP_TALLGRASS.getDefaultState());
	public static final WorldGenerator GEN_NETTLES = new WorldGenPlantCluster(BlockRegistry.NETTLE.getDefaultState(), 3,
			128);
	public static final WorldGenerator GEN_ARROW_ARUM = new WorldGenPlantCluster(
			BlockRegistry.ARROW_ARUM.getDefaultState());
	public static final WorldGenerator GEN_PICKEREL_WEED = new WorldGenPlantCluster(
			BlockRegistry.PICKEREL_WEED.getDefaultState());
	public static final WorldGenerator GEN_MARSH_HIBISCUS = new WorldGenPlantCluster(
			BlockRegistry.MARSH_HIBISCUS.getDefaultState());
	public static final WorldGenerator GEN_MARSH_MALLOW = new WorldGenPlantCluster(
			BlockRegistry.MARSH_MALLOW.getDefaultState());
	public static final WorldGenerator GEN_BUTTON_BUSH = new WorldGenPlantCluster(
			BlockRegistry.BUTTON_BUSH.getDefaultState());
	public static final WorldGenerator GEN_SOFT_RUSH = new WorldGenPlantCluster(
			BlockRegistry.SOFT_RUSH.getDefaultState());
	public static final WorldGenerator GEN_BOTTLE_BRUSH_GRASS = new WorldGenPlantCluster(
			BlockRegistry.BOTTLE_BRUSH_GRASS.getDefaultState());
	public static final WorldGenerator GEN_STAGNANT_WATER_POOL = new WorldGenFluidPool(BlockRegistry.STAGNANT_WATER);
	public static final WorldGenerator GEN_TAR_POOL_SURFACE = new WorldGenFluidPool(BlockRegistry.TAR)
			.setMinY(WorldProviderBetweenlands.CAVE_START + 5);
	public static final WorldGenerator GEN_SWAMP_REED = new WorldGenSwampReedCluster();
	public static final WorldGenerator GEN_SWAMP_PLANT = new WorldGenPlantCluster(
			BlockRegistry.SWAMP_PLANT.getDefaultState(), 8, 256);
	public static final WorldGenerator GEN_FLAT_HEAD_MUSHROOM = new WorldGenPlantCluster(
			BlockRegistry.FLAT_HEAD_MUSHROOM.getDefaultState(), 5, 40);
	public static final WorldGenerator GEN_BLACK_HAT_MUSHROOM = new WorldGenPlantCluster(
			BlockRegistry.BLACK_HAT_MUSHROOM.getDefaultState(), 5, 40);
	public static final WorldGenerator GEN_CATTAIL = new WorldGenPlantCluster(BlockRegistry.CATTAIL.getDefaultState());
	public static final WorldGenerator GEN_VENUS_FLY_TRAP = new WorldGenPlantCluster(
			BlockRegistry.VENUS_FLY_TRAP.getDefaultState(), 5, 64);
	public static final WorldGenerator GEN_MIRE_CORAL = new WorldGenPlantCluster(
			BlockRegistry.MIRE_CORAL.getDefaultState(), 4, 10).setUnderwater(true);
	public static final WorldGenerator GEN_DEEP_WATER_CORAL = new WorldGenPlantCluster(
			BlockRegistry.DEEP_WATER_CORAL.getDefaultState(), 4, 10).setUnderwater(true);
	...
	public static final WorldGenerator GEN_COPPER_IRIS = new WorldGenPlantCluster(
			BlockRegistry.COPPER_IRIS.getDefaultState());
	public static final WorldGenerator GEN_BLUE_IRIS = new WorldGenPlantCluster(
			BlockRegistry.BLUE_IRIS.getDefaultState());
	public static final WorldGenerator GEN_SWAMP_KELP = new WorldGenSwampKelpCluster();
	public static final WorldGenerator GEN_MILKWEED = new WorldGenPlantCluster(
			BlockRegistry.MILKWEED.getDefaultState());
	public static final WorldGenerator GEN_SHOOTS = new WorldGenPlantCluster(BlockRegistry.SHOOTS.getDefaultState());
	public static final WorldGenerator GEN_BLUE_EYED_GRASS = new WorldGenPlantCluster(
			BlockRegistry.BLUE_EYED_GRASS.getDefaultState());
	public static final WorldGenerator GEN_BONESET = new WorldGenPlantCluster(BlockRegistry.BONESET.getDefaultState());
	public static final WorldGenerator GEN_SLUDGECREEP = new WorldGenPlantCluster(
			BlockRegistry.SLUDGECREEP.getDefaultState());
	public static final WorldGenerator GEN_DEAD_WEEDWOOD_BUSH = new WorldGenPlantCluster(
			BlockRegistry.DEAD_WEEDWOOD_BUSH.getDefaultState());
	public static final WorldGenerator GEN_ROOTS = new WorldGenRootsCluster();
	public static final WorldGenerator GEN_WATER_WEEDS = new WorldGenPlantCluster(
			BlockRegistry.WATER_WEEDS.getDefaultState()).setUnderwater(true);
	...
	public static final WorldGenerator GEN_MOSS_UNDERGROUND = new WorldGenMossCluster(
			BlockRegistry.MOSS.getDefaultState(), 4, 80);
	public static final WorldGenerator GEN_LICHEN_UNDERGROUND = new WorldGenMossCluster(
			BlockRegistry.LICHEN.getDefaultState(), 3, 40);
	...
	public static final WorldGenerator GEN_BULB_CAPPED_MUSHROOMS = new WorldGenPlantCluster(
			BlockRegistry.BULB_CAPPED_MUSHROOM.getDefaultState(), 5, 40);
	...
	private static boolean canShortThingsGenerateHere(DecoratorPositionProvider decorator) {
		return ((ChunkGeneratorBetweenlands) decorator.getChunkGenerator()).evalTreeNoise(decorator.getX() * 0.01,
				decorator.getZ() * 0.01) > -0.25;
	}

	private static int getSpeleothemAttemptAdditive(DecoratorPositionProvider decorator) {
		return (int) ((((ChunkGeneratorBetweenlands) decorator.getChunkGenerator())
				.evalSpeleothemDensityNoise(decorator.getX() * 0.03, decorator.getZ() * 0.03) * 0.5 + 0.5) * 25);
	}

	public static boolean generatePhragmites(DecoratorPositionProvider decorator) {
		BlockPos pos = decorator.getRandomPos();
		if (decorator.getWorld().isAirBlock(pos)
				&& SurfaceType.PLANT_DECORATION_SOIL.matches(decorator.getWorld(), pos.down())) {
	...
	public static boolean generateSpeleothemCluster(DecoratorPositionProvider decorator) {
		...
		int y = (int) (v * (WorldProviderBetweenlands.LAYER_HEIGHT - WorldProviderBetweenlands.CAVE_WATER_HEIGHT)
				+ WorldProviderBetweenlands.CAVE_WATER_HEIGHT + 0.5F);
	...
	public static boolean generateCavePotsCluster(DecoratorPositionProvider decorator) {
		...
		int y = (int) (v * (WorldProviderBetweenlands.CAVE_START - 5.0F - WorldProviderBetweenlands.CAVE_WATER_HEIGHT)
				+ WorldProviderBetweenlands.CAVE_WATER_HEIGHT + 0.5F);
		int z = decorator.getRandomPosZ();
	...
	public static boolean generateUndergroundMossCluster(DecoratorPositionProvider decorator) {
		int x = decorator.getRandomPosX();
		float v = CAVE_MOSS_Y_CDF.eval(decorator.getRand().nextFloat());
		int y = (int) (v * (WorldProviderBetweenlands.CAVE_START - WorldProviderBetweenlands.CAVE_WATER_HEIGHT)
				+ WorldProviderBetweenlands.CAVE_WATER_HEIGHT + 0.5F);
		int z = decorator.getRandomPosZ();
	...
	public static boolean generateCaveGrassCluster(DecoratorPositionProvider decorator) {
		...
		int y = (int) (v * (WorldProviderBetweenlands.PITSTONE_HEIGHT - WorldProviderBetweenlands.CAVE_WATER_HEIGHT)
				+ WorldProviderBetweenlands.CAVE_WATER_HEIGHT + 0.5F);
		int z = decorator.getRandomPosZ();
	...
	public static boolean generateTarPoolSurface(DecoratorPositionProvider decorator) {
		...
		BlockPos pos = new BlockPos(x, y, z);
		if (SurfaceType.UNDERGROUND.matches(decorator.getWorld(), pos)
				|| SurfaceType.MIXED_GROUND.matches(decorator.getWorld(), pos)) {
	...
	public static boolean generateSwampReedCluster(DecoratorPositionProvider decorator) {
		...
		if (SurfaceType.WATER.matches(world, pos.up()) && world.getBlockState(pos).getBlock() == BlockRegistry.MUD
				&& world.isAirBlock(pos.up(2))) {
			return GEN_SWAMP_REED.generate(decorator.getWorld(), decorator.getRand(), pos);
		} else if (SurfaceType.MIXED_GROUND.matches(world, pos)
				&& BlockRegistry.SWAMP_REED.canPlaceBlockAt(world, pos.up())) {
			return GEN_SWAMP_REED.generate(decorator.getWorld(), decorator.getRand(), pos);
		}
		return false;
	}
	...
	public static boolean generateMireCoralCluster(DecoratorPositionProvider decorator) {
		...
		if (SurfaceType.WATER.matches(decorator.getWorld(), pos)
				&& SurfaceType.DIRT.matches(decorator.getWorld(), pos.down())) {
	...
	public static boolean generateMarshMarigold(DecoratorPositionProvider decorator) {
		...
		if (decorator.getWorld().isAirBlock(pos) && SurfaceType.WATER.matches(decorator.getWorld(), pos.down())
				&& SurfaceType.DIRT.matches(decorator.getWorld(), pos.down(2))) {
	...
	public static boolean generateCragrockTower(DecoratorPositionProvider decorator) {
		BlockPos pos = decorator.getRandomPosSeaGround(10);
		if (decorator.getWorld().isAirBlock(pos)
				&& SurfaceType.MIXED_GROUND.matches(decorator.getWorld(), pos.down())) {
	...
	public static boolean generateSapTree(DecoratorPositionProvider decorator) {
		BlockPos pos = decorator.getRandomPos();
		if (decorator.getWorld().isAirBlock(pos)
				&& SurfaceType.GRASS_AND_DIRT.matches(decorator.getWorld(), pos.down())) {
			...
			for (int zo = 0; zo < 32; zo++) {
				...
				if (surfaceBlock instanceof BlockLeaves) {
					...
					for (int i = 0; i < 128; i++) {
						...
						if (hasLeaves && (SurfaceType.GRASS_AND_DIRT.matches(cBlockState)
								|| cBlockState.getBlock() == BlockRegistry.LOG_WEEDWOOD)) {
							if (world.isAirBlock(checkPos.setPos(px, py - yo + 1, pz))
									&& decorator.getRand().nextInt(3) == 0) {
								world.setBlockState(new BlockPos(px, py - yo + 1, pz),
										BlockRegistry.FALLEN_LEAVES.getDefaultState(), 2 | 16);
								generated = true;
							}
						}
	...
	public static boolean generateWisp(DecoratorPositionProvider decorator) {
		...
		if (decorator.getWorld().isAirBlock(pos) && SurfaceType.WATER.matches(decorator.getWorld(), pos.down())) {
			...
			return decorator.getWorld().setBlockState(pos,
					BlockRegistry.WISP.getDefaultState().withProperty(BlockWisp.COLOR, color));
		}
		return false;
	}
	...
	public static boolean generateGiantTree(DecoratorPositionProvider decorator) {
		BlockPos pos = decorator.getRandomPosSeaGround();
		if (decorator.getWorld().isAirBlock(pos)
				&& SurfaceType.MIXED_GROUND.matches(decorator.getWorld().getBlockState(pos.down()))) {
			pos = pos.add(0, -8, 0);
	...
	public static boolean generateRottenLogs(DecoratorPositionProvider decorator) {
		...
		if (decorator.getWorld().isAirBlock(pos)
				&& SurfaceType.MIXED_GROUND.matches(decorator.getWorld(), pos.down())) {
			WorldGenRottenLogs gen = new WorldGenRottenLogs(decorator.getRand().nextInt(5) + 4,
					decorator.getRand().nextInt(3) + 2, (byte) decorator.getRand().nextInt(2));
	...
	public static boolean generateDeadTrunk(DecoratorPositionProvider decorator) {
		...
		if (decorator.getWorld().isAirBlock(pos)
				&& SurfaceType.MIXED_GROUND.matches(decorator.getWorld(), pos.down())) {
			GEN_DEAD_TRUNK.generate(decorator.getWorld(), decorator.getRand(),
					pos.down(8 + decorator.getRand().nextInt(5)));
		}
		return false;
	}
	...
	public static boolean generateMudStructures(DecoratorPositionProvider decorator) {
		BlockPos pos = decorator.getRandomPos(10);
		if (decorator.getWorld().isAirBlock(pos)
				&& decorator.getWorld().getBlockState(pos.down()).getBlock() == BlockRegistry.MUD) {
			return GEN_MUD_STRUCTURES.generate(decorator.getWorld(), decorator.getRand(), pos);
		}
		return false;
	}

	private static boolean generateSubBiomeStructure(DecoratorPositionProvider decorator, WorldGenerator generator,
			int offsetX, int offsetZ, int biomeCheckRange, Biome biome, SurfaceType surface) {
		MutableBlockPos pos = new MutableBlockPos();
		List<BlockPos> potentialPositions = new ArrayList<>();
		for (int xo = 0; xo < 32; xo += 3) {
			for (int zo = 0; zo < 32; zo += 3) {
				Biome biomeN = decorator.getWorld().getBiome(
						pos.setPos(decorator.getX() + xo, decorator.getY(), decorator.getZ() + zo - biomeCheckRange));
				Biome biomeE = decorator.getWorld().getBiome(
						pos.setPos(decorator.getX() + xo + biomeCheckRange, decorator.getY(), decorator.getZ() + zo));
				Biome biomeS = decorator.getWorld().getBiome(
						pos.setPos(decorator.getX() + xo, decorator.getY(), decorator.getZ() + zo + biomeCheckRange));
				Biome biomeW = decorator.getWorld().getBiome(
						pos.setPos(decorator.getX() + xo - biomeCheckRange, decorator.getY(), decorator.getZ() + zo));
	...
	public static boolean generateSwamplandsClearingSpiritTree(DecoratorPositionProvider decorator) {
		return generateSubBiomeStructure(decorator, GEN_SPIRIT_TREE_STRUCTURE, 0, 0, 36,
				BiomeRegistry.SWAMPLANDS_CLEARING, SurfaceType.MIXED_GROUND);
	}

	public static boolean generateSludgePlainsClearingDungeon(DecoratorPositionProvider decorator) {
		return generateSubBiomeStructure(decorator, GEN_SLUDGE_WORM_DUNGEON, 16, 16, 45,
				BiomeRegistry.SLUDGE_PLAINS_CLEARING, SurfaceType.MIXED_GROUND);
	}
}
