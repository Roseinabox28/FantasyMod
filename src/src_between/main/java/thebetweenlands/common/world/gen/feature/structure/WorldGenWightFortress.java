...
public class WorldGenWightFortress extends WorldGenerator {
	...
	private IBlockState betweenstoneTilesMossyCollapsing = BlockRegistry.WEAK_MOSSY_BETWEENSTONE_TILES
			.getDefaultState();
	...
	private IBlockState betweenstoneBrickStairsCracked = BlockRegistry.CRACKED_BETWEENSTONE_BRICK_STAIRS
			.getDefaultState();
	...
	private IBlockState betweenstoneStairsSmoothMossy = BlockRegistry.MOSSY_SMOOTH_BETWEENSTONE_STAIRS
			.getDefaultState();
	...
	private IBlockState lootPot1 = BlockRegistry.LOOT_POT.getDefaultState().withProperty(BlockLootPot.VARIANT,
			EnumLootPot.POT_1);
	private IBlockState lootPot2 = BlockRegistry.LOOT_POT.getDefaultState().withProperty(BlockLootPot.VARIANT,
			EnumLootPot.POT_2);
	private IBlockState lootPot3 = BlockRegistry.LOOT_POT.getDefaultState().withProperty(BlockLootPot.VARIANT,
			EnumLootPot.POT_3);
	...
	protected boolean isProtectedBlock(IBlockState state) {
		...
		if (block != Blocks.AIR && block != BlockRegistry.MOB_SPAWNER && block != BlockRegistry.LOOT_POT
				&& block != BlockRegistry.ROOT && block instanceof BlockPlant == false
				&& block != BlockRegistry.VALONITE_BLOCK && block != BlockRegistry.SYRMORITE_BLOCK
				&& block != BlockRegistry.OCTINE_BLOCK && block != BlockRegistry.WEEDWOOD_CHEST
				&& block != BlockRegistry.ITEM_CAGE && block != BlockRegistry.POSSESSED_BLOCK
				&& block != BlockRegistry.WEAK_POLISHED_LIMESTONE && block != BlockRegistry.WEAK_BETWEENSTONE_TILES
				&& block != BlockRegistry.WEAK_MOSSY_BETWEENSTONE_TILES) {
			return true;
		}
		return false;
	}
		...
		for (int xa = 0; xa <= 31; ++xa) {
			for (int za = 0; za <= 31; ++za) {
				for (int ya = 0; ya < 42; ++ya) {
					...
					boolean replaceable = state.getBlock() == Blocks.AIR
							|| state.getBlock().isReplaceable(world, checkPos) || state.getBlock() instanceof BlockPlant
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		LocationGuarded fortressLocation = new LocationGuarded(worldStorage, new StorageUUID(UUID.randomUUID()), region,
				"wight_tower", EnumLocationType.WIGHT_TOWER);
		this.guard = fortressLocation.getGuard();
		fortressLocation.addBounds(new AxisAlignedBB(pos.getX() - 10, pos.getY() - 10, pos.getZ() - 10, pos.getX() + 42,
				pos.getY() + 80, pos.getZ() + 42));
		fortressLocation.linkChunks();
		fortressLocation.setAmbience(new LocationAmbience(EnumLocationAmbience.WIGHT_TOWER).setFogRangeMultiplier(0.2F)
				.setFogBrightness(80));
		fortressLocation.setLayer(0);
		fortressLocation.setDirty(true);
		fortressLocation.setSeed(locationSeed);

		LocationStorage puzzleLocation = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()), region,
				"wight_tower_puzzle", EnumLocationType.WIGHT_TOWER);
		puzzleLocation.addBounds(new AxisAlignedBB(pos.getX() - 10 + 20, pos.getY() + 17, pos.getZ() - 10 + 20,
				pos.getX() + 42 - 20, pos.getY() + 17 + 6, pos.getZ() + 42 - 20));
		...
		LocationStorage teleporterLocation = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()),
				region, "wight_tower_teleporter", EnumLocationType.WIGHT_TOWER);
		teleporterLocation.addBounds(new AxisAlignedBB(pos.getX() - 10 + 23, pos.getY() + 17 + 12, pos.getZ() - 10 + 23,
				pos.getX() + 42 - 23, pos.getY() + 17 + 6 + 11, pos.getZ() + 42 - 23));
		...
		LocationStorage bossLocation = new LocationStorage(worldStorage, new StorageUUID(UUID.randomUUID()), region,
				"wight_tower_boss", EnumLocationType.WIGHT_TOWER);
		bossLocation.addBounds(new AxisAlignedBB(pos.getX() - 10 + 17, pos.getY() + 17 + 19, pos.getZ() - 10 + 17,
				pos.getX() + 42 - 17, pos.getY() + 17 + 12 + 32, pos.getZ() + 42 - 17));
		bossLocation.linkChunks();
		bossLocation.setAmbience(new LocationAmbience(EnumLocationAmbience.WIGHT_TOWER).setFogRange(12.0F, 20.0F)
				.setFogColorMultiplier(0.1F));
	...
	public IBlockState getStairRotations(IBlockState state, int blockMeta) {
		...
		case 4:
			return state.withProperty(BlockStairsBetweenlands.FACING, EnumFacing.EAST)
					.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP);
		case 5:
			return state.withProperty(BlockStairsBetweenlands.FACING, EnumFacing.WEST)
					.withProperty(BlockStairsBetweenlands.HALF, EnumHalf.TOP);
		case 6:
	...
	private IBlockState getSlabType(IBlockState slabType, int blockMeta) {
		return blockMeta == 0 ? slabType.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.BOTTOM)
				: slabType.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP);
	}
	...
	public boolean generateStructure(World world, Random rand, BlockPos pos) {
		...
		for (direction = 0; direction < 4; direction++) {
			...
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(10, -6, 10),
					rand.nextBoolean() ? "thebetweenlands:swamp_hag"
							: rand.nextBoolean() ? "thebetweenlands:chiromaw" : "thebetweenlands:termite");
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(21, -6, 21),
					rand.nextBoolean() ? "thebetweenlands:swamp_hag"
							: rand.nextBoolean() ? "thebetweenlands:chiromaw" : "thebetweenlands:termite");
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(10, -6, 21),
					rand.nextBoolean() ? "thebetweenlands:swamp_hag"
							: rand.nextBoolean() ? "thebetweenlands:chiromaw" : "thebetweenlands:termite");
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(21, -6, 10),
					rand.nextBoolean() ? "thebetweenlands:swamp_hag"
							: rand.nextBoolean() ? "thebetweenlands:chiromaw" : "thebetweenlands:termite");
			...
			rotatedCubeVolume(world, rand, pos, 12, -7, 12, betweenstoneStairsSmooth,
					direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 4, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 12, -7, 13, betweenstoneStairsSmooth,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 3, direction);
			...
			rotatedCubeVolume(world, rand, pos, 13, -3, 10, betweenstoneBrickStairs,
					direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 12, -3, 9, betweenstoneBrickStairs,
					direction == 0 ? 4 : direction == 1 ? 7 : direction == 2 ? 5 : 6, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 14, -3, 9, betweenstoneBrickStairs,
					direction == 0 ? 5 : direction == 1 ? 6 : direction == 2 ? 4 : 7, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 10, -3, 13, betweenstoneBrickStairs,
					direction == 0 ? 5 : direction == 1 ? 6 : direction == 2 ? 4 : 7, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 9, -3, 14, betweenstoneBrickStairs,
					direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 9, -3, 12, betweenstoneBrickStairs,
					direction == 0 ? 6 : direction == 1 ? 4 : direction == 2 ? 7 : 5, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 9, -5, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 11, -7, 9, getRandomMetalBlock(rand), 0, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 11, -6, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 9, -7, 11, getRandomMetalBlock(rand), 0, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 9, -6, 11, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			...
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(6, 2, 6),
					rand.nextBoolean() ? "thebetweenlands:swamp_hag" : "thebetweenlands:chiromaw");
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(25, 2, 6),
					rand.nextBoolean() ? "thebetweenlands:swamp_hag" : "thebetweenlands:chiromaw");
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(25, 2, 25),
					rand.nextBoolean() ? "thebetweenlands:swamp_hag" : "thebetweenlands:chiromaw");
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(6, 2, 25),
					rand.nextBoolean() ? "thebetweenlands:swamp_hag" : "thebetweenlands:chiromaw");
			...
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(6, 8, 6), "thebetweenlands:pyrad", logic -> logic
					.setNextEntity(new WeightedSpawnerEntity(nbt)).setCheckRange(16.0D).setMaxEntities(1));
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(25, 8, 6), "thebetweenlands:pyrad", logic -> logic
					.setNextEntity(new WeightedSpawnerEntity(nbt)).setCheckRange(16.0D).setMaxEntities(1));
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(25, 8, 25), "thebetweenlands:pyrad", logic -> logic
					.setNextEntity(new WeightedSpawnerEntity(nbt)).setCheckRange(16.0D).setMaxEntities(1));
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(6, 8, 25), "thebetweenlands:pyrad", logic -> logic
					.setNextEntity(new WeightedSpawnerEntity(nbt)).setCheckRange(16.0D).setMaxEntities(1));
			...
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(6, 19, 6), "thebetweenlands:wight",
					logic -> logic.setCheckRange(32.0D).setDelayRange(3000, 5000).setMaxEntities(3));
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(25, 19, 6), "thebetweenlands:wight",
					logic -> logic.setCheckRange(32.0D).setDelayRange(3000, 5000).setMaxEntities(3));
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(25, 19, 25), "thebetweenlands:wight",
					logic -> logic.setCheckRange(32.0D).setDelayRange(3000, 5000).setMaxEntities(3));
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(6, 19, 25), "thebetweenlands:wight",
					logic -> logic.setCheckRange(32.0D).setDelayRange(3000, 5000).setMaxEntities(3));

			if (rand.nextBoolean())
				rotatedCubeVolume(world, rand, pos, 16, 26, 16, spawner, 0, 1, 1, 1, direction);
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(16, 26, 16), "thebetweenlands:chiromaw",
					logic -> logic.setSpawnRange(2));
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(16, 26, 15), "thebetweenlands:chiromaw",
					logic -> logic.setSpawnRange(2));
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(15, 26, 16), "thebetweenlands:chiromaw",
					logic -> logic.setSpawnRange(2));
			BlockMobSpawnerBetweenlands.setMob(world, pos.add(15, 26, 15), "thebetweenlands:chiromaw",
					logic -> logic.setSpawnRange(2));
		...
		for (int tower = 0; tower < 5; tower++) {
			...
			for (direction = 0; direction < 4; direction++) {
				if (tower < 4) {
					...
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 2, 1, betweenstoneBrickStairs,
							direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 7, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 4, 2, betweenstoneBrickStairs,
							direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 8, 1, 1, direction);
					...
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 1, 3, 1, betweenstoneBricks, 0, 1, 1, 1,
							direction);
					...
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 0, 0, betweenstoneBrickWall, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 0, 0, betweenstoneBrickWall, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 0, 0, betweenstoneBrickWall, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 0, 0, 0, betweenstoneBrickWall, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 0, 0, 2, betweenstoneBrickWall, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 4, 2, betweenstoneBricks, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 4, 2, betweenstoneBricks, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 10, 3, betweenstoneBricks, 0, 1, 1, 1,
							direction);

					// deco walls
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 0, 4, 0, betweenstoneBrickWall, 0, 9, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 0, 4, 1, betweenstoneBrickWall, 0, 1, 1, 3,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 1, 4, 1, betweenstoneBrickWall, 0, 1, 3, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 4, 1, betweenstoneBrickWall, 0, 1, 6, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 1, 4, 3, betweenstoneBrickWall, 0, 1, 6, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 6, 1, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 1, 6, 2, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 7, 2, betweenstoneBrickWall, 0, 1, 3, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 9, 2, betweenstoneBrickWall, 0, 1, 6, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 9, 3, betweenstoneBrickWall, 0, 1, 6, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 14, 3, betweenstoneBrickWall, 0, 1, 5, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 16, 2, betweenstoneBrickWall, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 16, 3, betweenstoneBrickWall, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 17, 2, betweenstoneBrickWall, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 17, 1, betweenstoneBrickWall, 0, 4, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 1, 17, 3, betweenstoneBrickWall, 0, 1, 1, 3,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 16, 1, betweenstoneBrickWall, 0, 5, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 16, 0, betweenstoneBrickWall, 0, 1, 5, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 15, 1, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 18, 1, betweenstoneBrickWall, 0, 1, 2, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 18, 2, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 16, 0, betweenstoneBrickWall, 0, 1, 5, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 15, 1, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 18, 1, betweenstoneBrickWall, 0, 1, 2, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 18, 2, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 10, 2, betweenstoneBrickWall, 0, 1, 7, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 14, 2, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 10, 2, betweenstoneBrickWall, 0, 1, 7, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 10, 1, betweenstoneBrickWall, 0, 3, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 5, 1, betweenstoneBrickWall, 0, 1, 5, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 8, 1, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 5, 1, betweenstoneBrickWall, 0, 1, 5, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 5, 0, betweenstoneBrickWall, 0, 3, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 9, 1, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 9, 1, betweenstoneBrickWall, 0, 1, 1, 1,
							direction);

					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 3, 2, betweenstoneBrickStairs,
							direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 4, 3, betweenstoneBrickStairs,
							direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 3, 2, betweenstoneBrickStairs,
							direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 4, 3, betweenstoneBrickStairs,
							direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 4, 4, betweenstoneBrickSlab, 8, 5, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 1, 3, 2, betweenstoneBricks, 0, 1, 3, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 3, 1, betweenstoneBricks, 0, 1, 3, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 1, 0, 2, betweenstone, 0, 1, 3, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 4, 1, betweenstoneBricks, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 4, 1, betweenstoneBricks, 0, 1, 4, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 5, 2, betweenstoneBricks, 0, 1, 2, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 5, 3, betweenstoneBricks, 0, 1, 3, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 5, 2, betweenstoneBricks, 0, 1, 3, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 3, 1, betweenstoneBricks, 0, 7, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 1, 3, 3, betweenstoneBricks, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 8, 3, betweenstoneBricks, 0, 1, 6, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 8, 2, betweenstoneBricks, 0, 1, 11, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 8, 2, betweenstoneBricks, 0, 1, 11, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 16, 2, betweenstoneBricks, 0, 1, 3, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 17, 2, betweenstoneBricks, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 17, 2, betweenstoneBricks, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 16, 3, betweenstoneBricks, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 10, 3, betweenstoneBricks, 0, 1, 8, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 10, 3, betweenstoneBricks, 0, 1, 8, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 10, 3, betweenstoneBricks, 0, 1, 7, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 10, 3, betweenstoneBricks, 0, 1, 7, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 5, 2, betweenstoneBricks, 0, 2, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 5, 2, betweenstoneBricks, 0, 2, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 6, 2, betweenstoneBricks, 0, 1, 3, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 6, 2, betweenstoneBricks, 0, 1, 3, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 15, 3, betweenstoneTilesFortress, 0, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 14, 3, betweenstoneBrickSlab, 8, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 9, 2, betweenstoneTiles, 0, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 8, 2, betweenstoneBrickSlab, 8, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 3, 0, betweenstoneTiles, 0, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 2, 0, betweenstoneBrickSlab, 8, 1, 1, 1,
							direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 1, 3, 0, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 3, 0, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 3, 0, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 3, 0, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 9, 2, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 9, 2, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 5, 2, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 0, 3, 1, betweenstoneBrickStairs,
							direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 0, 3, 3, betweenstoneBrickStairs,
							direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 8, 3, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 8, 2, betweenstoneBrickStairs,
							direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 8, 1, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 8, 1, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 11, 4, betweenstoneBrickStairs,
							direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
					// tower loot pots
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 3, 0, 1, lootPot1,
							direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 9, 0, 1, lootPot1,
							direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);

					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 6, 2, lootPot1,
							direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 6, 2, lootPot1,
							direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
					if (tower == 0 && direction == 0 || tower == 0 && direction == 1 || tower == 1 && direction == 0
							|| tower == 1 && direction == 3 || tower == 2 && direction == 2
							|| tower == 2 && direction == 3 || tower == 3 && direction == 1
							|| tower == 3 && direction == 2)
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 10, 2, lootPot1,
								direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);

					// tower chests
					rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 12, 4, chest,
							direction == 0 ? 3 : direction == 1 ? 5 : direction == 2 ? 2 : 4, 1, 1, 1, direction);
					if (tower == 0 && direction == 0 || tower == 0 && direction == 1 || tower == 1 && direction == 0
							|| tower == 1 && direction == 3 || tower == 2 && direction == 2
							|| tower == 2 && direction == 3 || tower == 3 && direction == 1
							|| tower == 3 && direction == 2) {
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 17, 3, chest,
								direction == 0 ? 3 : direction == 1 ? 5 : direction == 2 ? 2 : 4, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 17, 3, chest,
								direction == 0 ? 3 : direction == 1 ? 5 : direction == 2 ? 2 : 4, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 17, 3, chest,
								direction == 0 ? 3 : direction == 1 ? 5 : direction == 2 ? 2 : 4, 1, 1, 1, direction);
					}
				}
			}
			...
			for (direction = 0; direction < 4; direction++) {
				if (tower < 4) {
					...
					if (tower == 0 && direction == 0 || tower == 0 && direction == 1 || tower == 1 && direction == 0
							...
							|| tower == 2 && direction == 3 || tower == 3 && direction == 1
							|| tower == 3 && direction == 2) {
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 4, 11, betweenstoneTiles, 0, 3, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 5, 12, betweenstoneBricks, 0, 1, 1, 4,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 5, 12, betweenstoneBricks, 0, 1, 1, 4,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 4, 1, betweenstoneBrickStairs,
								direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 3, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 6, 10, 3, betweenstoneBrickStairs,
								direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 5, 11, Blocks.AIR.getDefaultState(), 0, 3,
								5, 2, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 6, 12, betweenstoneBrickWall, 0, 1, 1, 4,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 6, 12, betweenstoneBrickWall, 0, 1, 1, 4,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 7, 14, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 7, 14, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 9, 11, betweenstoneBricks, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 9, 11, betweenstoneBricks, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 10, 11, betweenstoneBrickWall, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 10, 11, betweenstoneBrickWall, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 10, 10, betweenstoneTilesCollapsing, 0, 3,
								1, 6, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 11, 11, betweenstoneBricks, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 11, 11, betweenstoneBricks, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 12, 11, betweenstoneBrickWall, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 12, 11, betweenstoneBrickWall, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 13, 14, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 13, 14, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 15, 11, betweenstoneBricks, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 15, 11, betweenstoneBricks, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 16, 10, betweenstoneTiles, 0, 3, 1, 6,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 11, 10, Blocks.AIR.getDefaultState(), 0, 3,
								5, 2, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 17, 10, Blocks.AIR.getDefaultState(), 0, 3,
								4, 3, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 5, 12, possessedBlock,
								tower == 0 && direction == 0 ? 5
										: tower == 0 && direction == 1 ? 2
												: tower == 1 && direction == 0 ? 5
														: tower == 1 && direction == 3 ? 3
																: tower == 2 && direction == 2 ? 4
																		: tower == 2 && direction == 3 ? 3
																				: tower == 3 && direction == 1 ? 2 : 4,
								1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 5, 11, lootPot1,
								direction == 0 ? 5 : direction == 1 ? 3 : direction == 2 ? 4 : 2, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 5, 12, lootPot1,
								direction == 0 ? 5 : direction == 1 ? 3 : direction == 2 ? 4 : 2, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 5, 13, lootPot1,
								direction == 0 ? 5 : direction == 1 ? 3 : direction == 2 ? 4 : 2, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 11, 10, lootPot1,
								direction == 0 ? 5 : direction == 1 ? 3 : direction == 2 ? 4 : 2, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 11, 11, lootPot1,
								direction == 0 ? 5 : direction == 1 ? 3 : direction == 2 ? 4 : 2, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 11, 12, lootPot1,
								direction == 0 ? 5 : direction == 1 ? 3 : direction == 2 ? 4 : 2, 1, 1, 1, direction);
					}

					// top Floor
					if (tower == 0 && direction == 0 || tower == 1 && direction == 3 || tower == 2 && direction == 2
							|| tower == 3 && direction == 1) {
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 16, 11, betweenstoneBricks, 0, 1, 3, 4,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 7, 17, 15, betweenstoneBrickStairs,
								direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 17, 15, spikeTrap, 0, 3, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 9, 17, 14, betweenstoneBricks, 0, 2, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 19, 10, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 19, 12, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 19, 14, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 21, 10, betweenstoneBrickSlab, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 16, 12, betweenstoneBrickWall, 0, 1, 2, 4,
								direction);
					}
					if (tower == 0 && direction == 1 || tower == 1 && direction == 0 || tower == 2 && direction == 3
							|| tower == 3 && direction == 2) {
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 16, 11, betweenstoneBricks, 0, 1, 3, 4,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 5, 17, 15, betweenstoneBrickStairs,
								direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 17, 15, spikeTrap, 0, 3, 1, 1, direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 2, 17, 14, betweenstoneBricks, 0, 2, 2, 1,
								direction);//
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 19, 10, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 19, 12, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 19, 14, betweenstoneBrickWall, 0, 1, 2, 1,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 4, 21, 10, betweenstoneBrickSlab, 0, 1, 1, 5,
								direction);
						rotatedCubeVolume(world, rand, pos.add(x, y, z), 8, 16, 12, betweenstoneBrickWall, 0, 1, 2, 4,
								direction);
					}
				}
				// top tower
		...
		for (direction = 0; direction < 4; direction++) {
			...
			rotatedCubeVolume(world, rand, pos, 14, 3, 9, betweenstoneBrickStairs,
					direction == 0 ? 5 : direction == 1 ? 6 : direction == 2 ? 4 : 7, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 17, 3, 9, betweenstoneBrickStairs,
					direction == 0 ? 4 : direction == 1 ? 7 : direction == 2 ? 5 : 6, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 14, 4, 9, betweenstoneBrickStairs,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 17, 4, 9, betweenstoneBrickStairs,
					direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 12, 4, 9, betweenstoneBrickStairs,
					direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 19, 4, 9, betweenstoneBrickStairs,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);

			// mid
			rotatedCubeVolume(world, rand, pos, 14, 9, 9, betweenstoneBrickStairs,
					direction == 0 ? 5 : direction == 1 ? 6 : direction == 2 ? 4 : 7, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 17, 9, 9, betweenstoneBrickStairs,
					direction == 0 ? 4 : direction == 1 ? 7 : direction == 2 ? 5 : 6, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 14, 10, 9, betweenstoneBrickStairs,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 17, 10, 9, betweenstoneBrickStairs,
					direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 12, 10, 9, betweenstoneBrickStairs,
					direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 19, 10, 9, betweenstoneBrickStairs,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);

			// top
			rotatedCubeVolume(world, rand, pos, 14, 15, 9, betweenstoneBrickStairs,
					direction == 0 ? 5 : direction == 1 ? 6 : direction == 2 ? 4 : 7, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 17, 15, 9, betweenstoneBrickStairs,
					direction == 0 ? 4 : direction == 1 ? 7 : direction == 2 ? 5 : 6, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 14, 16, 9, betweenstoneBrickStairs,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 17, 16, 9, betweenstoneBrickStairs,
					direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 12, 16, 9, betweenstoneBrickStairs,
					direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 19, 16, 9, betweenstoneBrickStairs,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 13, 15, 10, betweenstoneBrickStairs,
					direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 13, 16, 10, betweenstoneBrickStairs,
					direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 13, 16, 11, betweenstoneBrickStairs,
					direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 18, 15, 10, betweenstoneBrickStairs,
					direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 18, 16, 10, betweenstoneBrickStairs,
					direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 18, 16, 11, betweenstoneBrickStairs,
					direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 1, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 13, -1, 13, betweenstoneStairsSmooth,
					direction == 0 ? 3 : direction == 1 ? 1 : direction == 2 ? 2 : 0, 2, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 17, -1, 13, betweenstoneStairsSmooth,
					direction == 0 ? 3 : direction == 1 ? 1 : direction == 2 ? 2 : 0, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 18, -1, 13, betweenstoneStairsSmooth,
					direction == 0 ? 3 : direction == 1 ? 1 : direction == 2 ? 2 : 0, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 14, -1, 6, betweenstoneStairsSmooth,
					direction == 0 ? 3 : direction == 1 ? 1 : direction == 2 ? 2 : 0, 4, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 14, -1, 7, betweenstoneStairsSmooth,
					direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 6, direction);
			rotatedCubeVolume(world, rand, pos, 15, -1, 7, betweenstoneSmooth, 0, 2, 1, 2, direction);
			rotatedCubeVolume(world, rand, pos, 17, -1, 7, betweenstoneStairsSmooth,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 6, direction);
			rotatedCubeVolume(world, rand, pos, 15, -1, 9, betweenstoneStairsSmooth,
					direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 2, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 15, -1, 10, betweenstoneSmooth, 0, 2, 1, 3, direction);
			rotatedCubeVolume(world, rand, pos, 15, -1, 13, betweenstoneStairsSmooth,
					direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 2, 1, 1, direction);
			...
			rotatedCubeVolume(world, rand, pos, 13, 3, 5, betweenstoneBrickStairs,
					direction == 0 ? 7 : direction == 1 ? 5 : direction == 2 ? 6 : 4, 6, 1, 1, direction);

			// going back to my roots
			rotatedCubeVolume(world, rand, pos, 13, 0, 5, root, 0, 1, rand.nextBoolean() ? rand.nextInt(3) + 1 : 0, 1,
					direction);
			rotatedCubeVolume(world, rand, pos, 18, 0, 5, root, 0, 1, rand.nextBoolean() ? rand.nextInt(3) + 1 : 0, 1,
					direction);
			rotatedCubeVolume(world, rand, pos, 5, 0, 13, root, 0, 1, rand.nextBoolean() ? rand.nextInt(3) + 1 : 0, 1,
					direction);
			rotatedCubeVolume(world, rand, pos, 5, 0, 18, root, 0, 1, rand.nextBoolean() ? rand.nextInt(3) + 1 : 0, 1,
					direction);
			rotatedCubeVolume(world, rand, pos, 13, 0, 11, root, 0, 1, rand.nextBoolean() ? rand.nextInt(3) + 2 : 0, 1,
					direction);
			rotatedCubeVolume(world, rand, pos, 18, 0, 11, root, 0, 1, rand.nextBoolean() ? rand.nextInt(3) + 2 : 0, 1,
					direction);
			rotatedCubeVolume(world, rand, pos, 11, 0, 13, root, 0, 1, rand.nextBoolean() ? rand.nextInt(3) + 2 : 0, 1,
					direction);
			rotatedCubeVolume(world, rand, pos, 11, 0, 18, root, 0, 1, rand.nextBoolean() ? rand.nextInt(3) + 2 : 0, 1,
					direction);
			rotatedCubeVolume(world, rand, pos, 11, 4, 11, root, 0, 1, rand.nextInt(3) + 3, 1, direction);
			rotatedCubeVolume(world, rand, pos, 14, 0, 14, root, 0, 1, rand.nextBoolean() ? rand.nextInt(4) + 4 : 0, 1,
					direction);
			rotatedCubeVolume(world, rand, pos, 16, 0, 14, root, 0, 1, rand.nextBoolean() ? rand.nextInt(3) + 2 : 0, 1,
					direction);

			// loot pots
			rotatedCubeVolume(world, rand, pos, 13, 0, 10, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 18, 0, 10, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 15, 5, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 16, 5, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 11, 11, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 15, 11, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 16, 11, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 20, 11, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
		...
		rotatedCubeVolume(world, rand, pos, 15, 0, 3, chest,
				direction == 0 ? 4 : direction == 1 ? 3 : direction == 2 ? 5 : 2, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 16, 0, 3, chest,
				direction == 0 ? 4 : direction == 1 ? 3 : direction == 2 ? 5 : 2, 1, 1, 1, direction);
		...
		rotatedCubeVolume(world, rand, pos, 14, 0, 0, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 4, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 14, 1, 1, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 4, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 14, 2, 2, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 4, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 14, 3, 3, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 4, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 14, 4, 4, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 4, 1, 1, direction);
		...
		for (int count = 0; count < 6; count++)
			rotatedCubeVolume(world, rand, pos, 16 + count, 5 + count, 24, betweenstoneBrickStairs,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
		...
		rotatedCubeVolume(world, rand, pos, 22, 12, 24, possessedBlock,
				direction == 0 ? 4 : direction == 1 ? 3 : direction == 2 ? 5 : 2, 1, 1, 1, direction);

		// 3rd betweenstoneBrickStairs
		for (int count = 0; count < 6; count++)
			rotatedCubeVolume(world, rand, pos, 16 - count, 11 + count, 7, betweenstoneBrickStairs,
					direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 1, direction);
		...
		for (int count = 0; count < 3; count++)
			rotatedCubeVolume(world, rand, pos, 17 + count, 18 + count, 23, betweenstoneBrickStairs,
					direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
		...
		for (int count = 0; count < 6; count++)
			rotatedCubeVolume(world, rand, pos, 22 - count, 22 + count, 10, betweenstoneBrickStairs,
					direction == 0 ? 1 : direction == 1 ? 2 : direction == 2 ? 0 : 3, 1, 1, 1, direction);
		...
		rotatedCubeVolume(world, rand, pos, 14, 27, 10, betweenstoneBrickStairs,
				direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 13, 26, 10, betweenstoneBrickStairs,
				direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 17, 26, 10, betweenstoneBrickStairs,
				direction == 0 ? 4 : direction == 1 ? 7 : direction == 2 ? 5 : 6, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 14, 26, 10, betweenstoneBrickStairs,
				direction == 0 ? 5 : direction == 1 ? 6 : direction == 2 ? 4 : 7, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 17, 29, 11, obviousSign,
				direction == 0 ? 2 : direction == 1 ? 4 : direction == 2 ? 3 : 5, 1, 1, 1, direction);
		// top tower floors
		...
		rotatedCubeVolume(world, rand, pos, 16, 24, 16, chest,
				direction == 0 ? 5 : direction == 1 ? 2 : direction == 2 ? 4 : 3, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 16, 24, 15, chest,
				direction == 0 ? 5 : direction == 1 ? 2 : direction == 2 ? 4 : 3, 1, 1, 1, direction);
		...
		for (direction = 0; direction < 4; direction++) {
			rotatedCubeVolume(world, rand, pos, 12, 17, 7, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 13, 17, 7, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 14, 17, 7, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 11, 18, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 13, 18, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 17, 17, 7, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 18, 17, 7, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 19, 17, 7, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 18, 18, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 20, 18, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 15, 22, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 16, 22, 9, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 15, 28, 11, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 16, 28, 11, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);

			// sword room pots
			rotatedCubeVolume(world, rand, pos, 12, 18, 10, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 14, 19, 10, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 17, 19, 10, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
			rotatedCubeVolume(world, rand, pos, 19, 18, 10, lootPot1,
					direction == 0 ? 2 : direction == 1 ? 5 : direction == 2 ? 3 : 4, 1, 1, 1, direction);
	...
	private void placeChest(World world, Random rand, BlockPos pos, int blockMeta) {
		...
		if (tile instanceof TileEntityChestBetweenlands) {
			...
			// TODO Also keep track of inventories ->
			// LocationStorage.setLootInventories(...)
			// ((TileEntityChestBetweenlands)
			// tile).setSharedLootTable(LootTableRegistry.SHARED_LOOT_POOL_TEST,
			// rand.nextLong());
	...
	private void placeSign(World world, Random rand, BlockPos pos, IBlockState state, int blockMeta) {
		this.setBlockAndNotifyAdequately(world, pos,
				state.withProperty(BlockWallWeedwoodSign.FACING, EnumFacing.byIndex(blockMeta)));
		TileEntity tile = world.getTileEntity(pos);
	...
	public void rotatedCubeVolume(World world, Random rand, BlockPos pos, int offsetA, int offsetB, int offsetC,
			IBlockState blockType, int blockMeta, int sizeWidth, int sizeHeight, int sizeDepth, int direction) {
		// special cases here
				...
				for (int xx = offsetA; xx < offsetA + sizeWidth; xx++)
					for (int zz = offsetC; zz < offsetC + sizeDepth; zz++) {
						if (blockType == limestoneBrickSlab || blockType == betweenstoneBrickSlab)
							this.setBlockAndNotifyAdequately(world, pos.add(xx, yy, zz),
									getSlabType(blockType, blockMeta));
						else if (blockType == betweenstoneTiles)
							this.setBlockAndNotifyAdequately(world, pos.add(xx, yy, zz),
									rand.nextBoolean() ? blockType : getRandomTiles(rand));
						else if (blockType == betweenstoneBricks)
							this.setBlockAndNotifyAdequately(world, pos.add(xx, yy, zz),
									rand.nextBoolean() ? blockType : getRandomBricks(rand));
						else if (blockType == betweenstoneBrickWall)
							this.setBlockAndNotifyAdequately(world, pos.add(xx, yy, zz),
									rand.nextBoolean() ? blockType : getRandomWall(rand));
						else if (blockType == betweenstoneBrickStairs)
							this.setBlockAndNotifyAdequately(world, pos.add(xx, yy, zz),
									getRandomBetweenstoneBrickStairs(rand, blockType, blockMeta));
						else if (blockType == betweenstoneStairsSmooth)
							this.setBlockAndNotifyAdequately(world, pos.add(xx, yy, zz),
									getRandomSmoothBetweenstoneStairs(rand, blockType, blockMeta));
						else if (blockType == betweenstoneSmooth)
							this.setBlockAndNotifyAdequately(world, pos.add(xx, yy, zz),
									rand.nextBoolean() ? blockType : getRandomSmoothBetweenstone(rand));
						else if (blockType == betweenstoneTilesCollapsing)
							this.setBlockAndNotifyAdequately(world, pos.add(xx, yy, zz),
									rand.nextBoolean() ? blockType : getRandomCollapsingTiles(rand));
						else if (blockType == possessedBlock)
							this.setBlockAndNotifyAdequately(world, pos.add(xx, yy, zz),
									getPossessedBlockRotations(blockType, blockMeta));
						else if (blockType == lootPot1)
							placeRandomisedLootPot(world, rand, pos.add(xx, yy, zz),
									rand.nextBoolean() ? blockType : rand.nextBoolean() ? lootPot2 : lootPot3,
									blockMeta);
	...
	public void generateTopTowerRight(World world, Random rand, BlockPos pos, int direction) {
		...
		rotatedCubeVolume(world, rand, pos, 1, 3, 0, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 3, 3, 0, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 5, 3, 0, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 5, 9, 2, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 6, 5, 2, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 0, 3, 1, betweenstoneBrickStairs,
				direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 0, 3, 3, betweenstoneBrickStairs,
				direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 5, 4, 1, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 4, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos, 6, 10, 3, betweenstoneBrickStairs,
				direction == 0 ? 2 : direction == 1 ? 0 : direction == 2 ? 3 : 1, 2, 1, 1, direction);
	}
	...
	public void generateTopTowerLeft(World world, Random rand, BlockPos pos, int direction) {
		...
		rotatedCubeVolume(world, rand, pos.add(x, 0, z), 1, 3, 0, betweenstoneBrickStairs,
				direction == 0 ? 3 : direction == 1 ? 1 : direction == 2 ? 2 : 0, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos.add(x, 0, z), 3, 3, 0, betweenstoneBrickStairs,
				direction == 0 ? 3 : direction == 1 ? 1 : direction == 2 ? 2 : 0, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos.add(x, 0, z), 5, 3, 0, betweenstoneBrickStairs,
				direction == 0 ? 3 : direction == 1 ? 1 : direction == 2 ? 2 : 0, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos.add(x, 0, z), 5, 9, -2, betweenstoneBrickStairs,
				direction == 0 ? 3 : direction == 1 ? 1 : direction == 2 ? 2 : 0, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos.add(x, 0, z), 6, 5, -2, betweenstoneBrickStairs,
				direction == 0 ? 3 : direction == 1 ? 1 : direction == 2 ? 2 : 0, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos.add(x, 0, z), 0, 3, -1, betweenstoneBrickStairs,
				direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
		rotatedCubeVolume(world, rand, pos.add(x, 0, z), 0, 3, -3, betweenstoneBrickStairs,
				direction == 0 ? 0 : direction == 1 ? 3 : direction == 2 ? 1 : 2, 1, 1, 1, direction);
	}
