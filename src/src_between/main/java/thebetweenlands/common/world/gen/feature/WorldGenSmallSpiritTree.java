...
public class WorldGenSmallSpiritTree extends WorldGenerator {
	...
	private List<BlockPos> generateRoot(World world, Random rand, BlockPos start, int dir, int trunkX, int trunkY,
			int trunkZ) {
		List<BlockPos> root = this.generateBranchPositions(rand, start, dir, 1 + rand.nextInt(2), 0.9D, 0.8D,
	...
	private List<BlockPos> generateSideBranchPositions(Random rand, BlockPos start, int dir) {
		return this.generateBranchPositions(rand, start, dir, 1 + rand.nextInt(2), 0.3D, 0.6D,
	...
	private List<BlockPos> generateTopBranch(World world, Random rand, BlockPos start, int dir, int trunkX, int trunkY,
			int trunkZ) {
		List<BlockPos> branch = this.generateBranchPositions(rand, start, dir, 1 + rand.nextInt(3), 0.1D, 0.2D,
