...
public class BiomeDecoratorBetweenlands extends DecoratorPositionProvider {
	...
	public void startProfilerSection(String name) {
		if (this.isProfilingEnabled() && this.getProfiler().profilingEnabled && (this.isRecursiveProfilingEnabled()
				|| !profiledGenerators.contains(this.getProfiler().getNameOfLastSection()))) {
