...
public class SludgeWormMazeBlockHelper {
	...
	// hanging plants
	public IBlockState CRYPTWEED = BlockRegistry.CRYPTWEED.getDefaultState().withProperty(BlockHangingPlant.CAN_GROW,
			false);
	public IBlockState STRING_ROOTS = BlockRegistry.STRING_ROOTS.getDefaultState()
			.withProperty(BlockHangingPlant.CAN_GROW, false);
	public IBlockState HANGER = BlockRegistry.HANGER.getDefaultState().withProperty(BlockHanger.CAN_GROW, true)
			.withProperty(BlockHanger.SEEDED, false);

	public IBlockState STAGNANT_WATER = BlockRegistry.STAGNANT_WATER.getDefaultState();

	public IBlockState DUNGEON_WALL_CANDLE_NORTH = BlockRegistry.DUNGEON_WALL_CANDLE.getDefaultState()
			.withProperty(BlockDungeonWallCandle.FACING, EnumFacing.NORTH);
	public IBlockState DUNGEON_WALL_CANDLE_EAST = BlockRegistry.DUNGEON_WALL_CANDLE.getDefaultState()
			.withProperty(BlockDungeonWallCandle.FACING, EnumFacing.EAST);
	public IBlockState DUNGEON_WALL_CANDLE_SOUTH = BlockRegistry.DUNGEON_WALL_CANDLE.getDefaultState()
			.withProperty(BlockDungeonWallCandle.FACING, EnumFacing.SOUTH);
	public IBlockState DUNGEON_WALL_CANDLE_WEST = BlockRegistry.DUNGEON_WALL_CANDLE.getDefaultState()
			.withProperty(BlockDungeonWallCandle.FACING, EnumFacing.WEST);
	...
	public IBlockState WORM_DUNGEON_PILLAR_TOP = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_TOP);
	public IBlockState WORM_DUNGEON_PILLAR_DECAY_1 = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_VERTICAL_DECAY_1);
	public IBlockState WORM_DUNGEON_PILLAR_TOP_DECAY_1 = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_TOP_DECAY_1);
	public IBlockState WORM_DUNGEON_PILLAR_DECAY_2 = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_VERTICAL_DECAY_2);
	public IBlockState WORM_DUNGEON_PILLAR_TOP_DECAY_2 = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_TOP_DECAY_2);
	public IBlockState WORM_DUNGEON_PILLAR_DECAY_3 = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_VERTICAL_DECAY_3);
	public IBlockState WORM_DUNGEON_PILLAR_TOP_DECAY_3 = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_TOP_DECAY_3);
	public IBlockState WORM_DUNGEON_PILLAR_DECAY_4 = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_VERTICAL_DECAY_4);
	public IBlockState WORM_DUNGEON_PILLAR_TOP_DECAY_4 = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_TOP_DECAY_4);
	public IBlockState WORM_DUNGEON_PILLAR_DECAY_FULL = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_VERTICAL_DECAY_FULL);
	public IBlockState WORM_DUNGEON_PILLAR_TOP_DECAY_FULL = BlockRegistry.WORM_DUNGEON_PILLAR.getDefaultState()
			.withProperty(BlockWormDungeonPillar.VARIANT, EnumWormPillarType.WORM_PILLAR_TOP_DECAY_FULL);

	public IBlockState MUD_TILES = BlockRegistry.MUD_TILES.getDefaultState();
	public IBlockState MUD_TILES_DECAY = BlockRegistry.MUD_TILES.getDefaultState().withProperty(BlockMudTiles.VARIANT,
			EnumMudTileType.MUD_TILES_DECAY);
	public IBlockState MUD_TILES_CRACKED = BlockRegistry.MUD_TILES.getDefaultState().withProperty(BlockMudTiles.VARIANT,
			EnumMudTileType.MUD_TILES_CRACKED);
	public IBlockState MUD_TILES_CRACKED_DECAY = BlockRegistry.MUD_TILES.getDefaultState()
			.withProperty(BlockMudTiles.VARIANT, EnumMudTileType.MUD_TILES_CRACKED_DECAY);
	...
	public IBlockState MUD_BRICKS_DECAY_1 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_DECAY_1);
	public IBlockState MUD_BRICKS_DECAY_2 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_DECAY_2);
	public IBlockState MUD_BRICKS_DECAY_3 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_DECAY_3);
	public IBlockState MUD_BRICKS_DECAY_4 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_DECAY_4);
	public IBlockState MUD_BRICKS_CARVED = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED);
	public IBlockState MUD_BRICKS_CARVED_DECAY_1 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED_DECAY_1);
	public IBlockState MUD_BRICKS_CARVED_DECAY_2 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED_DECAY_2);
	public IBlockState MUD_BRICKS_CARVED_DECAY_3 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED_DECAY_3);
	public IBlockState MUD_BRICKS_CARVED_DECAY_4 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED_DECAY_4);
	public IBlockState MUD_BRICKS_CARVED_EDGE = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED_EDGE);
	public IBlockState MUD_BRICKS_CARVED_EDGE_DECAY_1 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED_EDGE_DECAY_1);
	public IBlockState MUD_BRICKS_CARVED_EDGE_DECAY_2 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED_EDGE_DECAY_2);
	public IBlockState MUD_BRICKS_CARVED_EDGE_DECAY_3 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED_EDGE_DECAY_3);
	public IBlockState MUD_BRICKS_CARVED_EDGE_DECAY_4 = BlockRegistry.MUD_BRICKS_CARVED.getDefaultState()
			.withProperty(BlockCarvedMudBrick.VARIANT, EnumCarvedMudBrickType.MUD_BRICKS_CARVED_EDGE_DECAY_4);
	...
	public IBlockState ROTTEN_BARK = BlockRegistry.LOG_ROTTEN_BARK.getDefaultState()
			.withProperty(BlockLogBetweenlands.LOG_AXIS, EnumAxis.NONE);

	public IBlockState ROOT = BlockRegistry.ROOT.getDefaultState();

	public IBlockState DUNGEON_DOOR_COMBINATION_EAST = BlockRegistry.DUNGEON_DOOR_COMBINATION.getDefaultState()
			.withProperty(BlockDungeonDoorCombination.FACING, EnumFacing.EAST);
	public IBlockState DUNGEON_DOOR_COMBINATION_WEST = BlockRegistry.DUNGEON_DOOR_COMBINATION.getDefaultState()
			.withProperty(BlockDungeonDoorCombination.FACING, EnumFacing.WEST);

	public IBlockState DUNGEON_DOOR_EAST = BlockRegistry.DUNGEON_DOOR_RUNES.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.EAST);
	public IBlockState DUNGEON_DOOR_WEST = BlockRegistry.DUNGEON_DOOR_RUNES.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.WEST);

	public IBlockState DUNGEON_DOOR_NORTH = BlockRegistry.DUNGEON_DOOR_RUNES.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.NORTH);
	public IBlockState DUNGEON_DOOR_SOUTH = BlockRegistry.DUNGEON_DOOR_RUNES.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.SOUTH);

	public IBlockState DUNGEON_DOOR_MIMIC_EAST = BlockRegistry.DUNGEON_DOOR_RUNES_MIMIC.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.EAST);
	public IBlockState DUNGEON_DOOR_MIMIC_WEST = BlockRegistry.DUNGEON_DOOR_RUNES_MIMIC.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.WEST);

	public IBlockState DUNGEON_DOOR_MIMIC_NORTH = BlockRegistry.DUNGEON_DOOR_RUNES_MIMIC.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.NORTH);
	public IBlockState DUNGEON_DOOR_MIMIC_SOUTH = BlockRegistry.DUNGEON_DOOR_RUNES_MIMIC.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.SOUTH);

	public IBlockState DUNGEON_DOOR_CRAWLER_EAST = BlockRegistry.DUNGEON_DOOR_RUNES_CRAWLER.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.EAST);
	public IBlockState DUNGEON_DOOR_CRAWLER_WEST = BlockRegistry.DUNGEON_DOOR_RUNES_CRAWLER.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.WEST);

	public IBlockState DUNGEON_DOOR_CRAWLER_NORTH = BlockRegistry.DUNGEON_DOOR_RUNES_CRAWLER.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.NORTH);
	public IBlockState DUNGEON_DOOR_CRAWLER_SOUTH = BlockRegistry.DUNGEON_DOOR_RUNES_CRAWLER.getDefaultState()
			.withProperty(BlockDungeonDoorRunes.FACING, EnumFacing.SOUTH);

	public IBlockState LOOT_URN_1 = BlockRegistry.LOOT_URN.getDefaultState().withProperty(BlockLootUrn.VARIANT,
			EnumLootUrn.URN_1);
	public IBlockState LOOT_URN_2 = BlockRegistry.LOOT_URN.getDefaultState().withProperty(BlockLootUrn.VARIANT,
			EnumLootUrn.URN_2);
	public IBlockState LOOT_URN_3 = BlockRegistry.LOOT_URN.getDefaultState().withProperty(BlockLootUrn.VARIANT,
			EnumLootUrn.URN_3);

	public IBlockState MUD_BRICKS_ALCOVE_NORTH = BlockRegistry.MUD_BRICK_ALCOVE.getDefaultState()
			.withProperty(BlockMudBrickAlcove.FACING, EnumFacing.NORTH);
	public IBlockState MUD_BRICKS_ALCOVE_EAST = BlockRegistry.MUD_BRICK_ALCOVE.getDefaultState()
			.withProperty(BlockMudBrickAlcove.FACING, EnumFacing.EAST);
	public IBlockState MUD_BRICKS_ALCOVE_SOUTH = BlockRegistry.MUD_BRICK_ALCOVE.getDefaultState()
			.withProperty(BlockMudBrickAlcove.FACING, EnumFacing.SOUTH);
	public IBlockState MUD_BRICKS_ALCOVE_WEST = BlockRegistry.MUD_BRICK_ALCOVE.getDefaultState()
			.withProperty(BlockMudBrickAlcove.FACING, EnumFacing.WEST);

	public IBlockState MUD_BRICKS_CLIMBABLE_NORTH = BlockRegistry.MUD_BRICKS_CLIMBABLE.getDefaultState()
			.withProperty(BlockMudBricksClimbable.FACING, EnumFacing.NORTH);
	public IBlockState MUD_BRICKS_CLIMBABLE_EAST = BlockRegistry.MUD_BRICKS_CLIMBABLE.getDefaultState()
			.withProperty(BlockMudBricksClimbable.FACING, EnumFacing.EAST);
	public IBlockState MUD_BRICKS_CLIMBABLE_SOUTH = BlockRegistry.MUD_BRICKS_CLIMBABLE.getDefaultState()
			.withProperty(BlockMudBricksClimbable.FACING, EnumFacing.SOUTH);
	public IBlockState MUD_BRICKS_CLIMBABLE_WEST = BlockRegistry.MUD_BRICKS_CLIMBABLE.getDefaultState()
			.withProperty(BlockMudBricksClimbable.FACING, EnumFacing.WEST);

	public IBlockState MUD_FLOWER_POT_CANDLE_LIT = BlockRegistry.MUD_FLOWER_POT_CANDLE.getDefaultState()
			.withProperty(BlockMudFlowerPotCandle.LIT, true);
	public IBlockState MUD_FLOWER_POT_CANDLE_UNLIT = BlockRegistry.MUD_FLOWER_POT_CANDLE.getDefaultState()
			.withProperty(BlockMudFlowerPotCandle.LIT, false);
	...
	public IBlockState ROTTEN_PLANK_SLAB_UPPER = BlockRegistry.ROTTEN_PLANK_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP);
	public IBlockState ROTTEN_PLANK_SLAB_LOWER = BlockRegistry.ROTTEN_PLANK_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.BOTTOM);
	// Tower
	...
	public IBlockState SMOOTH_BETWEENSTONE_SLAB_UPPER = BlockRegistry.SMOOTH_BETWEENSTONE_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP);
	public IBlockState SMOOTH_BETWEENSTONE_SLAB_LOWER = BlockRegistry.SMOOTH_BETWEENSTONE_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.BOTTOM);
	...
	public IBlockState BETWEENSTONE_BRICK_SLAB_UPPER = BlockRegistry.BETWEENSTONE_BRICK_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP);
	public IBlockState BETWEENSTONE_BRICK_SLAB_LOWER = BlockRegistry.BETWEENSTONE_BRICK_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.BOTTOM);
	...
	public IBlockState SMOOTH_PITSTONE_SLAB_UPPER = BlockRegistry.SMOOTH_PITSTONE_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP);
	public IBlockState SMOOTH_PITSTONE_SLAB_LOWER = BlockRegistry.SMOOTH_PITSTONE_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.BOTTOM);
	...
	public IBlockState PITSTONE_BRICK_SLAB_UPPER = BlockRegistry.PITSTONE_BRICK_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.TOP);
	public IBlockState PITSTONE_BRICK_SLAB_LOWER = BlockRegistry.PITSTONE_BRICK_SLAB.getDefaultState()
			.withProperty(BlockSlabBetweenlands.HALF, EnumBlockHalfBL.BOTTOM);
	...
	public IBlockState BRAZIER_TOP = BlockRegistry.MUD_TOWER_BRAZIER.getDefaultState().withProperty(BlockBrazier.HALF,
			EnumBrazierHalf.UPPER);
	public IBlockState BRAZIER_BOTTOM = BlockRegistry.MUD_TOWER_BRAZIER.getDefaultState()
			.withProperty(BlockBrazier.HALF, EnumBrazierHalf.LOWER);
	...
	public IBlockState DECAY_PIT_INVISIBLE_FLOOR_BLOCK = BlockRegistry.DECAY_PIT_INVISIBLE_FLOOR_BLOCK
			.getDefaultState();
	public IBlockState DECAY_PIT_INVISIBLE_FLOOR_BLOCK_R_1 = BlockRegistry.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_R_1
			.getDefaultState();
	public IBlockState DECAY_PIT_INVISIBLE_FLOOR_BLOCK_R_2 = BlockRegistry.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_R_2
			.getDefaultState();
	public IBlockState DECAY_PIT_INVISIBLE_FLOOR_BLOCK_DIAGONAL = BlockRegistry.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_DIAGONAL
			.getDefaultState();
	public IBlockState DECAY_PIT_INVISIBLE_FLOOR_BLOCK_L_1 = BlockRegistry.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_L_1
			.getDefaultState();
	public IBlockState DECAY_PIT_INVISIBLE_FLOOR_BLOCK_L_2 = BlockRegistry.DECAY_PIT_INVISIBLE_FLOOR_BLOCK_L_2
			.getDefaultState();
	...
	public @Nullable IBlockState getMudBricksForLevel(Random rand, int level, int layer) {
		...
		case 5:
			...
			if (layer == 2)
				return rand.nextBoolean() ? MUD_BRICKS_CARVED_DECAY_1
						: rand.nextBoolean() ? MUD_BRICKS_CARVED_DECAY_2 : MUD_BRICKS_CARVED_DECAY_3;
			if (layer == 3)
		...
		case 6:
			if (layer == 1)
				return MUD_BRICKS_DECAY_4;
			if (layer == 2)
				return rand.nextBoolean() ? MUD_BRICKS_CARVED_DECAY_2
						: rand.nextBoolean() ? MUD_BRICKS_CARVED_DECAY_3 : MUD_BRICKS_CARVED_DECAY_4;
			if (layer == 3)
				return MUD_BRICKS_CARVED_EDGE_DECAY_4;
		case 7:
			if (layer == 1)
	...
	public @Nullable IBlockState getStairsForLevel(Random rand, int level, EnumFacing facing, EnumHalf half) {
		...
		return state.withProperty(BlockStairsBetweenlands.FACING, facing).withProperty(BlockStairsBetweenlands.HALF,
				half);
	}
	...
	public IBlockState getRandomSupportBeam(EnumFacing facing, boolean isTop, Random rand) {
		...
		return state.withProperty(BlockWoodenSupportBeam.FACING, facing).withProperty(BlockWoodenSupportBeam.TOP,
				isTop);
	}

	public IBlockState getRandomLitCandle(Random rand) {
		// return rand.nextBoolean() ? MUD_FLOWER_POT_CANDLE_UNLIT :
		// MUD_FLOWER_POT_CANDLE_LIT;
	...
	public void setRandomRoot(World world, BlockPos pos, Random rand) {
		if (!isSolidStructureBlock(world.getBlockState(pos))
				&& world.getBlockState(pos.down()).getBlock() instanceof BlockMudTiles) {
