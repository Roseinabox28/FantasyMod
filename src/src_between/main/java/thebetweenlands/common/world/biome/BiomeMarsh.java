...
public class BiomeMarsh extends BiomeBetweenlands {
	...
	public BiomeMarsh(int type) {
		super(new ResourceLocation(ModInfo.ID, "marsh_" + type),
				new BiomeProperties("Marsh " + type).setBaseHeight(WorldProviderBetweenlands.LAYER_HEIGHT - 1)
						.setHeightVariation(1.1F).setWaterColor(0x485E18).setTemperature(0.8F).setRainfall(0.9F));

		this.setWeight(type == 0 ? 10 : 4);
		this.getBiomeGenerator().addFeature(type == 0 ? new Marsh1Feature() : new Marsh2Feature())
	...
	protected void addSpawnEntries(List<ICustomSpawnEntry> entries) {
		...
		entries.add(new SurfaceSpawnEntry(0, EntityFirefly.class, EntityFirefly::new, (short) 65)
				.setCanSpawnOnWater(true).setSpawnCheckRadius(32.0D));
		entries.add(new SporelingSpawnEntry(1, EntitySporeling.class, EntitySporeling::new, (short) 80)
				.setGroupSize(2, 5).setSpawnCheckRadius(32.0D));
		entries.add(new CaveSpawnEntry(2, EntityBlindCaveFish.class, EntityBlindCaveFish::new, (short) 30)
				.setCanSpawnInWater(true).setGroupSize(3, 5).setSpawnCheckRadius(32.0D));
		entries.add(new GreeblingSpawnEntry(12, (short) 10).setGroupSize(1, 3).setSpawnCheckRadius(64.0D)
				.setGroupSpawnRadius(4).setSpawningInterval(24000));

		entries.add(new SurfaceSpawnEntry(3, EntityWight.class, EntityWight::new, (short) 5).setHostile(true)
				.setSpawnCheckRadius(64.0D).setSpawningInterval(4000));
		entries.add(new CaveSpawnEntry(4, EntityWight.class, EntityWight::new, (short) 16).setHostile(true)
				.setSpawnCheckRadius(64.0D));
		entries.add(new SurfaceSpawnEntry(5, EntityPeatMummy.class, EntityPeatMummy::new, (short) 12).setHostile(true)
				.setSpawnCheckRadius(64.0D));
		entries.add(new SurfaceSpawnEntry(6, EntityChiromaw.class, EntityChiromaw::new, (short) 40).setHostile(true)
				.setSpawnCheckRadius(64.0D).setSpawnCheckRangeY(20.0D));
		entries.add(new CaveSpawnEntry(7, EntityChiromaw.class, EntityChiromaw::new, (short) 60).setHostile(true)
				.setSpawnCheckRadius(40.0D).setGroupSize(1, 3));
		entries.add(new SwampHagCaveSpawnEntry(8, (short) 120).setHostile(true).setSpawnCheckRadius(24.0D)
				.setGroupSize(1, 3));
		entries.add(new CaveSpawnEntry(9, EntityAngler.class, EntityAngler::new, (short) 40).setCanSpawnInWater(true)
				.setHostile(true).setGroupSize(1, 3));
		entries.add(new SurfaceSpawnEntry(10, EntityGasCloud.class, EntityGasCloud::new, (short) 3)
				.setCanSpawnOnWater(true).setHostile(true).setSpawnCheckRadius(64.0D).setSpawnCheckRangeY(64.0D));
		entries.add(new BetweenstoneCaveSpawnEntry(11, EntityBoulderSprite.class, EntityBoulderSprite::new, (short) 60)
