...
public class SporelingSpawnEntry extends TreeSpawnEntry {
	public SporelingSpawnEntry(int id, Class<? extends EntityLiving> entityType,
	...
	public void onSpawned(EntityLivingBase entity) {
		if (entity.isEntityAlive() && entity.world.rand.nextInt(10) == 0) {
			...
			if (!entity.world.containsAnyLiquid(gecko.getEntityBoundingBox())
					&& entity.world.getCollisionBoxes(gecko, gecko.getEntityBoundingBox()).isEmpty()) {
				gecko.onInitialSpawn(
						entity.world.getDifficultyForLocation(new BlockPos(entity.posX, entity.posY, entity.posZ)),
						null);
