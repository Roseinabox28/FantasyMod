...
public class MessageItemNaming extends MessageBase {
	...
	public IMessage process(MessageContext ctx) {
		if (ctx.getServerHandler() != null) {
			...
			if (this.name != null && !heldItem.isEmpty() && heldItem.getItem() instanceof IRenamableItem
					&& ((IRenamableItem) heldItem.getItem()).canRename(player, this.hand, heldItem, this.name)) {
