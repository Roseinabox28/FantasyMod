	...
	public boolean onBlockStartBreak(ItemStack itemstack, BlockPos pos, EntityPlayer player) {
		...
		if (block instanceof ISickleHarvestable) {
			...
			if (target.isHarvestable(itemstack, player.world, pos)) {
				List<ItemStack> drops = target.getHarvestableDrops(itemstack, player.world, pos, EnchantmentHelper
						.getEnchantmentLevel(Enchantment.getEnchantmentByLocation("fortune"), itemstack));
				...
				for (ItemStack stack : drops) {
					...
					EntityItem entityitem = new EntityItem(player.world, (double) pos.getX() + rx,
							(double) pos.getY() + ry, (double) pos.getZ() + rz, stack);
