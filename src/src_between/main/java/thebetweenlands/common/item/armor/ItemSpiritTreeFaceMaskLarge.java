...
public class ItemSpiritTreeFaceMaskLarge extends ItemSpiritTreeFaceMask {
	public static final ResourceLocation TEXTURE = new ResourceLocation(ModInfo.ID,
			"textures/entity/spirit_tree_face_large.png");
	public static final ResourceLocation OVERLAY_TEXTURE = new ResourceLocation(ModInfo.ID,
			"textures/gui/spirit_tree_face_large_mask_overlay.png");
	public static final ResourceLocation OVERLAY_SIDE_TEXTURE = new ResourceLocation(ModInfo.ID,
			"textures/gui/spirit_tree_face_large_mask_overlay_side.png");

	@SideOnly(Side.CLIENT)
	private static ModelBiped model;

	public ItemSpiritTreeFaceMaskLarge() {
		super("spirit_tree_face_mask_large", (world, pos, facing) -> new EntitySpiritTreeFaceMask(world, pos, facing,
				EntitySpiritTreeFaceMask.Type.LARGE));
	}
