...
public class ItemSkullMask extends ItemBLArmor {
	private static final ResourceLocation SKULL_TEXTURE = new ResourceLocation(ModInfo.ID,
			"textures/gui/skull_mask.png");
	private static final ResourceLocation SKULL_SIDE_LEFT_TEXTURE = new ResourceLocation(ModInfo.ID,
			"textures/gui/skull_mask_side_left.png");
	private static final ResourceLocation SKULL_SIDE_RIGHT_TEXTURE = new ResourceLocation(ModInfo.ID,
			"textures/gui/skull_mask_side_right.png");
