...
public class ItemMarshRunnerBoots extends ItemRubberBoots {
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
		...
		if (!player.world.isRemote) {
			boolean playerOnGround = player.onGround && !player.isInWater()
					&& blockBelowPlayer.getBlock() instanceof BlockSwampWater == false;
	...
	public static boolean checkPlayerWalkOnWater(EntityPlayer player) {
		if (player.isSneaking() || ElixirEffectRegistry.EFFECT_HEAVYWEIGHT.isActive(player))
			return false;
