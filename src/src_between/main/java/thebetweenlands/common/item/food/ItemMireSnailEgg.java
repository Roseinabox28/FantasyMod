...
public class ItemMireSnailEgg extends ItemBLFood {
	...
	public EnumActionResult onItemUse(EntityPlayer player, World world, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		entity.setLocationAndAngles(pos.getX() + hitX + facing.getXOffset() * entity.width,
				pos.getY() + hitY + (facing.getYOffset() < 0 ? -entity.height - 0.005F : 0.0F),
				pos.getZ() + hitZ + facing.getZOffset() * entity.width, 0.0F, 0.0F);
