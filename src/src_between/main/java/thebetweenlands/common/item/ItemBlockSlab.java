	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		if (!itemstack.isEmpty() && player.canPlayerEdit(pos.offset(facing), facing, itemstack)) {
			...
			if (blockState.getBlock() == slab) {
				...
				if ((facing == EnumFacing.UP && type.equals(BlockSlabBetweenlands.EnumBlockHalfBL.BOTTOM)
						|| facing == EnumFacing.DOWN && type.equals(BlockSlabBetweenlands.EnumBlockHalfBL.TOP))) {
					IBlockState newState = blockState.withProperty(BlockSlabBetweenlands.HALF,
							BlockSlabBetweenlands.EnumBlockHalfBL.FULL);
			...
			return this.tryPlace(player, itemstack, worldIn, pos.offset(facing)) ? EnumActionResult.SUCCESS
