...
public class ItemRope extends Item {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand,
		...
		if (worldIn.getBlockState(pos).getBlock() == BlockRegistry.ROPE
				|| worldIn.getBlockState(pos.down()).getBlock() == BlockRegistry.ROPE) {
			...
			if (playerIn.canPlayerEdit(offsetPos, facing, stack)
					&& BlockRegistry.ROPE.canPlaceBlockAt(worldIn, offsetPos)) {
				if (!worldIn.isRemote) {
