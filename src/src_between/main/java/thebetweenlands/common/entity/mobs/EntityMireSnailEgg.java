...
public class EntityMireSnailEgg extends EntityAnimal implements IEntityBL {
	private static final DataParameter<Integer> HATCH_TICKS = EntityDataManager.createKey(EntityMireSnailEgg.class,
	...
	private void hatchParticlePacketTarget() {
		TheBetweenlands.networkWrapper.sendToAllAround(new MessageMireSnailEggHatching(this),
