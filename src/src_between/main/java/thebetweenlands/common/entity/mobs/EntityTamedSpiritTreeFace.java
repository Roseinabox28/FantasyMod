...
public class EntityTamedSpiritTreeFace extends EntitySpiritTreeFaceSmall {
	...
	protected void initEntityAI() {
		this.targetTasks.addTask(0,
				new EntityAINearestAttackableTarget<EntityLivingBase>(this, EntityLivingBase.class, 10, false, false,
						e -> IMob.VISIBLE_MOB_SELECTOR.apply(e) && e instanceof EntityTamedSpiritTreeFace == false));
		...
		this.tasks.addTask(2, new AISpit(this, 5.0F, 30, 70) {
			...
			protected float getSpitDamage() {
				return (float) EntityTamedSpiritTreeFace.this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE)
						.getAttributeValue();
			}
		});
