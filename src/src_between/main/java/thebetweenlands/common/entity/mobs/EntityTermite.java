...
public class EntityTermite extends EntityMob implements IEntityBL {
	public static final IAttribute SMALL = (new BooleanAttribute(null, "bl.termiteSmall", false))
			.setDescription("Whether this is a small termite").setShouldWatch(true);
