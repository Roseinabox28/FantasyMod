...
public abstract class EntitySpiritTreeFace extends EntityMovingWallFace implements IMob {
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		...
		if (source.getImmediateSource() instanceof IProjectile && source.getTrueSource() != null
				&& source.getTrueSource().getDistance(this) >= WorldGenSpiritTreeStructure.RADIUS_OUTER_CIRCLE + 12) {
			return false;
		}
	...
	public void doSpitAttack() {
		...
		if (target != null) {
			...
			spit.setPosition(this.posX + facing.getXOffset() * (this.width / 2 + 0.1F),
	...
	public static class AISpit extends EntityAIBase {
		...
		public boolean shouldExecute() {
			return this.entity.isActive() && !this.entity.isAttacking() && !this.entity.isMoving()
