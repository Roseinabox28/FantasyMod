...
public class EntityAIPuppet extends EntityAIBase {
	...
	/**
	 * Creates a puppet AI that takes over the entities AI. A list of additional
	 * tasks to run can be specified
	 * 
	 * @param taskOwner
	 * @param puppeteer
	 * @param tasks
	 ...
	 * @param tasks
	 */
	public static void addPuppetAI(Supplier<Entity> puppeteer, EntityLivingBase entity, EntityAITasks creatureTasks,
			@Nullable List<EntityAIBase> tasks) {
