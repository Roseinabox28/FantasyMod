...
public class EntitySpawnHandler {
	...
	public static void onEntitySpawn(EntityJoinWorldEvent event) {
		...
		if (!entity.world.isRemote) {
			...
			if (AMULET_SPAWNS.contains(entity.getClass()) && entity.getEntityData() != null
					&& entity.world.rand.nextInt(AMULET_SPAWN_CHANCE) == 0) {
	...
	/**
	 * Copies the gem modifier of the active or held item of the source entity to
	 * the spawned entity
	 *
	 * @param source
	 * @param entity
