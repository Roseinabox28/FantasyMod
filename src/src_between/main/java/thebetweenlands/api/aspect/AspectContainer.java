...
/**
 * The aspect container contains dynamic and static aspects. Static aspects are
 * only saved when their amount changes, so that they can be updated in case the
 * aspect distribution seed is changed. Once the amount of a static aspect in
 * this container has changed it is no longer treated as a static aspect.
 */
