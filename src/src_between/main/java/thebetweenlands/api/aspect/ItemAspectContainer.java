...
public final class ItemAspectContainer extends AspectContainer {
	 ...
	 * <p>
	 * <b>If the aspect manager is null the container will not contain static
	 * aspects!</b>
	 * 
	 * @param stack
	 * @param manager
	...
	public static ItemAspectContainer fromItem(ItemStack stack, @Nullable AspectManager manager) {
		...
		NBTTagCompound aspectNbt = stack.getTagCompound() != null
				? stack.getTagCompound().getCompoundTag(ASPECTS_NBT_TAG)
				: null;
		if (aspectNbt != null)
	 ...
	 * Creates an aspect container for the specified item stack.
	 * <p>
	 * <b>Does not contain static aspects!</b>
	 * 
	 * @param stack
	 * @return
	 */
	...
	/**
	 * Returns a list of all aspects in this container. Specify a discovery
	 * container if you only want discovered or dynamic aspects to be visible
	 * 
	 * @param discoveries
	 * @return
	 */
	public List<Aspect> getAspects(DiscoveryContainer<?> discoveries) {
		...
		if (discoveries != null && this.manager != null)
			discoveredAspects = discoveries.getDiscoveredStaticAspects(this.manager,
					AspectManager.getAspectItem(this.itemStack));
	...
	/**
	 * Returns a list of all aspects that are discovered and visible to the
	 * specified player
	 * 
	 * @param player
	 * @return
	...
	protected List<Aspect> getStaticAspects() {
		return this.manager != null ? this.manager.getStaticAspects(AspectManager.getAspectItem(this.itemStack))
				: ImmutableList.of();
	}
}
