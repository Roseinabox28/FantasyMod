...
public class DiscoveryContainer<T> {
	...
	/**
	 * Returns a list of all writable discovery containers in the inventory of a
	 * player
	 * 
	 * @param player
	 * @return
	...
	/**
	 * Merges all discovery containers in the inventory of a player into one
	 * discovery container. Mostly used to get the combined knowledge of the player.
	 * 
	 * @param player
	 * @return
	 */
