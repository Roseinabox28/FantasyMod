...
public interface IAnimatorRepairable {
	...
	/**
	 * Returns the maximum fuel cost to fully repair the specified stack if it were
	 * completely broken
	 * 
	 * @param stack
	 * @return
	...
	/**
	 * Returns the maximum life cost to fully repair the specified stack if it were
	 * completely broken
	 * 
	 * @param stack
	 * @return
