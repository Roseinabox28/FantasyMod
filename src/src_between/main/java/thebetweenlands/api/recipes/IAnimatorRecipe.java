...
public interface IAnimatorRecipe {
	...
	/**
	 * Called when the item is animated. Can return the resulting ItemStack
	 * (overrides {@link IAnimatorRecipe#getResult()}). Also used to spawn entities
	 * from animator once animated
	 * 
	 * @param world
	 * @param pos
	 * @param stack
