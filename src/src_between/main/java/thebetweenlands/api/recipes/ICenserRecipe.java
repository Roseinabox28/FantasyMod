...
public interface ICenserRecipe<Context> {
	/**
	 * Returns an ID that uniquely identifies this recipe
	 * 
	 * @return
	 */
	...
	/**
	 * Called when an input item stack is consumed. Returns the item stack that is
	 * left over. Usually decreases the stack size by one or returns a container
	 * item.
	 * 
	 * @param stack
	 */
	...
	/**
	 * Returns the input amount for the given item stack. The default value is 1000
	 * for regular items. Maximum amount that the censer can hold is 1000. Fluids
	...
	/**
	 * Called when the recipe starts being used. Only called on logical server side.
	 * 
	 * @param context
	 */
	...
	/**
	 * Called when the recipe stops being used. Only called on logical server side.
	 * 
	 * @param context
	 */
	...
	/**
	 * Called every tick while the recipe is running. Create and apply effects here.
	...
	/**
	 * Returns the effect color. Used e.g. to color the censer's progress bar or the
	 * censer fog strips.
	 * 
	 * @param context
	 * @param censer
	...
	/**
	 * Whether this recipe/effect creates dungeon fog that accelerates plant/crop
	 * growth and allows sludge worm dungeon plants to grow
	 * 
	 * @param context
	 * @param censer
	 * @return
	...
	/**
	 * Returns which aspect fog type this recipe creates, or null if no aspect fog
	 * is created
	 * 
	 * @param context
	 * @param censer
