...
public interface ILocalStorage extends ICapabilityProvider {
	...
	/**
	 * Reads the local storage data from NBT. {@link #getID()} and
	 * {@link #getRegion()} are already read automatically
	 * 
	 * @param nbt
	 */
	...
	/**
	 * Writes the local storage data to NBT. {@link #getID()} and
	 * {@link #getRegion()} are already written automatically
	 * 
	 * @param nbt
	 * @return
	 */
	...
	/**
	 * Adds a watcher of the specified chunk storage. May be called multiple times
	 * with the same player but from a different chunk storage
	 * 
	 * @param chunkStorage
	 * @param player
	...
	/**
	 * Removes a watcher of the specified chunk storage. May be called multiple
	 * times with the same player but from a different chunk storage
	 * 
	 * @param chunkStorage
	 * @param player
	...
	/**
	 * Unlinks all chunks from this local storage. Do not use this to remove local
	 * storage since the file won't be deleted. To remove a local storage use
	 * {@link ILocalStorageHandler#removeLocalStorage(ILocalStorage)} instead
	 * 
	...
	/**
	 * Unlinks the specified chunk from this local storage Do not use this to remove
	 * local storage since the file won't be deleted. To remove a local storage use
	 * {@link ILocalStorageHandler#removeLocalStorage(ILocalStorage)} instead
	 * 
	 * @param chunk
	 ...
	 * <p>
	 * <b>Only storages that implement {@link ITickable} will automatically update
	 * the data manager!</b>
	 * 
	 * @return
	 */
