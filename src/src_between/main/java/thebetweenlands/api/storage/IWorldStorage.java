...
public interface IWorldStorage {
	...
	/**
	 * Called when a chunk storage needs to be read from the specified NBT and
	 * loaded
	 * 
	 * @param chunk
	 * @param nbt
	...
	/**
	 * Saves the chunk storage data to NBT. May return null if no data needs to be
	 * saved
	 * 
	 * @param chunk
	 * @return
	...
	/**
	 * Returns the local storage handler responsible for loading and saving local
	 * storage from/to files and keeping track the local storage instances
	 * 
	 * @return
	 */
