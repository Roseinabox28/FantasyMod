...
/**
 * One region spans over 32x32 chunks. Any {@link ILocalStorage} assigned to a
 * region will be saved in that region file. Regions stay loaded until all
 * references are unloaded or the cache is cleared.
 */
