...
public interface ICustomSpawnEntry extends IWeightProvider {
	...
	/**
	 * Returns whether an entity can spawn based on the spawning position and the
	 * surface block below
	 * 
	 * @param world
	 * @param pos
	...
	/**
	 * Sets the desired minimum and maximum group size. The minimum desired group
	 * size may not always be achieved depending on the area around the initial
	 * spawn point.
	 * 
	 * @param min
	 * @param max
	...
	/**
	 * Returns whether already existing entity should be taken into account when
	 * spawning groups
	 * 
	 * @return
	 */
