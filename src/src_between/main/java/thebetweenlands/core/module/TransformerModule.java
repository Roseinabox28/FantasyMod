...
public abstract class TransformerModule {
	...
	/**
	 * Marks the transformation as successful. If this is not called the game will
	...
	/**
	 * Returns the obfuscated name if the code is obfuscated and if not it returns
	 * the deobfuscated name
	 * 
	 * @param obfName
	 * @param deofName
	 * @return
	 ...
	 * @param toInsert
	 */
	protected final void insertBefore(MethodNode method, AbstractInsnNode insn,
			Collection<? extends AbstractInsnNode> toInsert) {
	 ...
	 * @param toInsert
	 */
	protected final void insertAfter(MethodNode method, AbstractInsnNode insn,
			List<? extends AbstractInsnNode> toInsert) {
