...
public class SplashPotionInstantHookTransformer extends TransformerModule {
	...
	public boolean acceptsMethod(MethodNode method) {
		return method.name.equals(this.getMappedName("a", "applySplash"))
				&& method.desc.equals(this.getMappedName("(Lbhc;Ljava/util/List;)V",
						"(Lnet/minecraft/util/math/RayTraceResult;Ljava/util/List;)V"));
	}
	...
	public void transformMethodInstruction(MethodNode method, AbstractInsnNode node, int index) {
		if (node instanceof MethodInsnNode) {
			...
			if (methodCallNode.name.equals(this.getMappedName("a", "affectEntity"))
					&& methodCallNode.desc.equals(this.getMappedName("(Lvg;Lvg;Lvp;ID)V",
							"(Lnet/minecraft/entity/Entity;Lnet/minecraft/entity/Entity;Lnet/minecraft/entity/EntityLivingBase;ID)V"))
				...
				insertionsBefore.add(new VarInsnNode(Opcodes.ALOAD, isBukkitServer ? 9 : 6)); // entitylivingbase from
																								// "for
																								// (EntityLivingBase
																								// entitylivingbase :
																								// list)"
				insertionsBefore.add(new VarInsnNode(Opcodes.ALOAD, isBukkitServer ? 13 : 12)); // potioneffect from
																								// "for (PotionEffect
																								// potioneffect :
																								// p_190543_2_)"
				insertionsBefore.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "thebetweenlands/common/CommonHooks",
						"onSplashAffectEntity",
						this.getMappedName("(Laez;Lvp;Lva;)Z",
								"(Lnet/minecraft/entity/projectile/EntityPotion;Lnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/potion/PotionEffect;)Z"),
						false));
