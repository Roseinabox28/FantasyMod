...
public class TheBetweenlandsClassTransformer implements IClassTransformer {
	...
	/**
	 * Checks if all modules were successful and throws a
	 * {@link ClassTransformationException} otherwise.
	 */
	...
	/**
	 * Checks if all modules in the specified list were successful and throws a
	 * {@link ClassTransformationException} otherwise.
	 * 
	 * @param modules
	 */
