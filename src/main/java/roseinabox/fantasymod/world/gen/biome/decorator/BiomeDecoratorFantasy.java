...
public class BiomeDecoratorFantasy extends DecoratorPositionProvider {
	 ...
	 * @param z
	 */
	public final void decorate(World world, ChunkGeneratorWasteland generator, Random rand, int x, int z) {
	...
	protected void generateOres() {
		...
		//this.generateOre(6, 12, OreGens.SYRMORITE, WorldProviderBetweenlands.PITSTONE_HEIGHT + 40,
		//		WorldProviderBetweenlands.CAVE_START - 5);
		//this.generateOre(5, 12, OreGens.BONE_ORE, WorldProviderBetweenlands.PITSTONE_HEIGHT, 128);
		//this.generateOre(4.5F, 12, OreGens.OCTINE, WorldProviderBetweenlands.PITSTONE_HEIGHT,
		//		WorldProviderBetweenlands.CAVE_START - 40);
		//this.generateOre(4, 12, OreGens.SWAMP_DIRT, WorldProviderBetweenlands.PITSTONE_HEIGHT,
		//		WorldProviderBetweenlands.CAVE_START - 15);
		/*this.generateOre(0.2F, 12, OreGens.LIMESTONE, WorldProviderBetweenlands.PITSTONE_HEIGHT,
				WorldProviderBetweenlands.CAVE_START - 15);
...
*/
				...
				if (hasMud) {
					...
					case 0:
						world.setBlockState(new BlockPos(xx, yy, zz),
								BlockRegistry.AQUA_MIDDLE_GEM_ORE.getDefaultState());
						break gems;
					case 1:
						world.setBlockState(new BlockPos(xx, yy, zz),
								BlockRegistry.CRIMSON_MIDDLE_GEM_ORE.getDefaultState());
						break gems;
					case 2:
						world.setBlockState(new BlockPos(xx, yy, zz),
								BlockRegistry.GREEN_MIDDLE_GEM_ORE.getDefaultState());
						break gems;
					}
				}
			}
	 ...
	 *
	 * @param tries     How many attempts should be run. If this value is < 1 it is
	 *                  used as a probability
	 * @param generator
	 * @return
	 */
	public boolean generate(float tries, Function<BiomeDecoratorFantasy, Boolean> generator) {
	 ...
	 * @return
	 */
	public boolean generate(Function<BiomeDecoratorFantasy, Boolean> generator) {
