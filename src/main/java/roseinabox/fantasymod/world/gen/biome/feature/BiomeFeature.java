package roseinabox.fantasymod.world.gen.biome.feature;
...
public abstract class BiomeFeature {
	 ...
	 * @param pass
	 */
	public abstract void replaceStackBlocks(int x, int z, double baseBlockNoise, ChunkPrimer chunkPrimer,
			ChunkGeneratorWasteland chunkGeneratorWasteland, Biome[] biomesForGeneration, Biome biome,
