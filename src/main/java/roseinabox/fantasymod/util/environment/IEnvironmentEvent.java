...
public interface IEnvironmentEvent {
	...
	/**
	 * Returns whether the event affects the specified position. Can be used by
	 * events that should only affect certain locations, e.g. biomes, height etc.
	 * <br>
	...
	/**
	 * Resets the active state. Can be used by seasonal events to reset to the
