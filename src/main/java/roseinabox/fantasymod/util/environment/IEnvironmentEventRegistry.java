package roseinabox.fantasymod.util.environment;
...
public interface IEnvironmentEventRegistry {
	...
	/**
	 * Returns the event with the specified ID or null if that event is not
	 * registered
	 * 
	 * @param eventId
	 * @return
	...
	/**
	 * Returns whether the specified event is registered and
	 * {@link IEnvironmentEvent#isActive()} == true
	 * 
	 * @param eventId
	 * @return
	 */
	...
	/**
	 * Returns whether the specified event is registered and
	 * {@link IEnvironmentEvent#isActiveAt(double, double, double)} == true
	 * 
	 * @param x
	 * @param y
	 * @param z
	...
	/**
	 * Returns a list of all registered events whose
	 * {@link IEnvironmentEvent#isActive()} == active
	 * 
	 * @param active
	 * @return
	 */
	...
	/**
	 * Returns a list of all registered events whose
	 * {@link IEnvironmentEvent#isActiveAt(double, double, double)} == active
	 * 
	 * @param x
	 * @param y
	 * @param z
	...
	/**
	 * Sets whether the registry is enabled. Environment events are only updated if
